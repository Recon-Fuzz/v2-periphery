...
- **Kind**: internal
- **Source**: 3774:154:508
- **Link**: `src/SuperBank.sol:SuperBank:_isHookRegistered(address)`
...
- **Kind**: internal
- **Source**: 3597:171:508
- **Link**: `src/SuperBank.sol:SuperBank:_getMerkleRootForHook(address)`
...
- **ISuperGovernor::getSuperBankHookMerkleRoot(address)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperBank.executeHooks(struct IHookExecutionData.HookExecutionData) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: Bank._executeHooks(struct IHookExecutionData.HookExecutionData) (NodeID: 1)
  │   💬 Args: [executionData]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SuperBank._isHookRegistered(address) (NodeID: 2)
  │ │   💬 Args: [hookAddress]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SuperBank._getMerkleRootForHook(address) (NodeID: 3)
  │ │   💬 Args: [hookAddress]
  │ │   👁️  Def: internal
  ...
  │       💬 Args: [no args]
  │       👁️  Def: private
  └─ [1] 🔒 MODIFIER: SuperBank.onlyBankManager() (NodeID: 14)
      💬 Args: [no args]
    └─ [2] ⚙️ FUNCTION: SuperBank._onlyBankManager() (NodeID: 15)
        💬 Args: [no args]
        👁️  Def: internal
```
