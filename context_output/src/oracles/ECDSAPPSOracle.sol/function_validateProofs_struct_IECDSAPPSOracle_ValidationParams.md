# Function: validateProofs(struct IECDSAPPSOracle.ValidationParams)
...
- **ISuperGovernor::isValidator(address)**
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracle.validateProofs(struct IECDSAPPSOracle.ValidationParams) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
