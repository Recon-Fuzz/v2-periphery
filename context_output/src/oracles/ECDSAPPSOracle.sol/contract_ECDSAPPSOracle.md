...
- **Details**: [function_validateProofs_struct_IECDSAPPSOracle.ValidationParams.md](./function_validateProofs_struct_IECDSAPPSOracle.ValidationParams.md)
...
- **Details**: [function_validateProofs_struct_IECDSAPPSOracle.ValidationParams_uint256.md](./function_validateProofs_struct_IECDSAPPSOracle.ValidationParams_uint256.md)
