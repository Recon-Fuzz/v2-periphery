...
┌─ [0] ⚙️ FUNCTION: SuperOracleBase.getQuoteFromProvider(uint256,address,address,bytes32) (NodeID: 0)
  ...
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: SuperOracleBase._getQuoteFromOracle(address,uint256,address,address,bool) (NodeID: 2)
  ...
  │     💬 Args: [variance]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: SuperOracleBase._getQuoteFromOracle(address,uint256,address,address,bool) (NodeID: 19)
