...
- **Kind**: internal
- **Source**: 10247:1303:535
- **Link**: `src/oracles/SuperOracleBase.sol:SuperOracleBase:getQuoteFromProvider(uint256,address,address,bytes32)`
...
- **Kind**: internal
- **Source**: 13591:2396:535
- **Link**: `src/oracles/SuperOracleBase.sol:SuperOracleBase:_getQuoteFromOracle(address,uint256,address,address,bool)`

```solidity
function _getQuoteFromOracle(address oracle, uint256 baseAmount, address base, address quote, bool revertOnError) virtual internal view returns (uint256 quoteAmount) {
    int256 answer;
    uint256 updatedAt;
...
- **IERC20::safeDecimals(contract IERC20)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperOracleBase.getQuote(uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: SuperOracleBase.getQuoteFromProvider(uint256,address,address,bytes32) (NodeID: 1)
      💬 Args: [baseAmount, base, quote, AVERAGE_PROVIDER]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: SuperOracleBase._getAverageQuote(address,address,uint256,uint256) (NodeID: 2)
    │   💬 Args: [base, quote, baseAmount, length]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: SuperOracleBase._getQuoteFromOracle(address,uint256,address,address,bool) (NodeID: 3)
    │     💬 Args: [providerOracle, baseAmount, base, quote, false]
    │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: Math.min(uint256,uint256) (NodeID: 4)
    │   │   💬 Args: [feedMaxStaleness[oracle], defaultStaleness]
    │   │   👁️  Def: internal
    │   │ └─ [5] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 5)
    │   │     💬 Args: [a < b, a, b]
    │   │     👁️  Def: internal
    │   │   └─ [6] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 6)
    │   │       💬 Args: [condition]
    │   │       👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: SuperOracleBase._scaleQuoteAmount(uint256,uint256,uint8,uint8,uint8) (NodeID: 7)
    │       💬 Args: [baseAmount, uint256(answer), feedDecimals, baseDecimals, quoteDecimals]
    │       👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 8)
    │         💬 Args: [baseAmount, uint256(answer) * (10 ** quoteDecimals), 10 ** (feedDecimals + baseDecimals)]
    │         👁️  Def: internal
    │       ├─ [6] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 9)
    │       │   💬 Args: [x, y]
    │       │   👁️  Def: internal
    │       └─ [6] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 10)
    │           💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
    │           👁️  Def: internal
    │         └─ [7] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 11)
    │             💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
    │             👁️  Def: internal
    │           └─ [8] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 12)
    │               💬 Args: [condition]
    │               👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SuperOracleBase._calculateStdDev(uint256[],uint256) (NodeID: 13)
    ...
    │ │         💬 Args: [condition]
    │ │         👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: SuperOracleBase._sqrt(uint256) (NodeID: 19)
    │     💬 Args: [variance]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: SuperOracleBase._getQuoteFromOracle(address,uint256,address,address,bool) (NodeID: 20)
        💬 Args: [_oracle, baseAmount, base, quote, true]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: Math.min(uint256,uint256) (NodeID: 21)
      │   💬 Args: [feedMaxStaleness[oracle], defaultStaleness]
      │   👁️  Def: internal
      ...
      │       💬 Args: [condition]
      │       👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: SuperOracleBase._scaleQuoteAmount(uint256,uint256,uint8,uint8,uint8) (NodeID: 24)
          💬 Args: [baseAmount, uint256(answer), feedDecimals, baseDecimals, quoteDecimals]
          👁️  Def: internal
