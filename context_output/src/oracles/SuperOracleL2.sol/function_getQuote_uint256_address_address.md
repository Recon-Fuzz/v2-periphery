...
┌─ [0] ⚙️ FUNCTION: SuperOracleBase.getQuote(uint256,address,address) (NodeID: 0)
  ...
  └─ [1] ⚙️ FUNCTION: SuperOracleBase.getQuoteFromProvider(uint256,address,address,bytes32) (NodeID: 1)
    ...
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: SuperOracleL2._getQuoteFromOracle(address,uint256,address,address,bool) (NodeID: 3)
    ...
    │     💬 Args: [variance]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: SuperOracleL2._getQuoteFromOracle(address,uint256,address,address,bool) (NodeID: 20)
