...
- **Name**: ISuperVaultStrategy
- **Type**: Interface
- **Path**: src/interfaces/SuperVault/ISuperVaultStrategy.sol
- **Documentation**: @title ISuperVaultStrategy
...
### YIELD_SOURCE_ALREADY_EXISTS

```solidity
error YIELD_SOURCE_ALREADY_EXISTS();
```

### INVALID_PERFORMANCE_FEE_BPS

```solidity
error INVALID_PERFORMANCE_FEE_BPS();
```

### MINIMUM_OUTPUT_AMOUNT_ASSETS_NOT_MET
...
### CONTROLLERS_NOT_SORTED_UNIQUE

```solidity
error CONTROLLERS_NOT_SORTED_UNIQUE();
```

### ZERO_SHARE_FULFILLMENT_DISALLOWED

```solidity
error ZERO_SHARE_FULFILLMENT_DISALLOWED();
```

### NOT_ENOUGH_FREE_ASSETS_FEE_SKIM

```solidity
error NOT_ENOUGH_FREE_ASSETS_FEE_SKIM();
```

### SKIM_TIMELOCK_ACTIVE
