...
- **Name**: IECDSAPPSOracle
- **Type**: Interface
- **Path**: src/interfaces/oracles/IECDSAPPSOracle.sol
...
### noncePerStrategy(address)

- **Signature**: `noncePerStrategy(address)`
- **Visibility**: external
- **Source Range**: 4638:77:523
