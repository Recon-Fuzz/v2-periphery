...
- **Kind**: internal
- **Source**: 60438:135:511
- **Link**: `src/SuperVault/SuperVaultAggregator.sol:SuperVaultAggregator:_getSuperBank()`
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregator.claimUpkeep(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: SuperVaultAggregator._getSuperBank() (NodeID: 1)
      💬 Args: [no args]
      👁️  Def: internal
```
