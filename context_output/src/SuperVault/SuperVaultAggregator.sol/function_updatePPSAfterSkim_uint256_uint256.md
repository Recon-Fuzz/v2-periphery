# Function: updatePPSAfterSkim(uint256,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregator.updatePPSAfterSkim(uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256,enum Math.Rounding) (NodeID: 1)
  │   💬 Args: [oldPPS, BPS_PRECISION - MAX_PERFORMANCE_FEE, BPS_PRECISION, Math.Rounding.Ceil]
  │   👁️  Def: internal
  ...
  │           💬 Args: [condition]
  │           👁️  Def: internal
  └─ [1] 🔒 MODIFIER: SuperVaultAggregator.validStrategy(address) (NodeID: 9)
      💬 Args: [msg.sender]
    └─ [2] ⚙️ FUNCTION: SuperVaultAggregator._validStrategy(address) (NodeID: 10)
        💬 Args: [msg.sender]
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: EnumerableSet.contains(struct EnumerableSet.AddressSet,address) (NodeID: 11)
