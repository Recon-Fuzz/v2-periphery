...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregator.changePrimaryManager(address,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │     👁️  Def: private
  └─ [1] 🔒 MODIFIER: SuperVaultAggregator.validStrategy(address) (NodeID: 5)
      💬 Args: [strategy]
    └─ [2] ⚙️ FUNCTION: SuperVaultAggregator._validStrategy(address) (NodeID: 6)
        💬 Args: [strategy]
        👁️  Def: internal
