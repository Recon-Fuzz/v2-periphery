# Function: removeSecondaryManager(address,address)
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregator.removeSecondaryManager(address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │     👁️  Def: private
  └─ [1] 🔒 MODIFIER: SuperVaultAggregator.validStrategy(address) (NodeID: 3)
      💬 Args: [strategy]
    └─ [2] ⚙️ FUNCTION: SuperVaultAggregator._validStrategy(address) (NodeID: 4)
        💬 Args: [strategy]
        👁️  Def: internal
