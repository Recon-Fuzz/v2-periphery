# Function: unpauseStrategy(address)
...
- **Kind**: internal
- **Source**: 45607:301:511
- **Link**: `src/SuperVault/SuperVaultAggregator.sol:SuperVaultAggregator:isAnyManager(address,address)`
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregator.unpauseStrategy(address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: SuperVaultAggregator.isAnyManager(address,address) (NodeID: 1)
  ...
  │       👁️  Def: private
  └─ [1] 🔒 MODIFIER: SuperVaultAggregator.validStrategy(address) (NodeID: 4)
      💬 Args: [strategy]
    └─ [2] ⚙️ FUNCTION: SuperVaultAggregator._validStrategy(address) (NodeID: 5)
        💬 Args: [strategy]
        👁️  Def: internal
