# Function: manageYieldSource(address,address,enum ISuperVaultStrategy.YieldSourceAction)
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultStrategy.manageYieldSource(address,address,enum ISuperVaultStrategy.YieldSourceAction) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
