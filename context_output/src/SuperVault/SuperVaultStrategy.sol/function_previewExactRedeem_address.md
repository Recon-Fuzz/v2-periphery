# Function: previewExactRedeem(address)
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultStrategy.previewExactRedeem(address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: SuperVaultStrategy.getStoredPPS() (NodeID: 1)
  │   💬 Args: [no args]
  │   👁️  Def: public
  ...
  │   💬 Args: [shares, pps, PRECISION, Math.Rounding.Floor]
  │   👁️  Def: internal
  ...
  │           💬 Args: [condition]
  │           👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: SuperVaultAccountingLib.computeMinNetOut(uint256,uint256,uint16,uint256) (NodeID: 11)
      💬 Args: [shares, state.averageRequestPPS, slippageBps, PRECISION]
      👁️  Def: internal
    ...
    │           💬 Args: [condition]
    │           👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256,enum Math.Rounding) (NodeID: 20)
        💬 Args: [expectedAssets, BPS_PRECISION - slippageBps, BPS_PRECISION, Math.Rounding.Floor]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 21)
      │   💬 Args: [unsignedRoundsUp(rounding) && (mulmod(x, y, denominator) > 0)]
      │   👁️  Def: internal
      │ └─ [4] ⚙️ FUNCTION: Math.unsignedRoundsUp(enum Math.Rounding) (NodeID: 22)
      │     💬 Args: [rounding]
      │     👁️  Def: internal
