...
- **ISuperVaultStrategy::quoteMintAssetsGross(uint256)**
- **IERC20::safeTransferFrom(contract IERC20,address,address,uint256)**
- **ISuperVaultStrategy::handleOperations4626Mint(address,uint256,uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperVault.mint(uint256,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
