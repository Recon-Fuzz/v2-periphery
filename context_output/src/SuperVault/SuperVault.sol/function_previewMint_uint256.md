...
function previewMint(uint256 shares) override public view returns (uint256) {
    ...
    if (feeBps >= BPS_PRECISION) return 0;
...
```
┌─ [0] ⚙️ FUNCTION: SuperVault.previewMint(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │           💬 Args: [condition]
  │           👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SuperVault._getManagementFeeConfig() (NodeID: 10)
  │   💬 Args: [no args]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256,enum Math.Rounding) (NodeID: 11)
      💬 Args: [assetsGross, BPS_PRECISION, (BPS_PRECISION - feeBps), Math.Rounding.Ceil]
      👁️  Def: internal
