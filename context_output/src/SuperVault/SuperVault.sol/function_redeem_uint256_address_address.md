...
```
┌─ [0] ⚙️ FUNCTION: SuperVault.redeem(uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [shares, averageWithdrawPrice, PRECISION, Math.Rounding.Floor]
  │   👁️  Def: internal
  ...
  │           💬 Args: [condition]
  │           👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SuperVault.maxWithdraw(address) (NodeID: 11)
  │   💬 Args: [controller]
  │   👁️  Def: public
