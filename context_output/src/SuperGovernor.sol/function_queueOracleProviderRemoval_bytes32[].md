# Function: queueOracleProviderRemoval(bytes32[])
...
- **ISuperOracle::queueProviderRemoval(bytes32[])**
...
```
┌─ [0] ⚙️ FUNCTION: SuperGovernor.queueOracleProviderRemoval(bytes32[]) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
