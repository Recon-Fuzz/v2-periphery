...
- **Kind**: internal
- **Source**: 4726:153:389
- **Link**: `lib/v2-core/src/hooks/swappers/odos/SwapOdosV2Hook.sol:SwapOdosV2Hook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 5256:299:389
- **Link**: `lib/v2-core/src/hooks/swappers/odos/SwapOdosV2Hook.sol:SwapOdosV2Hook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: SwapOdosV2Hook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: SwapOdosV2Hook._getBalance(address,bytes) (NodeID: 12)
      │   💬 Args: [account, data]
      │   👁️  Def: private
