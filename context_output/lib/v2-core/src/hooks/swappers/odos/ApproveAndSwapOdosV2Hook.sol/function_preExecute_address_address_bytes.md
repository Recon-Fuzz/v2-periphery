...
- **Kind**: internal
- **Source**: 5647:153:388
- **Link**: `lib/v2-core/src/hooks/swappers/odos/ApproveAndSwapOdosV2Hook.sol:ApproveAndSwapOdosV2Hook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 6177:299:388
- **Link**: `lib/v2-core/src/hooks/swappers/odos/ApproveAndSwapOdosV2Hook.sol:ApproveAndSwapOdosV2Hook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ApproveAndSwapOdosV2Hook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: ApproveAndSwapOdosV2Hook._getBalance(address,bytes) (NodeID: 12)
      │   💬 Args: [account, data]
      │   👁️  Def: private
