...
- **Name**: ApproveAndSwapOdosV2Hook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/swappers/odos/ApproveAndSwapOdosV2Hook.sol
- **Documentation**: @title ApproveAndSwapOdosV2Hook
