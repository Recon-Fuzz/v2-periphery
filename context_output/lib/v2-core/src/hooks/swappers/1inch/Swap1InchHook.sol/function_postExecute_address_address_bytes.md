...
- **Kind**: internal
- **Source**: 6062:178:387
- **Link**: `lib/v2-core/src/hooks/swappers/1inch/Swap1InchHook.sol:Swap1InchHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 14212:467:387
- **Link**: `lib/v2-core/src/hooks/swappers/1inch/Swap1InchHook.sol:Swap1InchHook:_getBalance(bytes,address)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: Swap1InchHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: Swap1InchHook._getBalance(bytes,address) (NodeID: 17)
      │   💬 Args: [data, account]
      │   👁️  Def: private
