...
- **Name**: Swap1InchHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/swappers/1inch/Swap1InchHook.sol
- **Documentation**: @title Swap1InchHook
...
**I1InchAggregationRouterV6**: [lib/v2-core/src/vendor/1inch/I1InchAggregationRouterV6.sol/interface_I1InchAggregationRouterV6.md]
