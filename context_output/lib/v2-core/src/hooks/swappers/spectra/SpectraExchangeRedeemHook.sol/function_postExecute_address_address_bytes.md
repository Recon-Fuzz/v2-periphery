...
- **Kind**: internal
- **Source**: 5715:178:393
- **Link**: `lib/v2-core/src/hooks/swappers/spectra/SpectraExchangeRedeemHook.sol:SpectraExchangeRedeemHook:_postExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: SpectraExchangeRedeemHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: SpectraExchangeRedeemHook._getBalance(bytes,address) (NodeID: 17)
      │   💬 Args: [data, account]
      │   👁️  Def: private
      │ ├─ [4] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 18)
      │ │   💬 Args: [data, 32]
      │ │   👁️  Def: internal
      │ └─ [4] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 19)
      │     💬 Args: [data, 72]
      │     👁️  Def: internal
