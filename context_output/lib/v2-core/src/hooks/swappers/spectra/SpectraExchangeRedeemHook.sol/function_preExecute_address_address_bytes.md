...
- **Kind**: internal
- **Source**: 5556:153:393
- **Link**: `lib/v2-core/src/hooks/swappers/spectra/SpectraExchangeRedeemHook.sol:SpectraExchangeRedeemHook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 7924:253:393
- **Link**: `lib/v2-core/src/hooks/swappers/spectra/SpectraExchangeRedeemHook.sol:SpectraExchangeRedeemHook:_getBalance(bytes,address)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: SpectraExchangeRedeemHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: SpectraExchangeRedeemHook._getBalance(bytes,address) (NodeID: 12)
      │   💬 Args: [data, account]
      │   👁️  Def: private
      │ ├─ [4] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 13)
      │ │   💬 Args: [data, 32]
      │ │   👁️  Def: internal
      │ └─ [4] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 14)
      │     💬 Args: [data, 72]
      │     👁️  Def: internal
