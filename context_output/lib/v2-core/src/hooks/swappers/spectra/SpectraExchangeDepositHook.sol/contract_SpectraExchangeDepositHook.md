...
- **Name**: SpectraExchangeDepositHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/swappers/spectra/SpectraExchangeDepositHook.sol
- **Documentation**: @title SpectraExchangeDepositHook
...
**ISpectraRouter**: [lib/v2-core/src/vendor/spectra/ISpectraRouter.sol/interface_ISpectraRouter.md]

## Structs

### ValidateTxDataParams
