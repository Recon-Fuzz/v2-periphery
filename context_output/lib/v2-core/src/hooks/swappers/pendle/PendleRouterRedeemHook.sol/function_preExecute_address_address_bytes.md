...
- **Kind**: internal
- **Source**: 5465:153:390
- **Link**: `lib/v2-core/src/hooks/swappers/pendle/PendleRouterRedeemHook.sol:PendleRouterRedeemHook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 8789:539:390
- **Link**: `lib/v2-core/src/hooks/swappers/pendle/PendleRouterRedeemHook.sol:PendleRouterRedeemHook:_getBalance(bytes,address)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: PendleRouterRedeemHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: PendleRouterRedeemHook._getBalance(bytes,address) (NodeID: 12)
      │   💬 Args: [data, account]
      │   👁️  Def: private
