...
- **Kind**: internal
- **Source**: 5624:178:390
- **Link**: `lib/v2-core/src/hooks/swappers/pendle/PendleRouterRedeemHook.sol:PendleRouterRedeemHook:_postExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: PendleRouterRedeemHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: PendleRouterRedeemHook._getBalance(bytes,address) (NodeID: 17)
      │   💬 Args: [data, account]
      │   👁️  Def: private
