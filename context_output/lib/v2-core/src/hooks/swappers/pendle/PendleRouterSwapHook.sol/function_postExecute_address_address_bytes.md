...
- **Kind**: internal
- **Source**: 7820:178:391
- **Link**: `lib/v2-core/src/hooks/swappers/pendle/PendleRouterSwapHook.sol:PendleRouterSwapHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 13304:290:391
- **Link**: `lib/v2-core/src/hooks/swappers/pendle/PendleRouterSwapHook.sol:PendleRouterSwapHook:_getBalance(address,bytes)`
...
- **Kind**: internal
- **Source**: 11928:750:391
- **Link**: `lib/v2-core/src/hooks/swappers/pendle/PendleRouterSwapHook.sol:PendleRouterSwapHook:_decodeTokenOut(bytes)`
...
function _decodeTokenOut(bytes calldata data) private view returns (address tokenOut) {
    ...
    if (selector == IPendleRouterV4.swapExactTokenForPt.selector) {
        (, address market, , , , ) = abi.decode(data[4:], (address, address, uint256, ApproxParams, TokenInput, LimitOrderData));
        (, tokenOut, ) = IPendleMarket(market).readTokens();
    } else if (selector == IPendleRouterV4.swapExactPtForToken.selector) {
        (, , , TokenOutput memory output, ) = abi.decode(data[4:], (address, address, uint256, TokenOutput, LimitOrderData));
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: PendleRouterSwapHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: PendleRouterSwapHook._getBalance(address,bytes) (NodeID: 17)
      │   💬 Args: [account, data]
      │   👁️  Def: private
      │ └─ [4] ⚙️ FUNCTION: PendleRouterSwapHook._decodeTokenOut(bytes) (NodeID: 18)
      │     💬 Args: [data[85:]]
      │     👁️  Def: private
