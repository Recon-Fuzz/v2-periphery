...
- **Kind**: internal
- **Source**: 7661:153:391
- **Link**: `lib/v2-core/src/hooks/swappers/pendle/PendleRouterSwapHook.sol:PendleRouterSwapHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: PendleRouterSwapHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: PendleRouterSwapHook._getBalance(address,bytes) (NodeID: 12)
      │   💬 Args: [account, data]
      │   👁️  Def: private
      │ └─ [4] ⚙️ FUNCTION: PendleRouterSwapHook._decodeTokenOut(bytes) (NodeID: 13)
      │     💬 Args: [data[85:]]
      │     👁️  Def: private
