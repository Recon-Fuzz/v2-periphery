...
- **Kind**: internal
- **Source**: 3083:335:385
- **Link**: `lib/v2-core/src/hooks/stake/gearbox/GearboxUnstakeHook.sol:GearboxUnstakeHook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 3962:139:385
- **Link**: `lib/v2-core/src/hooks/stake/gearbox/GearboxUnstakeHook.sol:GearboxUnstakeHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: GearboxUnstakeHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 10)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: GearboxUnstakeHook._getBalance(address,bytes) (NodeID: 14)
      │   💬 Args: [account, data]
      │   👁️  Def: private
