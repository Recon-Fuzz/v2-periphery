...
- **Name**: GearboxUnstakeHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/stake/gearbox/GearboxUnstakeHook.sol
- **Documentation**: @title GearboxUnstakeHook
