...
- **Name**: GearboxStakeHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/stake/gearbox/GearboxStakeHook.sol
- **Documentation**: @title GearboxStakeHook
