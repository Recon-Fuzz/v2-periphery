...
**Contract**: [lib/v2-core/src/hooks/stake/gearbox/GearboxStakeHook.sol/contract_GearboxStakeHook.md]

## Metadata

- **Contract**: GearboxStakeHook
...
- **Kind**: internal
- **Source**: 3329:178:384
- **Link**: `lib/v2-core/src/hooks/stake/gearbox/GearboxStakeHook.sol:GearboxStakeHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 3867:177:384
- **Link**: `lib/v2-core/src/hooks/stake/gearbox/GearboxStakeHook.sol:GearboxStakeHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: GearboxStakeHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: GearboxStakeHook._getBalance(address,bytes) (NodeID: 17)
      │   💬 Args: [account, data]
      │   👁️  Def: private
