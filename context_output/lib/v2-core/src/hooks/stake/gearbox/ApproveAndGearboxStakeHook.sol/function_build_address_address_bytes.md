...
**Contract**: [lib/v2-core/src/hooks/stake/gearbox/ApproveAndGearboxStakeHook.sol/contract_ApproveAndGearboxStakeHook.md]

## Metadata

- **Contract**: ApproveAndGearboxStakeHook
...
- **Kind**: internal
- **Source**: 1685:1401:383
- **Link**: `lib/v2-core/src/hooks/stake/gearbox/ApproveAndGearboxStakeHook.sol:ApproveAndGearboxStakeHook:_buildHookExecutions(address,address,bytes)`
...
function _buildHookExecutions(address prevHook, address account, bytes calldata data) override internal view returns (Execution[] memory executions) {
    ...
    executions[1] = Execution({target: token, value: 0, callData: abi.encodeCall(IERC20.approve, (yieldSource, amount))});
    executions[2] = Execution({target: yieldSource, value: 0, callData: abi.encodeCall(IGearboxFarmingPool.deposit, (amount))});
...
- **Kind**: internal
- **Source**: 4471:138:383
- **Link**: `lib/v2-core/src/hooks/stake/gearbox/ApproveAndGearboxStakeHook.sol:ApproveAndGearboxStakeHook:_decodeAmount(bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.build(address,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ApproveAndGearboxStakeHook._buildHookExecutions(address,address,bytes) (NodeID: 1)
    ...
    │   💬 Args: [data, 52]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ApproveAndGearboxStakeHook._decodeAmount(bytes) (NodeID: 5)
    │   💬 Args: [data]
    │   👁️  Def: private
