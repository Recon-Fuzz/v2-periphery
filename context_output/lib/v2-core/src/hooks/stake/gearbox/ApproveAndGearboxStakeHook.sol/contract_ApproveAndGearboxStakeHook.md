...
- **Name**: ApproveAndGearboxStakeHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/stake/gearbox/ApproveAndGearboxStakeHook.sol
- **Documentation**: @title ApproveAndGearboxStakeHook
