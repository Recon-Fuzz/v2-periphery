...
- **Kind**: internal
- **Source**: 4100:178:383
- **Link**: `lib/v2-core/src/hooks/stake/gearbox/ApproveAndGearboxStakeHook.sol:ApproveAndGearboxStakeHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 4615:177:383
- **Link**: `lib/v2-core/src/hooks/stake/gearbox/ApproveAndGearboxStakeHook.sol:ApproveAndGearboxStakeHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ApproveAndGearboxStakeHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: ApproveAndGearboxStakeHook._getBalance(address,bytes) (NodeID: 17)
      │   💬 Args: [account, data]
      │   👁️  Def: private
      │ └─ [4] ⚙️ FUNCTION: HookDataDecoder.extractYieldSource(bytes) (NodeID: 18)
      │     💬 Args: [data]
      │     👁️  Def: internal
      │   └─ [5] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 19)
      │       💬 Args: [data, 32]
      │       👁️  Def: internal
