...
```
┌─ [0] 🏗️ CONSTRUCTOR: ApproveAndGearboxStakeHook.constructor() (NodeID: 0)
    💬 Args: [no args]
    🏗️  Contract: ApproveAndGearboxStakeHook
  └─ [1] 🏗️ CONSTRUCTOR: BaseHook.constructor(enum ISuperHook.HookType,bytes32) (NodeID: 1)
      💬 Args: [HookType.NONACCOUNTING, HookSubTypes.STAKE]
      🏗️  Contract: BaseHook
```
