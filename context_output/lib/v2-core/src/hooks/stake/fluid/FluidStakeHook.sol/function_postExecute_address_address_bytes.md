...
- **Kind**: internal
- **Source**: 3460:178:381
- **Link**: `lib/v2-core/src/hooks/stake/fluid/FluidStakeHook.sol:FluidStakeHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 3975:185:381
- **Link**: `lib/v2-core/src/hooks/stake/fluid/FluidStakeHook.sol:FluidStakeHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: FluidStakeHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: FluidStakeHook._getBalance(address,bytes) (NodeID: 17)
      │   💬 Args: [account, data]
      │   👁️  Def: private
