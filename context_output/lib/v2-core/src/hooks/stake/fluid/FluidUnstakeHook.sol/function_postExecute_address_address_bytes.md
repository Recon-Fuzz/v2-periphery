...
- **Kind**: internal
- **Source**: 3574:178:382
- **Link**: `lib/v2-core/src/hooks/stake/fluid/FluidUnstakeHook.sol:FluidUnstakeHook:_postExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: FluidUnstakeHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: FluidUnstakeHook._getBalance(address,bytes) (NodeID: 17)
      │   💬 Args: [account, data]
      │   👁️  Def: private
