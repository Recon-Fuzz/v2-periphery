...
- **Kind**: internal
- **Source**: 3213:355:382
- **Link**: `lib/v2-core/src/hooks/stake/fluid/FluidUnstakeHook.sol:FluidUnstakeHook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 4089:160:382
- **Link**: `lib/v2-core/src/hooks/stake/fluid/FluidUnstakeHook.sol:FluidUnstakeHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: FluidUnstakeHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 10)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: FluidUnstakeHook._getBalance(address,bytes) (NodeID: 14)
      │   💬 Args: [account, data]
      │   👁️  Def: private
