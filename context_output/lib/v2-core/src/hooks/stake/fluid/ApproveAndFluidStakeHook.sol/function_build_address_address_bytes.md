...
**Contract**: [lib/v2-core/src/hooks/stake/fluid/ApproveAndFluidStakeHook.sol/contract_ApproveAndFluidStakeHook.md]

## Metadata

- **Contract**: ApproveAndFluidStakeHook
...
- **Kind**: internal
- **Source**: 1694:1360:380
- **Link**: `lib/v2-core/src/hooks/stake/fluid/ApproveAndFluidStakeHook.sol:ApproveAndFluidStakeHook:_buildHookExecutions(address,address,bytes)`
...
function _buildHookExecutions(address prevHook, address account, bytes calldata data) override internal view returns (Execution[] memory executions) {
    ...
    executions[2] = Execution({target: yieldSource, value: 0, callData: abi.encodeCall(IFluidLendingStakingRewards.stake, (amount))});
...
- **Kind**: internal
- **Source**: 4553:138:380
- **Link**: `lib/v2-core/src/hooks/stake/fluid/ApproveAndFluidStakeHook.sol:ApproveAndFluidStakeHook:_decodeAmount(bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.build(address,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ApproveAndFluidStakeHook._buildHookExecutions(address,address,bytes) (NodeID: 1)
    ...
    │   💬 Args: [data, 52]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ApproveAndFluidStakeHook._decodeAmount(bytes) (NodeID: 5)
    │   💬 Args: [data]
    │   👁️  Def: private
