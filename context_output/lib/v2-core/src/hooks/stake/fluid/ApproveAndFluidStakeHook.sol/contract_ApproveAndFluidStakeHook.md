...
- **Name**: ApproveAndFluidStakeHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/stake/fluid/ApproveAndFluidStakeHook.sol
- **Documentation**: @title ApproveAndFluidStakeHook
