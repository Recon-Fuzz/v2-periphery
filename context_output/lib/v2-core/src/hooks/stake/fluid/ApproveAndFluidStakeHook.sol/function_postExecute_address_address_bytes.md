...
- **Kind**: internal
- **Source**: 4182:178:380
- **Link**: `lib/v2-core/src/hooks/stake/fluid/ApproveAndFluidStakeHook.sol:ApproveAndFluidStakeHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 4697:185:380
- **Link**: `lib/v2-core/src/hooks/stake/fluid/ApproveAndFluidStakeHook.sol:ApproveAndFluidStakeHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ApproveAndFluidStakeHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: ApproveAndFluidStakeHook._getBalance(address,bytes) (NodeID: 17)
      │   💬 Args: [account, data]
      │   👁️  Def: private
