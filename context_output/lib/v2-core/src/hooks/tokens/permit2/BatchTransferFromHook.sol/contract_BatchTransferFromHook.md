...
- **Name**: BatchTransferFromHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/tokens/permit2/BatchTransferFromHook.sol
- **Documentation**: @title BatchTransferFromHook
...
**IPermit2**: [lib/v2-core/src/vendor/uniswap/permit2/IPermit2.sol/interface_IPermit2.md]
