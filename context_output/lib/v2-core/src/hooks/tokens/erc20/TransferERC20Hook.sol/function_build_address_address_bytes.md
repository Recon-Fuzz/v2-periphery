...
- **Kind**: internal
- **Source**: 1313:918:397
- **Link**: `lib/v2-core/src/hooks/tokens/erc20/TransferERC20Hook.sol:TransferERC20Hook:_buildHookExecutions(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.build(address,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: TransferERC20Hook._buildHookExecutions(address,address,bytes) (NodeID: 1)
