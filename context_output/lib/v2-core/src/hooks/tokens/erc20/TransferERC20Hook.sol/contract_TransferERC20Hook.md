...
- **Name**: TransferERC20Hook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/tokens/erc20/TransferERC20Hook.sol
- **Documentation**: @title TransferERC20Hook
