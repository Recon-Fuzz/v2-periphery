...
- **Kind**: internal
- **Source**: 3242:169:397
- **Link**: `lib/v2-core/src/hooks/tokens/erc20/TransferERC20Hook.sol:TransferERC20Hook:_postExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: TransferERC20Hook._postExecute(address,address,bytes) (NodeID: 7)
      💬 Args: [prevHook, account, data]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
        💬 Args: [_getBalance(data) - getOutAmount(account), account]
        👁️  Def: internal
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: TransferERC20Hook._getBalance(bytes) (NodeID: 17)
      │   💬 Args: [data]
      │   👁️  Def: private
