...
- **Kind**: internal
- **Source**: 3092:144:397
- **Link**: `lib/v2-core/src/hooks/tokens/erc20/TransferERC20Hook.sol:TransferERC20Hook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 3604:226:397
- **Link**: `lib/v2-core/src/hooks/tokens/erc20/TransferERC20Hook.sol:TransferERC20Hook:_getBalance(bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: TransferERC20Hook._preExecute(address,address,bytes) (NodeID: 7)
      💬 Args: [prevHook, account, data]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
        💬 Args: [_getBalance(data), account]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: TransferERC20Hook._getBalance(bytes) (NodeID: 12)
      │   💬 Args: [data]
      │   👁️  Def: private
