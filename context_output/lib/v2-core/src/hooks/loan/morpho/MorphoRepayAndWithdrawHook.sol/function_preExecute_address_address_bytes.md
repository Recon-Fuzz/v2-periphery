...
- **Kind**: internal
- **Source**: 10357:469:377
- **Link**: `lib/v2-core/src/hooks/loan/morpho/MorphoRepayAndWithdrawHook.sol:MorphoRepayAndWithdrawHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MorphoRepayAndWithdrawHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 19)
        💬 Args: [getCollateralTokenBalance(account, data), account]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BaseLoanHook.getCollateralTokenBalance(address,bytes) (NodeID: 23)
      │   💬 Args: [account, data]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 24)
      │     💬 Args: [data, 20]
      │     👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BaseHook._getCurrentExecutionContext(address) (NodeID: 20)
      │   💬 Args: [caller]
      │   👁️  Def: private
      │ └─ [4] ⚙️ FUNCTION: BaseHook._makeAccountContextKey(address) (NodeID: 21)
      │     💬 Args: [caller]
      │     👁️  Def: private
      └─ [3] ⚙️ FUNCTION: BaseHook._makeKey(uint256,uint256) (NodeID: 22)
