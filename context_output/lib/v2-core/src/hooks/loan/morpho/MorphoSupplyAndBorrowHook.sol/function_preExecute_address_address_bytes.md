...
- **Kind**: internal
- **Source**: 7117:200:379
- **Link**: `lib/v2-core/src/hooks/loan/morpho/MorphoSupplyAndBorrowHook.sol:MorphoSupplyAndBorrowHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MorphoSupplyAndBorrowHook._preExecute(address,address,bytes) (NodeID: 7)
