...
- **Name**: MorphoSupplyAndBorrowHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/loan/morpho/MorphoSupplyAndBorrowHook.sol
- **Documentation**: @title MorphoSupplyAndBorrowHook
...
- **Details**: [function_deriveLoanAmount_uint256_uint256_uint256_address.md](./function_deriveLoanAmount_uint256_uint256_uint256_address.md)
