...
- **Kind**: internal
- **Source**: 7323:192:379
- **Link**: `lib/v2-core/src/hooks/loan/morpho/MorphoSupplyAndBorrowHook.sol:MorphoSupplyAndBorrowHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 1965:231:375
- **Link**: `lib/v2-core/src/hooks/loan/BaseLoanHook.sol:BaseLoanHook:getCollateralTokenBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MorphoSupplyAndBorrowHook._postExecute(address,address,bytes) (NodeID: 7)
      💬 Args: [prevHook, account, data]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
        💬 Args: [getOutAmount(account) - getCollateralTokenBalance(account, data), account]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BaseLoanHook.getCollateralTokenBalance(address,bytes) (NodeID: 12)
      │   💬 Args: [account, data]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 13)
      │     💬 Args: [data, 20]
      │     👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BaseHook.getOutAmount(address) (NodeID: 14)
      │   💬 Args: [account]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: BaseHook._getOutAmount(uint256) (NodeID: 15)
      │     💬 Args: [_getCurrentExecutionContext(caller)]
      │     👁️  Def: private
      │   ├─ [5] ⚙️ FUNCTION: BaseHook._getCurrentExecutionContext(address) (NodeID: 17)
      │   │   💬 Args: [caller]
      │   │   👁️  Def: private
      │   │ └─ [6] ⚙️ FUNCTION: BaseHook._makeAccountContextKey(address) (NodeID: 18)
      │   │     💬 Args: [caller]
      │   │     👁️  Def: private
      │   └─ [5] ⚙️ FUNCTION: BaseHook._makeKey(uint256,uint256) (NodeID: 16)
