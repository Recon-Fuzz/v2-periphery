...
- **Kind**: internal
- **Source**: 5080:124:373
- **Link**: `lib/v2-core/src/hooks/claim/merkl/MerklClaimRewardHook.sol:MerklClaimRewardHook:_postExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MerklClaimRewardHook._postExecute(address,address,bytes) (NodeID: 7)
