...
- **Kind**: internal
- **Source**: 4951:123:373
- **Link**: `lib/v2-core/src/hooks/claim/merkl/MerklClaimRewardHook.sol:MerklClaimRewardHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MerklClaimRewardHook._preExecute(address,address,bytes) (NodeID: 7)
