...
- **Name**: YearnClaimOneRewardHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/claim/yearn/YearnClaimOneRewardHook.sol
- **Documentation**: @title YearnClaimOneRewardHook
