...
- **Kind**: internal
- **Source**: 3027:262:374
- **Link**: `lib/v2-core/src/hooks/claim/yearn/YearnClaimOneRewardHook.sol:YearnClaimOneRewardHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: YearnClaimOneRewardHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 9)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BaseClaimRewardHook._getBalance(bytes,address) (NodeID: 13)
      │   💬 Args: [data, account]
      │   👁️  Def: internal
