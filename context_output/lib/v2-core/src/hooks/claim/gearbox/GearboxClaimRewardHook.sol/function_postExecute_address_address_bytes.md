...
- **Kind**: internal
- **Source**: 3378:178:372
- **Link**: `lib/v2-core/src/hooks/claim/gearbox/GearboxClaimRewardHook.sol:GearboxClaimRewardHook:_postExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: GearboxClaimRewardHook._postExecute(address,address,bytes) (NodeID: 7)
