...
- **Kind**: internal
- **Source**: 2902:470:372
- **Link**: `lib/v2-core/src/hooks/claim/gearbox/GearboxClaimRewardHook.sol:GearboxClaimRewardHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: GearboxClaimRewardHook._preExecute(address,address,bytes) (NodeID: 7)
