...
- **Name**: GearboxClaimRewardHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/claim/gearbox/GearboxClaimRewardHook.sol
- **Documentation**: @title GearboxClaimRewardHook
...
- **ISuperHookOutflow** [lib/v2-core/src/interfaces/ISuperHook.sol/interface_ISuperHookOutflow.md]
- **ISuperHookInflowOutflow** [lib/v2-core/src/interfaces/ISuperHook.sol/interface_ISuperHookInflowOutflow.md]
...
### ASSET_ZERO_ADDRESS (inherited from BaseClaimRewardHook)

```solidity
error ASSET_ZERO_ADDRESS();
```

### INVALID_REWARD_TOKEN (inherited from BaseClaimRewardHook)

```solidity
error INVALID_REWARD_TOKEN();
```

### REWARD_TOKEN_ZERO_ADDRESS (inherited from BaseClaimRewardHook)
...
- **Visibility**: external
- **Source Range**: 2066:93:372
- **Details**: [function_decodeAmount_bytes.md](./function_decodeAmount_bytes.md)
...
- **Details**: [function_replaceCalldataAmount_bytes_uint256.md](./function_replaceCalldataAmount_bytes_uint256.md)
