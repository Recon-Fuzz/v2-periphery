...
- **Kind**: internal
- **Source**: 5355:232:418
- **Link**: `lib/v2-core/src/hooks/vaults/vault-bank/MintSuperPositionsHook.sol:MintSuperPositionsHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MintSuperPositionsHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    │   💬 Args: [data, 105]
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: HookDataDecoder.extractYieldSource(bytes) (NodeID: 10)
        💬 Args: [data]
        👁️  Def: internal
