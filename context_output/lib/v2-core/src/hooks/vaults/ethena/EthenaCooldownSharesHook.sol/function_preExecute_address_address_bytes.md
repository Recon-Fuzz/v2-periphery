...
- **Kind**: internal
- **Source**: 3332:148:416
- **Link**: `lib/v2-core/src/hooks/vaults/ethena/EthenaCooldownSharesHook.sol:EthenaCooldownSharesHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: EthenaCooldownSharesHook._preExecute(address,address,bytes) (NodeID: 7)
