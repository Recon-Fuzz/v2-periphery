...
- **Name**: EthenaCooldownSharesHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/vaults/ethena/EthenaCooldownSharesHook.sol
- **Documentation**: @notice         bytes32 yieldSourceOracleId = bytes32(BytesLib.slice(data, 0, 32), 0);
