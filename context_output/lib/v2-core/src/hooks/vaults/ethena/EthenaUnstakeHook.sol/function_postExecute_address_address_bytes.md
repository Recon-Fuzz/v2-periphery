...
- **Kind**: internal
- **Source**: 2887:562:417
- **Link**: `lib/v2-core/src/hooks/vaults/ethena/EthenaUnstakeHook.sol:EthenaUnstakeHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 3642:139:417
- **Link**: `lib/v2-core/src/hooks/vaults/ethena/EthenaUnstakeHook.sol:EthenaUnstakeHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: EthenaUnstakeHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    │     💬 Args: [data, 32]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseHook.getOutAmount(address) (NodeID: 10)
    │   💬 Args: [account]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: BaseHook._getOutAmount(uint256) (NodeID: 11)
    │     💬 Args: [_getCurrentExecutionContext(caller)]
    │     👁️  Def: private
    │   ├─ [4] ⚙️ FUNCTION: BaseHook._getCurrentExecutionContext(address) (NodeID: 13)
    │   │   💬 Args: [caller]
    │   │   👁️  Def: private
    │   │ └─ [5] ⚙️ FUNCTION: BaseHook._makeAccountContextKey(address) (NodeID: 14)
    │   │     💬 Args: [caller]
    │   │     👁️  Def: private
    │   └─ [4] ⚙️ FUNCTION: BaseHook._makeKey(uint256,uint256) (NodeID: 12)
    │       💬 Args: [context, OUT_AMOUNT_OFFSET]
    │       👁️  Def: private
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 15)
        💬 Args: [_getBalance(account, data) - outAmount, account]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: EthenaUnstakeHook._getBalance(address,bytes) (NodeID: 19)
      │   💬 Args: [account, data]
      │   👁️  Def: private
