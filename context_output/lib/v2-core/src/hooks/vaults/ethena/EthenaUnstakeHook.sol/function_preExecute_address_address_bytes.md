...
- **Kind**: internal
- **Source**: 2560:321:417
- **Link**: `lib/v2-core/src/hooks/vaults/ethena/EthenaUnstakeHook.sol:EthenaUnstakeHook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 3787:215:417
- **Link**: `lib/v2-core/src/hooks/vaults/ethena/EthenaUnstakeHook.sol:EthenaUnstakeHook:_getSharesBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: EthenaUnstakeHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: EthenaUnstakeHook._getBalance(address,bytes) (NodeID: 14)
    │ │   💬 Args: [account, data]
    │ │   👁️  Def: private
    ...
    │     👁️  Def: private
    └─ [2] ⚙️ FUNCTION: EthenaUnstakeHook._getSharesBalance(address,bytes) (NodeID: 15)
        💬 Args: [account, data]
        👁️  Def: private
