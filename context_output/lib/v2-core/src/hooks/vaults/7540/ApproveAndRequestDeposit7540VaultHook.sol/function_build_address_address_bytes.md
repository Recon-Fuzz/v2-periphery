...
- **Kind**: internal
- **Source**: 1818:1393:405
- **Link**: `lib/v2-core/src/hooks/vaults/7540/ApproveAndRequestDeposit7540VaultHook.sol:ApproveAndRequestDeposit7540VaultHook:_buildHookExecutions(address,address,bytes)`
...
function _buildHookExecutions(address prevHook, address account, bytes calldata data) override internal view returns (Execution[] memory executions) {
    ...
    executions[2] = Execution({target: yieldSource, value: 0, callData: abi.encodeCall(IERC7540.requestDeposit, (amount, account, account))});
...
┌─ [0] ⚙️ FUNCTION: BaseHook.build(address,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ApproveAndRequestDeposit7540VaultHook._buildHookExecutions(address,address,bytes) (NodeID: 1)
    ...
    │   💬 Args: [data, 52]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ApproveAndRequestDeposit7540VaultHook._decodeAmount(bytes) (NodeID: 5)
    │   💬 Args: [data]
    │   👁️  Def: private
