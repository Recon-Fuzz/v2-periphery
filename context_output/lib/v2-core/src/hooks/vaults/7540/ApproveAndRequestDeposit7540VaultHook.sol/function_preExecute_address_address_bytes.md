...
- **Kind**: internal
- **Source**: 4235:153:405
- **Link**: `lib/v2-core/src/hooks/vaults/7540/ApproveAndRequestDeposit7540VaultHook.sol:ApproveAndRequestDeposit7540VaultHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ApproveAndRequestDeposit7540VaultHook._preExecute(address,address,bytes) (NodeID: 7)
