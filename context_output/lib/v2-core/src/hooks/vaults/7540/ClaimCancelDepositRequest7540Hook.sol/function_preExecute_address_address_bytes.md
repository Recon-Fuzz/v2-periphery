...
- **Kind**: internal
- **Source**: 3030:348:408
- **Link**: `lib/v2-core/src/hooks/vaults/7540/ClaimCancelDepositRequest7540Hook.sol:ClaimCancelDepositRequest7540Hook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 3815:139:408
- **Link**: `lib/v2-core/src/hooks/vaults/7540/ClaimCancelDepositRequest7540Hook.sol:ClaimCancelDepositRequest7540Hook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ClaimCancelDepositRequest7540Hook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    │     💬 Args: [data, 32]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 10)
    │   💬 Args: [data, 52]
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 11)
        💬 Args: [_getBalance(receiver, data), account]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: ClaimCancelDepositRequest7540Hook._getBalance(address,bytes) (NodeID: 15)
      │   💬 Args: [receiver, data]
      │   👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: BaseHook._getCurrentExecutionContext(address) (NodeID: 12)
      │   💬 Args: [caller]
      │   👁️  Def: private
      │ └─ [4] ⚙️ FUNCTION: BaseHook._makeAccountContextKey(address) (NodeID: 13)
      │     💬 Args: [caller]
      │     👁️  Def: private
      └─ [3] ⚙️ FUNCTION: BaseHook._makeKey(uint256,uint256) (NodeID: 14)
