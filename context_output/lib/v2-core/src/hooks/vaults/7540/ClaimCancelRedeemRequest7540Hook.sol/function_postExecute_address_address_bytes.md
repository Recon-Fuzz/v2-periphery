...
- **Kind**: internal
- **Source**: 3343:236:409
- **Link**: `lib/v2-core/src/hooks/vaults/7540/ClaimCancelRedeemRequest7540Hook.sol:ClaimCancelRedeemRequest7540Hook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 3773:182:409
- **Link**: `lib/v2-core/src/hooks/vaults/7540/ClaimCancelRedeemRequest7540Hook.sol:ClaimCancelRedeemRequest7540Hook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ClaimCancelRedeemRequest7540Hook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 9)
        💬 Args: [_getBalance(receiver, data) - getOutAmount(account), account]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BaseHook.getOutAmount(address) (NodeID: 13)
      │   💬 Args: [account]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: BaseHook._getOutAmount(uint256) (NodeID: 14)
      │     💬 Args: [_getCurrentExecutionContext(caller)]
      │     👁️  Def: private
      │   ├─ [5] ⚙️ FUNCTION: BaseHook._getCurrentExecutionContext(address) (NodeID: 16)
      │   │   💬 Args: [caller]
      │   │   👁️  Def: private
      │   │ └─ [6] ⚙️ FUNCTION: BaseHook._makeAccountContextKey(address) (NodeID: 17)
      │   │     💬 Args: [caller]
      │   │     👁️  Def: private
      │   └─ [5] ⚙️ FUNCTION: BaseHook._makeKey(uint256,uint256) (NodeID: 15)
      │       💬 Args: [context, OUT_AMOUNT_OFFSET]
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: ClaimCancelRedeemRequest7540Hook._getBalance(address,bytes) (NodeID: 18)
      │   💬 Args: [receiver, data]
      │   👁️  Def: private
      │ └─ [4] ⚙️ FUNCTION: HookDataDecoder.extractYieldSource(bytes) (NodeID: 19)
      │     💬 Args: [data]
      │     👁️  Def: internal
      │   └─ [5] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 20)
      │       💬 Args: [data, 32]
      │       👁️  Def: internal
