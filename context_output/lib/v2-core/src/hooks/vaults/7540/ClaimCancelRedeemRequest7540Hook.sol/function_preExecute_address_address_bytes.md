...
- **Kind**: internal
- **Source**: 3121:216:409
- **Link**: `lib/v2-core/src/hooks/vaults/7540/ClaimCancelRedeemRequest7540Hook.sol:ClaimCancelRedeemRequest7540Hook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ClaimCancelRedeemRequest7540Hook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ClaimCancelRedeemRequest7540Hook._getBalance(address,bytes) (NodeID: 12)
    │ │   💬 Args: [account, data]
    │ │   👁️  Def: private
