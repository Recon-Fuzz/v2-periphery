...
- **Kind**: internal
- **Source**: 3843:178:410
- **Link**: `lib/v2-core/src/hooks/vaults/7540/Deposit7540VaultHook.sol:Deposit7540VaultHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 4358:182:410
- **Link**: `lib/v2-core/src/hooks/vaults/7540/Deposit7540VaultHook.sol:Deposit7540VaultHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: Deposit7540VaultHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: Deposit7540VaultHook._getBalance(address,bytes) (NodeID: 17)
      │   💬 Args: [account, data]
      │   👁️  Def: private
