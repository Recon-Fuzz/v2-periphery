...
- **Kind**: internal
- **Source**: 3588:249:410
- **Link**: `lib/v2-core/src/hooks/vaults/7540/Deposit7540VaultHook.sol:Deposit7540VaultHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: Deposit7540VaultHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Deposit7540VaultHook._getBalance(address,bytes) (NodeID: 12)
    │ │   💬 Args: [account, data]
    │ │   👁️  Def: private
