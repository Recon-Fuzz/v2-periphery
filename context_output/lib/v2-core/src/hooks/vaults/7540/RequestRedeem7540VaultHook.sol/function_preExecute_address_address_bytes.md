...
- **Kind**: internal
- **Source**: 3828:153:413
- **Link**: `lib/v2-core/src/hooks/vaults/7540/RequestRedeem7540VaultHook.sol:RequestRedeem7540VaultHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: RequestRedeem7540VaultHook._preExecute(address,address,bytes) (NodeID: 7)
