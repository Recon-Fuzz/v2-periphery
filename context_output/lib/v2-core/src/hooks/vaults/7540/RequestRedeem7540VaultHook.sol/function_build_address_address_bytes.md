...
- **Kind**: internal
- **Source**: 1810:902:413
- **Link**: `lib/v2-core/src/hooks/vaults/7540/RequestRedeem7540VaultHook.sol:RequestRedeem7540VaultHook:_buildHookExecutions(address,address,bytes)`
...
function _buildHookExecutions(address prevHook, address account, bytes calldata data) override internal view returns (Execution[] memory executions) {
    ...
    executions[0] = Execution({target: yieldSource, value: 0, callData: abi.encodeCall(IERC7540.requestRedeem, (shares, account, account))});
}
```
...
- **Kind**: internal
- **Source**: 4359:138:413
- **Link**: `lib/v2-core/src/hooks/vaults/7540/RequestRedeem7540VaultHook.sol:RequestRedeem7540VaultHook:_decodeAmount(bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.build(address,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: RequestRedeem7540VaultHook._buildHookExecutions(address,address,bytes) (NodeID: 1)
    ...
    │     💬 Args: [data, 32]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: RequestRedeem7540VaultHook._decodeAmount(bytes) (NodeID: 4)
    │   💬 Args: [data]
    │   👁️  Def: private
