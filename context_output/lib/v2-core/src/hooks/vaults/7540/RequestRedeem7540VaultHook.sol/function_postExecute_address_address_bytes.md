...
- **Kind**: internal
- **Source**: 3987:178:413
- **Link**: `lib/v2-core/src/hooks/vaults/7540/RequestRedeem7540VaultHook.sol:RequestRedeem7540VaultHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 4503:182:413
- **Link**: `lib/v2-core/src/hooks/vaults/7540/RequestRedeem7540VaultHook.sol:RequestRedeem7540VaultHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: RequestRedeem7540VaultHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: RequestRedeem7540VaultHook._getBalance(address,bytes) (NodeID: 12)
      │   💬 Args: [account, data]
      │   👁️  Def: private
