...
- **Name**: RequestDeposit7540VaultHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/vaults/7540/RequestDeposit7540VaultHook.sol
- **Documentation**: @title RequestDeposit7540VaultHook
...
- **ISuperHookAsyncCancelations** [lib/v2-core/src/interfaces/ISuperHook.sol/interface_ISuperHookAsyncCancelations.md]
...
### CancelationType (inherited from ISuperHookAsyncCancelations)
...
- **Details**: [function_isAsyncCancelHook.md](./function_isAsyncCancelHook.md)
