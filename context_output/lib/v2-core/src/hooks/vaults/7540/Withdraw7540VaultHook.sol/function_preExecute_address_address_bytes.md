...
**Contract**: [lib/v2-core/src/hooks/vaults/7540/Withdraw7540VaultHook.sol/contract_Withdraw7540VaultHook.md]

## Metadata

- **Contract**: Withdraw7540VaultHook
...
- **Kind**: internal
- **Source**: 3858:361:415
- **Link**: `lib/v2-core/src/hooks/vaults/7540/Withdraw7540VaultHook.sol:Withdraw7540VaultHook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 4808:139:415
- **Link**: `lib/v2-core/src/hooks/vaults/7540/Withdraw7540VaultHook.sol:Withdraw7540VaultHook:_getBalance(address,bytes)`
...
- **Kind**: internal
- **Source**: 4953:231:415
- **Link**: `lib/v2-core/src/hooks/vaults/7540/Withdraw7540VaultHook.sol:Withdraw7540VaultHook:_getSharesBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: Withdraw7540VaultHook._preExecute(address,address,bytes) (NodeID: 7)
      💬 Args: [prevHook, account, data]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: HookDataDecoder.extractYieldSource(bytes) (NodeID: 8)
    │   💬 Args: [data]
    │   👁️  Def: internal
    ...
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Withdraw7540VaultHook._getBalance(address,bytes) (NodeID: 14)
    │ │   💬 Args: [account, data]
    │ │   👁️  Def: private
    ...
    │     👁️  Def: private
    └─ [2] ⚙️ FUNCTION: Withdraw7540VaultHook._getSharesBalance(address,bytes) (NodeID: 15)
        💬 Args: [account, data]
        👁️  Def: private
      └─ [3] ⚙️ FUNCTION: HookDataDecoder.extractYieldSource(bytes) (NodeID: 16)
          💬 Args: [data]
          👁️  Def: internal
        └─ [4] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 17)
            💬 Args: [data, 32]
            👁️  Def: internal
```
