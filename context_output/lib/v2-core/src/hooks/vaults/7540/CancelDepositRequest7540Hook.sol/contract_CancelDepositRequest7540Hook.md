...
- **Name**: CancelDepositRequest7540Hook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/vaults/7540/CancelDepositRequest7540Hook.sol
- **Documentation**: @title CancelDepositRequest7540Hook
