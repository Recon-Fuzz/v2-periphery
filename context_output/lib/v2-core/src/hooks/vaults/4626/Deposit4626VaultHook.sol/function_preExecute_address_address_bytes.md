...
- **Kind**: internal
- **Source**: 3456:231:400
- **Link**: `lib/v2-core/src/hooks/vaults/4626/Deposit4626VaultHook.sol:Deposit4626VaultHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: Deposit4626VaultHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Deposit4626VaultHook._getBalance(address,bytes) (NodeID: 12)
    │ │   💬 Args: [account, data]
    │ │   👁️  Def: private
