...
- **Kind**: internal
- **Source**: 1770:929:401
- **Link**: `lib/v2-core/src/hooks/vaults/4626/Redeem4626VaultHook.sol:Redeem4626VaultHook:_buildHookExecutions(address,address,bytes)`
...
function _buildHookExecutions(address prevHook, address account, bytes calldata data) override internal view returns (Execution[] memory executions) {
    ...
    executions[0] = Execution({target: yieldSource, value: 0, callData: abi.encodeCall(IERC4626.redeem, (shares, account, owner))});
}
```
...
- **Kind**: internal
- **Source**: 4732:138:401
- **Link**: `lib/v2-core/src/hooks/vaults/4626/Redeem4626VaultHook.sol:Redeem4626VaultHook:_decodeAmount(bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.build(address,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: Redeem4626VaultHook._buildHookExecutions(address,address,bytes) (NodeID: 1)
    ...
    │   💬 Args: [data, 52]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Redeem4626VaultHook._decodeAmount(bytes) (NodeID: 5)
    │   💬 Args: [data]
    │   👁️  Def: private
