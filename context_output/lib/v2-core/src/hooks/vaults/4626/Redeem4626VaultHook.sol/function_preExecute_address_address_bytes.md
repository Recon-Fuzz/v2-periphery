...
- **Kind**: internal
- **Source**: 3944:343:401
- **Link**: `lib/v2-core/src/hooks/vaults/4626/Redeem4626VaultHook.sol:Redeem4626VaultHook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 4876:139:401
- **Link**: `lib/v2-core/src/hooks/vaults/4626/Redeem4626VaultHook.sol:Redeem4626VaultHook:_getBalance(address,bytes)`
...
- **Kind**: internal
- **Source**: 5021:341:401
- **Link**: `lib/v2-core/src/hooks/vaults/4626/Redeem4626VaultHook.sol:Redeem4626VaultHook:_getSharesBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: Redeem4626VaultHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Redeem4626VaultHook._getBalance(address,bytes) (NodeID: 14)
    │ │   💬 Args: [account, data]
    │ │   👁️  Def: private
    ...
    │     👁️  Def: private
    └─ [2] ⚙️ FUNCTION: Redeem4626VaultHook._getSharesBalance(address,bytes) (NodeID: 15)
        💬 Args: [account, data]
        👁️  Def: private
