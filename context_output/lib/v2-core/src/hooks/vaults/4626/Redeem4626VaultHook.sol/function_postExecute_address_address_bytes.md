...
- **Kind**: internal
- **Source**: 4293:246:401
- **Link**: `lib/v2-core/src/hooks/vaults/4626/Redeem4626VaultHook.sol:Redeem4626VaultHook:_postExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: Redeem4626VaultHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    │ │       👁️  Def: private
    │ ├─ [3] ⚙️ FUNCTION: Redeem4626VaultHook._getBalance(address,bytes) (NodeID: 17)
    │ │   💬 Args: [account, data]
    │ │   👁️  Def: private
    ...
    │     💬 Args: [context, OUT_AMOUNT_OFFSET]
    │     👁️  Def: private
    └─ [2] ⚙️ FUNCTION: Redeem4626VaultHook._getSharesBalance(address,bytes) (NodeID: 18)
        💬 Args: [account, data]
        👁️  Def: private
      ...
      │     💬 Args: [data, 32]
      │     👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 21)
          💬 Args: [data, 52]
          👁️  Def: internal
```
