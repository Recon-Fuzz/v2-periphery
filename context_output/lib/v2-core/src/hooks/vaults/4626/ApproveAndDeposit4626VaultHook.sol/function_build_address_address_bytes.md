...
- **Kind**: internal
- **Source**: 1925:1320:399
- **Link**: `lib/v2-core/src/hooks/vaults/4626/ApproveAndDeposit4626VaultHook.sol:ApproveAndDeposit4626VaultHook:_buildHookExecutions(address,address,bytes)`
...
function _buildHookExecutions(address prevHook, address account, bytes calldata data) override internal view returns (Execution[] memory executions) {
    ...
    executions[2] = Execution({target: yieldSource, value: 0, callData: abi.encodeCall(IERC4626.deposit, (amount, account))});
...
- **Kind**: internal
- **Source**: 4873:138:399
- **Link**: `lib/v2-core/src/hooks/vaults/4626/ApproveAndDeposit4626VaultHook.sol:ApproveAndDeposit4626VaultHook:_decodeAmount(bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.build(address,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ApproveAndDeposit4626VaultHook._buildHookExecutions(address,address,bytes) (NodeID: 1)
    ...
    │   💬 Args: [data, 52]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ApproveAndDeposit4626VaultHook._decodeAmount(bytes) (NodeID: 5)
    │   💬 Args: [data]
    │   👁️  Def: private
