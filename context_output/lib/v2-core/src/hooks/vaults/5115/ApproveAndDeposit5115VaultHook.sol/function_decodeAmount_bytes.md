...
- **Kind**: internal
- **Source**: 5156:138:402
- **Link**: `lib/v2-core/src/hooks/vaults/5115/ApproveAndDeposit5115VaultHook.sol:ApproveAndDeposit5115VaultHook:_decodeAmount(bytes)`
...
```
┌─ [0] ⚙️ FUNCTION: ApproveAndDeposit5115VaultHook.decodeAmount(bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ApproveAndDeposit5115VaultHook._decodeAmount(bytes) (NodeID: 1)
      💬 Args: [data]
      👁️  Def: private
