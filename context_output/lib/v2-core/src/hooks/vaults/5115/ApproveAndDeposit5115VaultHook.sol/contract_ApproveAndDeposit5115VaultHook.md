...
- **Name**: ApproveAndDeposit5115VaultHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/vaults/5115/ApproveAndDeposit5115VaultHook.sol
- **Documentation**: @title ApproveAndDeposit5115VaultHook
...
### vaultBank (inherited from VaultBankLockableHook)
...
### dstChainId (inherited from VaultBankLockableHook)
