...
- **Kind**: internal
- **Source**: 4535:244:402
- **Link**: `lib/v2-core/src/hooks/vaults/5115/ApproveAndDeposit5115VaultHook.sol:ApproveAndDeposit5115VaultHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ApproveAndDeposit5115VaultHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ApproveAndDeposit5115VaultHook._getBalance(address,bytes) (NodeID: 12)
    │ │   💬 Args: [account, data]
    │ │   👁️  Def: private
    ...
    │     👁️  Def: private
    ├─ [2] ⚙️ FUNCTION: HookDataDecoder.extractYieldSource(bytes) (NodeID: 15)
    │   💬 Args: [data]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 16)
    │     💬 Args: [data, 32]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: BytesLib.toAddress(bytes,uint256) (NodeID: 17)
        💬 Args: [data, 52]
        👁️  Def: internal
```
