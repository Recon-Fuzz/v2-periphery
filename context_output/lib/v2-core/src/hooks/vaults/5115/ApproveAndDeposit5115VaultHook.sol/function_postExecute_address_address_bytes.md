...
- **Kind**: internal
- **Source**: 4785:178:402
- **Link**: `lib/v2-core/src/hooks/vaults/5115/ApproveAndDeposit5115VaultHook.sol:ApproveAndDeposit5115VaultHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 5300:176:402
- **Link**: `lib/v2-core/src/hooks/vaults/5115/ApproveAndDeposit5115VaultHook.sol:ApproveAndDeposit5115VaultHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ApproveAndDeposit5115VaultHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: ApproveAndDeposit5115VaultHook._getBalance(address,bytes) (NodeID: 17)
      │   💬 Args: [account, data]
      │   👁️  Def: private
