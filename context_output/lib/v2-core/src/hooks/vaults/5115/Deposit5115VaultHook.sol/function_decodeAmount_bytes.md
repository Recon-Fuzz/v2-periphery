...
- **Kind**: internal
- **Source**: 4567:138:403
- **Link**: `lib/v2-core/src/hooks/vaults/5115/Deposit5115VaultHook.sol:Deposit5115VaultHook:_decodeAmount(bytes)`
...
```
┌─ [0] ⚙️ FUNCTION: Deposit5115VaultHook.decodeAmount(bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: Deposit5115VaultHook._decodeAmount(bytes) (NodeID: 1)
      💬 Args: [data]
      👁️  Def: private
