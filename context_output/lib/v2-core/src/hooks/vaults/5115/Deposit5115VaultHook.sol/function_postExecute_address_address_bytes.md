...
- **Kind**: internal
- **Source**: 4196:178:403
- **Link**: `lib/v2-core/src/hooks/vaults/5115/Deposit5115VaultHook.sol:Deposit5115VaultHook:_postExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 4711:176:403
- **Link**: `lib/v2-core/src/hooks/vaults/5115/Deposit5115VaultHook.sol:Deposit5115VaultHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: Deposit5115VaultHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
      ...
      │       👁️  Def: private
      ├─ [3] ⚙️ FUNCTION: Deposit5115VaultHook._getBalance(address,bytes) (NodeID: 17)
      │   💬 Args: [account, data]
      │   👁️  Def: private
