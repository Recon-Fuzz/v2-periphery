...
- **Kind**: internal
- **Source**: 4482:246:404
- **Link**: `lib/v2-core/src/hooks/vaults/5115/Redeem5115VaultHook.sol:Redeem5115VaultHook:_postExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: Redeem5115VaultHook._postExecute(address,address,bytes) (NodeID: 7)
    ...
    │ │       👁️  Def: private
    │ ├─ [3] ⚙️ FUNCTION: Redeem5115VaultHook._getBalance(address,bytes) (NodeID: 17)
    │ │   💬 Args: [account, data]
    │ │   👁️  Def: private
    ...
    │     💬 Args: [context, OUT_AMOUNT_OFFSET]
    │     👁️  Def: private
    └─ [2] ⚙️ FUNCTION: Redeem5115VaultHook._getSharesBalance(address,bytes) (NodeID: 18)
        💬 Args: [account, data]
        👁️  Def: private
