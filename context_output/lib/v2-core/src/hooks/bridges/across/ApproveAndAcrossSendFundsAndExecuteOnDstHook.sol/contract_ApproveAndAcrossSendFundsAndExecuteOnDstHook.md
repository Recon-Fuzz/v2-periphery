...
- **Name**: ApproveAndAcrossSendFundsAndExecuteOnDstHook
- **Type**: Contract
- **Path**: lib/v2-core/src/hooks/bridges/across/ApproveAndAcrossSendFundsAndExecuteOnDstHook.sol
- **Documentation**: @title ApproveAndAcrossSendFundsAndExecuteOnDstHook
   @author Superform Labs
   @dev ERC20-only version of AcrossSendFundsAndExecuteOnDstHook with approval pattern
