...
- **Kind**: internal
- **Source**: 5617:586:368
- **Link**: `lib/v2-core/src/hooks/bridges/debridge/DeBridgeCancelOrderHook.sol:DeBridgeCancelOrderHook:_buildHookExecutions(address,address,bytes)`
...
function _buildHookExecutions(address, address account, bytes calldata data) override internal view returns (Execution[] memory executions) {
    ...
    executions[0] = Execution({target: DLN_DESTINATION, value: value, callData: abi.encodeCall(IDlnDestination.sendEvmOrderCancel, (order, account, executionFee))});
}
```
...
┌─ [0] ⚙️ FUNCTION: BaseHook.build(address,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: DeBridgeCancelOrderHook._buildHookExecutions(address,address,bytes) (NodeID: 1)
      💬 Args: [prevHook, account, hookData]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: DeBridgeCancelOrderHook._createOrder(bytes) (NodeID: 2)
        💬 Args: [data]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BytesLib.toUint256(bytes,uint256) (NodeID: 3)
      │   💬 Args: [data, offset]
      │   👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BytesLib.toUint64(bytes,uint256) (NodeID: 4)
      │   💬 Args: [data, offset]
      │   👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BytesLib.toUint256(bytes,uint256) (NodeID: 5)
      │   💬 Args: [data, offset]
      │   👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BytesLib.slice(bytes,uint256,uint256) (NodeID: 6)
      │   💬 Args: [data, offset, makerSrcLen]
      │   👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BytesLib.toUint256(bytes,uint256) (NodeID: 7)
      │   💬 Args: [data, offset]
      │   👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BytesLib.slice(bytes,uint256,uint256) (NodeID: 8)
      ...
      │   💬 Args: [data, offset]
      │   👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BytesLib.slice(bytes,uint256,uint256) (NodeID: 18)
      │   💬 Args: [data, offset, givePatchAuthoritySrcLen]
      │   👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BytesLib.toUint256(bytes,uint256) (NodeID: 19)
      │   💬 Args: [data, offset]
      │   👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BytesLib.slice(bytes,uint256,uint256) (NodeID: 20)
