# Contract: SpectraCommands

## Metadata

- **Name**: SpectraCommands
- **Type**: Contract
- **Path**: lib/v2-core/src/vendor/spectra/SpectraCommands.sol
...
uint256 internal constant TRANSFER_FROM = 0x00
```
...
uint256 internal constant TRANSFER_FROM_WITH_PERMIT = 0x01
```
...
uint256 internal constant TRANSFER = 0x02
```
...
uint256 internal constant CURVE_SWAP = 0x03
```
...
uint256 internal constant DEPOSIT_ASSET_IN_IBT = 0x04
```
...
uint256 internal constant DEPOSIT_ASSET_IN_PT = 0x05
```
...
uint256 internal constant DEPOSIT_IBT_IN_PT = 0x06
```
...
uint256 internal constant REDEEM_IBT_FOR_ASSET = 0x07
```
...
uint256 internal constant REDEEM_PT_FOR_ASSET = 0x08
```
...
uint256 internal constant REDEEM_PT_FOR_IBT = 0x09
```
...
uint256 internal constant FLASH_LOAN = 0x0a
```

### CURVE_SPLIT_IBT_LIQUIDITY

```solidity
///  Splits liquidity between IBT and PT before depositing in a Curve pool
...
uint256 internal constant CURVE_SPLIT_IBT_LIQUIDITY = 0x0b
```

### CURVE_ADD_LIQUIDITY

```solidity
///  Deposits coins into a Curve pool
...
uint256 internal constant CURVE_ADD_LIQUIDITY = 0x0c
```

### CURVE_REMOVE_LIQUIDITY

```solidity
///  Withdraws coins from a Curve pool
...
uint256 internal constant CURVE_REMOVE_LIQUIDITY = 0x0d
```

### CURVE_REMOVE_LIQUIDITY_ONE_COIN

```solidity
///  Withdraws a single coin from a Curve pool
///  lps represents the amount of LP tokens to burn
...
uint256 internal constant CURVE_REMOVE_LIQUIDITY_ONE_COIN = 0x0e
```
...
uint256 internal constant ASSERT_MIN_BALANCE = 0x0f
```
...
uint256 internal constant WRAP_VAULT_IN_4626_ADAPTER = 0x10
```
...
uint256 internal constant UNWRAP_VAULT_FROM_4626_ADAPTER = 0x11
```
...
uint256 internal constant KYBER_SWAP = 0x12
```

### PENDLE_REMOVE_LIQUIDITY_SINGLE_TOKEN
...
///  limit)
uint256 internal constant PENDLE_REMOVE_LIQUIDITY_SINGLE_TOKEN = 0x13
```
