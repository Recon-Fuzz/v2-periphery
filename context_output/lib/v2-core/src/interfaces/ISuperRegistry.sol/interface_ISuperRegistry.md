...
- **Name**: ISuperRegistry
- **Type**: Interface
- **Path**: lib/v2-core/src/interfaces/ISuperRegistry.sol
...
### setExecutor(bytes32,address)

- **Signature**: `setExecutor(bytes32,address)`
- **Visibility**: external
- **Source Range**: 3681:61:424
...
### isExecutorAllowed(address)

- **Signature**: `isExecutorAllowed(address)`
- **Visibility**: external
- **Source Range**: 5401:74:424
