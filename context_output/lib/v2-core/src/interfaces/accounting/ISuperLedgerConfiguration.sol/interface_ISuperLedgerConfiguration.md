...
- **Name**: ISuperLedgerConfiguration
- **Type**: Interface
- **Path**: lib/v2-core/src/interfaces/accounting/ISuperLedgerConfiguration.sol
- **Documentation**: @title ISuperLedgerConfiguration
...
function getYieldSourceOracleConfigs(bytes32[] calldata yieldSourceOracleIds) external view returns (YieldSourceOracleConfig[] memory configs);;
```
