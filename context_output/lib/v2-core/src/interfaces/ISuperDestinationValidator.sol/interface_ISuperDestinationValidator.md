...
- **Name**: ISuperDestinationValidator
- **Type**: Interface
- **Path**: lib/v2-core/src/interfaces/ISuperDestinationValidator.sol
- **Documentation**: @title ISuperDestinationValidator
