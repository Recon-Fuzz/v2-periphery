...
- **Name**: ISuperExecutor
- **Type**: Interface
- **Path**: lib/v2-core/src/interfaces/ISuperExecutor.sol
- **Documentation**: @title ISuperExecutor
