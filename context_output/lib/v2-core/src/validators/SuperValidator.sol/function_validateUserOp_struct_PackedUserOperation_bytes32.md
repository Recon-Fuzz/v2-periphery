...
function validateUserOp(PackedUserOperation calldata _userOp, bytes32 _userOpHash) override external returns (ValidationData) {
    ...
    if (isValid && (sigData.chainsWithDestinationExecution.length > 0)) {
        ...
        for (uint256 i; i < dstLen; ++i) {
            ...
            DestinationData memory dstData = DestinationData({callData: dstProof.info.data, chainId: dstProof.dstChainId, sender: dstProof.info.account, executor: dstProof.info.executor, dstTokens: dstProof.info.dstTokens, intentAmounts: dstProof.info.intentAmounts});
...
### storeSignature(uint256,bytes)

- **Kind**: internal
- **Source**: 1533:680:435
- **Link**: `lib/v2-core/src/libraries/SignatureTransientStorage.sol:SignatureTransientStorage:storeSignature(uint256,bytes)`
...
```
┌─ [0] ⚙️ FUNCTION: SuperValidator.validateUserOp(struct PackedUserOperation,bytes32) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: SuperValidatorBase._is7702Account(bytes) (NodeID: 1)
  │   💬 Args: [_userOp.sender.code]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SuperValidatorBase._decodeSignatureData(bytes) (NodeID: 2)
  │   💬 Args: [_userOp.signature]
  │   👁️  Def: internal
  ...
  │   💬 Args: [_userOp.sender, sigData, _userOpHash]
  │   👁️  Def: private
  ...
  │   💬 Args: [signer, _userOp.sender, sigData.validUntil, sigData.validAfter]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: SuperValidatorBase._is7702Account(bytes) (NodeID: 35)
  │     💬 Args: [sender.code]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SuperValidatorBase._createDestinationLeaf(struct ISuperValidator.DestinationData,uint48,address) (NodeID: 36)
  │   💬 Args: [dstData, sigData.validUntil, dstProof.info.validator]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: MerkleProof.verify(bytes32[],bytes32,bytes32) (NodeID: 37)
  │   💬 Args: [dstProof.proof, sigData.merkleRoot, dstLeaf]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: MerkleProof.processProof(bytes32[],bytes32) (NodeID: 38)
  │     💬 Args: [proof, leaf]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: Hashes.commutativeKeccak256(bytes32,bytes32) (NodeID: 39)
  │       💬 Args: [computedHash, proof[i]]
  │       👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: Hashes.efficientKeccak256(bytes32,bytes32) (NodeID: 40)
  │     │   💬 Args: [a, b]
  │     │   👁️  Def: internal
  │     └─ [4] ⚙️ FUNCTION: Hashes.efficientKeccak256(bytes32,bytes32) (NodeID: 41)
  │         💬 Args: [b, a]
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SignatureTransientStorage.storeSignature(uint256,bytes) (NodeID: 42)
  │   💬 Args: [identifier, _userOp.signature]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: SignatureTransientStorage._makeKey(uint256) (NodeID: 43)
  │     💬 Args: [identifier]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: ERC7579ValidatorBase._packValidationData(bool,uint48,uint48) (NodeID: 44)
      💬 Args: [!isValid, sigData.validUntil, sigData.validAfter]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: ERC7579ValidatorBase._packValidationData(bool,uint48,uint48) (NodeID: 45)
