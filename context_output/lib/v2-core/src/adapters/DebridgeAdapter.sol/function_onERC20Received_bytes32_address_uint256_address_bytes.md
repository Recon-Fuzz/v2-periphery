# Function: onERC20Received(bytes32,address,uint256,address,bytes)
...
```
┌─ [0] ⚙️ FUNCTION: DebridgeAdapter.onERC20Received(bytes32,address,uint256,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │   💬 Args: [_token, initData, executorCalldata, account, dstTokens, intentAmounts, sigData]
  │   👁️  Def: private
