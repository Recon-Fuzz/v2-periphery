...
- **Kind**: internal
- **Source**: 1593:260:355
- **Link**: `lib/v2-core/src/accounting/oracles/ERC4626YieldSourceOracle.sol:ERC4626YieldSourceOracle:getAssetOutput(address,address,uint256)`
...
┌─ [0] ⚙️ FUNCTION: AbstractYieldSourceOracle.getAssetOutputWithFees(bytes32,address,address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ERC4626YieldSourceOracle.getAssetOutput(address,address,uint256) (NodeID: 1)
