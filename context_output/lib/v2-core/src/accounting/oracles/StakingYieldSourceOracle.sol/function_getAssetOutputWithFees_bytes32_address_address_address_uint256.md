...
- **Kind**: internal
- **Source**: 1571:131:357
- **Link**: `lib/v2-core/src/accounting/oracles/StakingYieldSourceOracle.sol:StakingYieldSourceOracle:getAssetOutput(address,address,uint256)`
...
┌─ [0] ⚙️ FUNCTION: AbstractYieldSourceOracle.getAssetOutputWithFees(bytes32,address,address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: StakingYieldSourceOracle.getAssetOutput(address,address,uint256) (NodeID: 1)
