...
- **Kind**: internal
- **Source**: 4519:343:356
- **Link**: `lib/v2-core/src/accounting/oracles/ERC5115YieldSourceOracle.sol:ERC5115YieldSourceOracle:getTVL(address)`
...
┌─ [0] ⚙️ FUNCTION: AbstractYieldSourceOracle.getTVLMultiple(address[]) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ERC5115YieldSourceOracle.getTVL(address) (NodeID: 1)
      💬 Args: [yieldSourceAddresses[i]]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 2)
        💬 Args: [totalShares, yieldSource.exchangeRate(), 1e18]
        👁️  Def: internal
