# Function: help(address,address,address,uint256,uint256,uint256,uint256,struct VmSafe.Log[],uint256)
...
function help(address sourceSpokePool, address destinationSpokePool, address relayer, uint256 warpTimestamp, uint256 forkId, uint256 destinationChainId, uint256 refundChainId, Vm.Log[] calldata logs, uint256 gasLimit) external {
    _help(HelpArgs({sourceSpokePool: sourceSpokePool, destinationSpokePool: destinationSpokePool, relayer: relayer, forkId: forkId, destinationChainId: destinationChainId, refundChainId: refundChainId, warpTimestamp: warpTimestamp, logs: logs}), gasLimit);
}
```

## Related Implementations

### _help(struct AcrossV3Helper.HelpArgs,uint256)

- **Kind**: internal
- **Source**: 8742:2744:306
- **Link**: `lib/v2-core/lib/pigeon/src/across/AcrossV3Helper.sol:AcrossV3Helper:_help(struct AcrossV3Helper.HelpArgs,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: AcrossV3Helper.help(address,address,address,uint256,uint256,uint256,uint256,struct VmSafe.Log[],uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: AcrossV3Helper._help(struct AcrossV3Helper.HelpArgs,uint256) (NodeID: 1)
      💬 Args: [HelpArgs({sourceSpokePool: sourceSpokePool, destinationSpokePool: destinationSpokePool, relayer: relayer, forkId: forkId, destinationChainId: destinationChainId, refundChainId: refundChainId, warpTimestamp: warpTimestamp, logs: logs}), gasLimit]
      👁️  Def: internal
