...
- **Kind**: internal
- **Source**: 17426:575:236
- **Link**: `lib/v2-core/lib/modulekit/src/test/helpers/KernelHelpers.sol:KernelHelpers:isModuleInstalled(struct AccountInstance,uint256,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: HelperBase.isModuleInstalled(struct AccountInstance,uint256,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: KernelHelpers.isModuleInstalled(struct AccountInstance,uint256,address,bytes) (NodeID: 1)
  │   💬 Args: [instance, moduleTypeId, module, ""]
  │   👁️  Def: public
  │ ├─ [2] ⚙️ FUNCTION: KernelHelpers.getHookMultiPlexer(struct AccountInstance) (NodeID: 2)
  │ │   💬 Args: [instance]
  │ │   👁️  Def: public
  │ └─ [2] 🔒 MODIFIER: HelperBase.deployAccountForAction(struct AccountInstance) (NodeID: 3)
  │     💬 Args: [instance]
  │   ├─ [3] ⚙️ FUNCTION: Unknown.snapshot() (NodeID: 4)
  │   │   💬 Args: [no args]
  │   │   👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: HelperBase.deployAccount(struct AccountInstance) (NodeID: 5)
  │   │   💬 Args: [instance]
  │   │   👁️  Def: public
  │   └─ [3] ⚙️ FUNCTION: Unknown.revertTo(uint256) (NodeID: 6)
  │       💬 Args: [snapShotId]
  │       👁️  Def: internal
  └─ [1] 🔒 MODIFIER: HelperBase.deployAccountForAction(struct AccountInstance) (NodeID: 7)
      💬 Args: [instance]
    ├─ [2] ⚙️ FUNCTION: Unknown.snapshot() (NodeID: 8)
    │   💬 Args: [no args]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: HelperBase.deployAccount(struct AccountInstance) (NodeID: 9)
    │   💬 Args: [instance]
    │   👁️  Def: public
    └─ [2] ⚙️ FUNCTION: Unknown.revertTo(uint256) (NodeID: 10)
        💬 Args: [snapShotId]
        👁️  Def: internal
```
