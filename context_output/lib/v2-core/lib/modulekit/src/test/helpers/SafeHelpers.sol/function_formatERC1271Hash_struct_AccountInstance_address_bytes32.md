...
function formatERC1271Hash(AccountInstance memory instance, address validator, bytes32 hash) virtual override public deployAccountForAction(instance) returns (bytes32) {
    if (isModuleInstalled(instance, MODULE_TYPE_VALIDATOR, validator, "")) {
        revert("formatERC1271Hash: validator is installed");
    }
    bytes memory messageData = abi.encodePacked(bytes1(0x19), bytes1(0x01), IERC712(instance.account).domainSeparator(), keccak256(abi.encodePacked(SAFE_MSG_TYPEHASH, abi.encode(keccak256(abi.encode(hash))))));
...
- **Kind**: internal
- **Source**: 12764:728:238
- **Link**: `lib/v2-core/lib/modulekit/src/test/helpers/SafeHelpers.sol:SafeHelpers:isModuleInstalled(struct AccountInstance,uint256,address,bytes)`
...
function isModuleInstalled(AccountInstance memory instance, uint256 moduleTypeId, address module, bytes memory data) virtual override public deployAccountForAction(instance) returns (bool) {
    ...
    if ((moduleTypeId == MODULE_TYPE_PREVALIDATION_HOOK_ERC4337) || (moduleTypeId == MODULE_TYPE_PREVALIDATION_HOOK_ERC1271)) {
...
- **IERC712::domainSeparator()**

## State Variable Reads

- **SAFE_MSG_TYPEHASH** (`bytes32`)

## Call Tree

```
┌─ [0] ⚙️ FUNCTION: SafeHelpers.formatERC1271Hash(struct AccountInstance,address,bytes32) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: SafeHelpers.isModuleInstalled(struct AccountInstance,uint256,address,bytes) (NodeID: 1)
  │   💬 Args: [instance, MODULE_TYPE_VALIDATOR, validator, ""]
  │   👁️  Def: public
  ...
  │   │   💬 Args: [no args]
  │   │   👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: SafeHelpers.deployAccount(struct AccountInstance) (NodeID: 4)
  │   │   💬 Args: [instance]
  │   │   👁️  Def: public
  │   │ ├─ [4] ⚙️ FUNCTION: SafeHelpers._getInitCallData(bytes32,bytes,bytes) (NodeID: 5)
  │   │ │   💬 Args: [instance.salt, instance.initCode, encode({target: address(0), value: 0 wei, callData: ""})]
  │   │ │   👁️  Def: public
  │   │ │ ├─ [5] ⚙️ FUNCTION: HelperBase.encode(address,uint256,bytes) (NodeID: 7)
  │   │ │ │   💬 Args: [address(0), 0 wei, ""]
  │   │ │ │   👁️  Def: public
  │   │ │ │ └─ [6] ⚙️ FUNCTION: ModeLib.encode(CallType,ExecType,ModeSelector,ModePayload) (NodeID: 8)
  │   │ │ │     💬 Args: [CALLTYPE_SINGLE, EXECTYPE_DEFAULT, MODE_DEFAULT, ModePayload.wrap(bytes22(0))]
  │   │ │ │     👁️  Def: internal
  │   │ │ └─ [5] ⚙️ FUNCTION: LibBytes.slice(bytes,uint256,uint256) (NodeID: 6)
  │   │ │     💬 Args: [originalInitCode, 120, originalInitCode.length]
  │   │ │     👁️  Def: internal
  │   │ ├─ [4] ⚙️ FUNCTION: HelperBase.getNonce(struct AccountInstance,bytes,address) (NodeID: 9)
  │   │ │   💬 Args: [instance, callData, address(instance.defaultValidator)]
  │   │ │   👁️  Def: public
  │   │ ├─ [4] ⚙️ FUNCTION: Unknown.startPrank(address) (NodeID: 10)
  │   │ │   💬 Args: [address(instance.aux.entrypoint)]
  │   │ │   👁️  Def: internal
  │   │ └─ [4] ⚙️ FUNCTION: Unknown.stopPrank() (NodeID: 11)
  │   │     💬 Args: [no args]
  │   │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: Unknown.revertTo(uint256) (NodeID: 12)
  │       💬 Args: [snapShotId]
  │       👁️  Def: internal
  └─ [1] 🔒 MODIFIER: HelperBase.deployAccountForAction(struct AccountInstance) (NodeID: 13)
      💬 Args: [instance]
    ├─ [2] ⚙️ FUNCTION: Unknown.snapshot() (NodeID: 14)
    │   💬 Args: [no args]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SafeHelpers.deployAccount(struct AccountInstance) (NodeID: 15)
    │   💬 Args: [instance]
    │   👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: SafeHelpers._getInitCallData(bytes32,bytes,bytes) (NodeID: 16)
    │ │   💬 Args: [instance.salt, instance.initCode, encode({target: address(0), value: 0 wei, callData: ""})]
    │ │   👁️  Def: public
    │ │ ├─ [4] ⚙️ FUNCTION: HelperBase.encode(address,uint256,bytes) (NodeID: 18)
    │ │ │   💬 Args: [address(0), 0 wei, ""]
    │ │ │   👁️  Def: public
    │ │ │ └─ [5] ⚙️ FUNCTION: ModeLib.encode(CallType,ExecType,ModeSelector,ModePayload) (NodeID: 19)
    │ │ │     💬 Args: [CALLTYPE_SINGLE, EXECTYPE_DEFAULT, MODE_DEFAULT, ModePayload.wrap(bytes22(0))]
    │ │ │     👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: LibBytes.slice(bytes,uint256,uint256) (NodeID: 17)
    │ │     💬 Args: [originalInitCode, 120, originalInitCode.length]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: HelperBase.getNonce(struct AccountInstance,bytes,address) (NodeID: 20)
    │ │   💬 Args: [instance, callData, address(instance.defaultValidator)]
    │ │   👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: Unknown.startPrank(address) (NodeID: 21)
    │ │   💬 Args: [address(instance.aux.entrypoint)]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Unknown.stopPrank() (NodeID: 22)
    │     💬 Args: [no args]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: Unknown.revertTo(uint256) (NodeID: 23)
        💬 Args: [snapShotId]
        👁️  Def: internal
```
