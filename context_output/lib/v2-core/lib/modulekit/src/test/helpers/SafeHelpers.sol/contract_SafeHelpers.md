...
- **Name**: SafeHelpers
- **Type**: Contract
- **Path**: lib/v2-core/lib/modulekit/src/test/helpers/SafeHelpers.sol
- **Documentation**: @notice Helper functions for the Safe7579 implementation
...
### formatERC1271Hash(struct AccountInstance,address,bytes32)
...
- **Details**: [function__getInitCallData_bytes32_bytes_bytes.md](./function__getInitCallData_bytes32_bytes_bytes.md)
...
### getInstallFallbackData(struct AccountInstance,address,bytes) (inherited from HelperBase)
