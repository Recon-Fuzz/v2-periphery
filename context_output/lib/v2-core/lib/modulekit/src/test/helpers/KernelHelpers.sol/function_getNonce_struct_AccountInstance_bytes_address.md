...
```
┌─ [0] ⚙️ FUNCTION: KernelHelpers.getNonce(struct AccountInstance,bytes,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: KernelHelpers.enableValidator(struct AccountInstance,bytes,address) (NodeID: 1)
  │   💬 Args: [instance, callData, txValidator]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: ValidatorLib.validatorToIdentifier(contract IValidator) (NodeID: 2)
  │ │   💬 Args: [IValidator(txValidator)]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: KernelPrecompiles.deployKernelWithSetSelector(address) (NodeID: 3)
  │ │   💬 Args: [ENTRYPOINT_ADDR]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: BytecodeDeployer._deploy(bytes) (NodeID: 4)
  │ │ │   💬 Args: [creationBytecode]
  │ │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Unknown.label(address,string) (NodeID: 5)
  │ │     💬 Args: [address(kernel), "SetSelector"]
  │ │     👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Unknown.etch(address,bytes) (NodeID: 6)
  │ │   💬 Args: [instance.account, _setSelector.code]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Unknown.etch(address,bytes) (NodeID: 7)
  │ │   💬 Args: [instance.account, accountCode]
  │ │   👁️  Def: internal
  │ └─ [2] 🔒 MODIFIER: HelperBase.deployAccountForAction(struct AccountInstance) (NodeID: 8)
  │     💬 Args: [instance]
  │   ├─ [3] ⚙️ FUNCTION: Unknown.snapshot() (NodeID: 9)
  │   │   💬 Args: [no args]
  │   │   👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: HelperBase.deployAccount(struct AccountInstance) (NodeID: 10)
  │   │   💬 Args: [instance]
  │   │   👁️  Def: public
  │   └─ [3] ⚙️ FUNCTION: Unknown.revertTo(uint256) (NodeID: 11)
  │       💬 Args: [snapShotId]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: KernelHelpers.encodeNonce(ValidationType,bool,address,address) (NodeID: 12)
      💬 Args: [vType, false, instance.account, txValidator]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: ValidatorLib.encodeAsNonceKey(bytes1,bytes1,bytes20,uint16) (NodeID: 13)
