...
```
┌─ [0] ⚙️ FUNCTION: KernelHelpers.getInstallModuleCallData(struct AccountInstance,uint256,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: KernelHelpers.getHookMultiPlexer(struct AccountInstance) (NodeID: 1)
  │   💬 Args: [instance]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: KernelHelpers.getHookMultiPlexer(struct AccountInstance) (NodeID: 2)
  │   💬 Args: [instance]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: HelperBase.encode(struct Execution[]) (NodeID: 3)
      💬 Args: [executions]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: ModeLib.encode(CallType,ExecType,ModeSelector,ModePayload) (NodeID: 4)
