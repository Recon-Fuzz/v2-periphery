...
- **Kind**: internal
- **Source**: 1596:1023:222
- **Link**: `lib/v2-core/lib/modulekit/src/module-bases/mocks/MockHookMultiPlexer.sol:MockHookMultiPlexer:_preCheck(address,address,uint256,bytes)`
...
function _preCheck(address account, address msgSender, uint256 msgValue, bytes calldata msgData) override internal returns (bytes memory hookData) {
    ...
    for (uint256 i = 0; i < length; i++) {
        ...
        (bool success, bytes memory _ret) = _hook.hook.call(abi.encodePacked(abi.encodeCall(ERC7579HookBase.preCheck, (msgSender, msgValue, msgData)), address(this), msg.sender));
...
┌─ [0] ⚙️ FUNCTION: ERC7579HookBase.preCheck(address,uint256,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: MockHookMultiPlexer._preCheck(address,address,uint256,bytes) (NodeID: 1)
