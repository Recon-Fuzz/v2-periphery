...
- **Type**: Interface
- **Path**: lib/v2-core/lib/modulekit/src/integrations/interfaces/uniswap/v3/IUniswapV3SwapCallback.sol
- **Documentation**: @title Callback for IUniswapV3PoolActions#swap
