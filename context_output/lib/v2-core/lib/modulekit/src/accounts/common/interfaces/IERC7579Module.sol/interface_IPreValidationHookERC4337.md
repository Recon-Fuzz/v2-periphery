...
### preValidationHookERC4337(struct PackedUserOperation,uint256,bytes32)

- **Signature**: `preValidationHookERC4337(struct PackedUserOperation,uint256,bytes32)`
- **Visibility**: external
- **Source Range**: 4466:230:149

**Signature:**
```solidity
function preValidationHookERC4337(PackedUserOperation calldata userOp, uint256 missingAccountFunds, bytes32 userOpHash) external returns (bytes32 hookHash, bytes memory hookSignature);;
```
