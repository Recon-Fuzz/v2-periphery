...
┌─ [0] ⚙️ FUNCTION: SafeFactory.init() (NodeID: 0)
  ...
  │     💬 Args: [address(safe), "Safe7579"]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Safe7579Precompiles.deploySafe7579Launchpad(address,address) (NodeID: 4)
  │   💬 Args: [ENTRYPOINT_ADDR, REGISTRY_ADDR]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: BytecodeDeployer._deploy2(bytes,bytes32) (NodeID: 5)
  │ │   💬 Args: [creationBytecode, keccak256("123")]
  │ │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: Unknown.label(address,string) (NodeID: 6)
  │     💬 Args: [address(safeLaunchpad), "Safe7579Launchpad"]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Safe7579Precompiles.deploySafeSingleton() (NodeID: 7)
  │   💬 Args: [no args]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: BytecodeDeployer._deploy2(bytes,bytes32) (NodeID: 8)
  │ │   💬 Args: [SAFE_SINGLETON_BYTECODE, keccak256("123")]
  │ │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: Unknown.label(address,string) (NodeID: 9)
  │     💬 Args: [safeSingleton, "SafeSingleton"]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: Safe7579Precompiles.deploySafeProxyFactory() (NodeID: 10)
      💬 Args: [no args]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BytecodeDeployer._deploy2(bytes,bytes32) (NodeID: 11)
    │   💬 Args: [SAFE_PROXY_FACTORY_BYTECODE, keccak256("123")]
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: Unknown.label(address,string) (NodeID: 12)
        💬 Args: [address(safeProxyFactory), "SafeProxyFactory"]
        👁️  Def: internal
```
