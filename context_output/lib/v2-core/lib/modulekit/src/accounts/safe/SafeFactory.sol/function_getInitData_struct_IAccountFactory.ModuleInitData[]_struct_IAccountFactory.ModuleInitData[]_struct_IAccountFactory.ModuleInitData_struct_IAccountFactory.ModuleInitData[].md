...
```
┌─ [0] ⚙️ FUNCTION: SafeFactory.getInitData(struct IAccountFactory.ModuleInitData[],struct IAccountFactory.ModuleInitData[],struct IAccountFactory.ModuleInitData,struct IAccountFactory.ModuleInitData[]) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
