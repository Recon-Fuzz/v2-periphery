...
┌─ [0] ⚙️ FUNCTION: NexusFactory.init() (NodeID: 0)
  ...
  │     💬 Args: [nexus, "Nexus"]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: NexusPrecompiles.deployNexusAccountFactory(address,address) (NodeID: 4)
  ...
  │     💬 Args: [address(factory), "NexusAccountFactory"]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: NexusPrecompiles.deployNexusBootstrap() (NodeID: 7)
      💬 Args: [no args]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: BytecodeDeployer._deploy(bytes) (NodeID: 8)
