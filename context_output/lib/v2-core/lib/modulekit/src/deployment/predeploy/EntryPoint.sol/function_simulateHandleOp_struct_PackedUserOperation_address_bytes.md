...
function simulateHandleOp(PackedUserOperation calldata op, address target, bytes calldata targetCallData) external nonReentrant() returns (ExecutionResult memory) {
    ...
    return ExecutionResult(opInfo.preOpGas, paid, validationData, paymasterValidationData, targetSuccess, targetResult);
}
```
...
- **EntryPointSimulations::_validateSenderAndPaymaster(bytes,address,bytes)**
- **unknown::unknown**
...
```
┌─ [0] ⚙️ FUNCTION: EntryPointSimulations.simulateHandleOp(struct PackedUserOperation,address,bytes) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │     💬 Args: [context]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: EntryPoint._executeUserOp(uint256,struct PackedUserOperation,struct EntryPoint.UserOpInfo) (NodeID: 27)
  │   💬 Args: [0, op, opInfo]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: EntryPoint.getMemoryBytesFromOffset(uint256) (NodeID: 28)
  │ │   💬 Args: [opInfo.contextOffset]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: EntryPoint.emitPrefundTooLow(struct EntryPoint.UserOpInfo) (NodeID: 29)
  │ │   💬 Args: [opInfo]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: EntryPoint.emitUserOperationEvent(struct EntryPoint.UserOpInfo,bool,uint256,uint256) (NodeID: 30)
  │ │   💬 Args: [opInfo, false, actualGasCost, actualGas]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Exec.getReturnData(uint256) (NodeID: 31)
  │ │   💬 Args: [REVERT_REASON_MAX_LEN]
  │ │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: EntryPoint._postExecution(enum IPaymaster.PostOpMode,struct EntryPoint.UserOpInfo,bytes,uint256) (NodeID: 32)
  │     💬 Args: [IPaymaster.PostOpMode.postOpReverted, opInfo, context, actualGas]
  │     👁️  Def: private
  │   ├─ [3] ⚙️ FUNCTION: EntryPoint.getUserOpGasPrice(struct EntryPoint.MemoryUserOp) (NodeID: 33)
  │   │   💬 Args: [mUserOp]
  │   │   👁️  Def: internal
  │   │ └─ [4] ⚙️ FUNCTION: Unknown.min(uint256,uint256) (NodeID: 34)
  │   │     💬 Args: [maxFeePerGas, maxPriorityFeePerGas + block.basefee]
  │   │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: Exec.getReturnData(uint256) (NodeID: 35)
  │   │   💬 Args: [REVERT_REASON_MAX_LEN]
  │   │   👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: EntryPoint.emitPrefundTooLow(struct EntryPoint.UserOpInfo) (NodeID: 36)
  │   │   💬 Args: [opInfo]
  │   │   👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: EntryPoint.emitUserOperationEvent(struct EntryPoint.UserOpInfo,bool,uint256,uint256) (NodeID: 37)
  │   │   💬 Args: [opInfo, false, actualGasCost, actualGas]
  │   │   👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: StakeManager._incrementDeposit(address,uint256) (NodeID: 38)
  │   │   💬 Args: [refundAddress, refund]
  │   │   👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: EntryPoint.emitUserOperationEvent(struct EntryPoint.UserOpInfo,bool,uint256,uint256) (NodeID: 39)
  │       💬 Args: [opInfo, success, actualGasCost, actualGas]
  │       👁️  Def: internal
  └─ [1] 🔒 MODIFIER: ReentrancyGuard.nonReentrant() (NodeID: 40)
      💬 Args: [no args]
    ├─ [2] ⚙️ FUNCTION: ReentrancyGuard._nonReentrantBefore() (NodeID: 41)
    │   💬 Args: [no args]
    │   👁️  Def: private
    └─ [2] ⚙️ FUNCTION: ReentrancyGuard._nonReentrantAfter() (NodeID: 42)
        💬 Args: [no args]
        👁️  Def: private
```
