# Function: handleOps(struct PackedUserOperation[],address payable)
...
```
┌─ [0] ⚙️ FUNCTION: EntryPoint.handleOps(struct PackedUserOperation[],address payable) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [i, validationData, pmValidationData, address(0)]
  │   👁️  Def: internal
