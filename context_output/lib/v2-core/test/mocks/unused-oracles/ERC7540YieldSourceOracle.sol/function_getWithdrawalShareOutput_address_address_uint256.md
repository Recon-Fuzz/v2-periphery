...
```
┌─ [0] ⚙️ FUNCTION: ERC7540YieldSourceOracle.getWithdrawalShareOutput(address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256,enum Math.Rounding) (NodeID: 1)
      💬 Args: [assetsIn, 1e18, assetsPerShare, Math.Rounding.Ceil]
      👁️  Def: internal
