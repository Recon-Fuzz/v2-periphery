...
- **Kind**: internal
- **Source**: 2072:262:498
- **Link**: `lib/v2-core/test/mocks/unused-oracles/ERC7540YieldSourceOracle.sol:ERC7540YieldSourceOracle:getAssetOutput(address,address,uint256)`
...
┌─ [0] ⚙️ FUNCTION: AbstractYieldSourceOracle.getAssetOutputWithFees(bytes32,address,address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ERC7540YieldSourceOracle.getAssetOutput(address,address,uint256) (NodeID: 1)
