...
- **Name**: IGateway
- **Type**: Interface
- **Path**: lib/v2-core/test/mocks/centrifuge/IGateway.sol
...
### messageHandlers(uint8)

- **Signature**: `messageHandlers(uint8)`
- **Visibility**: external
- **Source Range**: 2320:74:488
...
### recoveries(address,bytes32)

- **Signature**: `recoveries(address,bytes32)`
- **Visibility**: external
- **Source Range**: 2479:100:488
...
### file(bytes32,uint8,address)

- **Signature**: `file(bytes32,uint8,address)`
- **Visibility**: external
- **Source Range**: 3748:65:488
...
### file(bytes32,address,bool)

- **Signature**: `file(bytes32,address,bool)`
- **Visibility**: external
- **Source Range**: 4177:69:488
...
### disputeMessageRecovery(address,bytes32)

- **Signature**: `disputeMessageRecovery(address,bytes32)`
- **Visibility**: external
- **Source Range**: 5029:79:488
...
### executeMessageRecovery(address,bytes)

- **Signature**: `executeMessageRecovery(address,bytes)`
- **Visibility**: external
- **Source Range**: 5811:82:488
...
- **Signature**: `send(bytes,address)`
- **Visibility**: external
- **Source Range**: 6625:71:488
...
- **Signature**: `activeSessionId()`
- **Visibility**: external
- **Source Range**: 7952:58:488
...
- **Signature**: `votes(bytes32)`
- **Visibility**: external
- **Source Range**: 8488:93:488
...
- **Signature**: `estimate(bytes)`
- **Visibility**: external
- **Source Range**: 9274:109:488
...
- **Signature**: `payers(address)`
- **Visibility**: external
- **Source Range**: 9644:71:488
