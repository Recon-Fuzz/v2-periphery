...
- **Name**: MockApproveAndSwapOdosHook
- **Type**: Contract
- **Path**: lib/v2-core/test/mocks/unused-hooks/MockApproveAndSwapOdosHook.sol
- **Documentation**: @title MockApproveAndSwapOdosHook
...
**IOdosRouterV2**: [lib/v2-core/src/vendor/odos/IOdosRouterV2.sol/interface_IOdosRouterV2.md]
...
### inspect(bytes) (inherited from BaseHook)
