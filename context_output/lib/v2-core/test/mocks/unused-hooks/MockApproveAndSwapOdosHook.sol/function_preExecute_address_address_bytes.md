...
- **Kind**: internal
- **Source**: 4634:153:496
- **Link**: `lib/v2-core/test/mocks/unused-hooks/MockApproveAndSwapOdosHook.sol:MockApproveAndSwapOdosHook:_preExecute(address,address,bytes)`
...
- **Kind**: internal
- **Source**: 5164:299:496
- **Link**: `lib/v2-core/test/mocks/unused-hooks/MockApproveAndSwapOdosHook.sol:MockApproveAndSwapOdosHook:_getBalance(address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MockApproveAndSwapOdosHook._preExecute(address,address,bytes) (NodeID: 7)
    ...
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 8)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: MockApproveAndSwapOdosHook._getBalance(address,bytes) (NodeID: 12)
      │   💬 Args: [account, data]
      │   👁️  Def: private
