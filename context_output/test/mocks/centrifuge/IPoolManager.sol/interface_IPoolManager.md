...
- **Name**: IPoolManager
- **Type**: Interface
- **Path**: test/mocks/centrifuge/IPoolManager.sol

## Implements Interfaces

- **IRecoverable** [test/mocks/centrifuge/IRoot.sol/interface_IRecoverable.md]
- **IMessageHandler** [test/mocks/centrifuge/IGateway.sol/interface_IMessageHandler.md]
