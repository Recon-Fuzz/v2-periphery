...
- **Kind**: internal
- **Source**: 2780:123:610
- **Link**: `test/mocks/SuperVaultExecuteHooksHook.sol:SuperVaultExecuteHooksHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: SuperVaultExecuteHooksHook._preExecute(address,address,bytes) (NodeID: 7)
