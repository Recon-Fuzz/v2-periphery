...
- **Kind**: internal
- **Source**: 1538:214:595
- **Link**: `test/mocks/MockHookWithSlippage.sol:MockHookWithSlippage:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MockHookWithSlippage._preExecute(address,address,bytes) (NodeID: 7)
