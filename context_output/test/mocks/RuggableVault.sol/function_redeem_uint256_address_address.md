...
- **Kind**: internal
- **Source**: 4375:125:609
- **Link**: `test/mocks/RuggableVault.sol:RuggableVault:previewRedeem(uint256)`
...
- **Kind**: internal
- **Source**: 2943:224:609
- **Link**: `test/mocks/RuggableVault.sol:RuggableVault:convertToAssets(uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: RuggableVault.redeem(uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: RuggableVault.previewRedeem(uint256) (NodeID: 1)
  │   💬 Args: [shares]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: RuggableVault.convertToAssets(uint256) (NodeID: 2)
  │     💬 Args: [shares]
  │     👁️  Def: public
  ...
  │       💬 Args: [shares, totalAssets(), supply, Math.Rounding.Floor]
  │       👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: RuggableVault.totalAssets() (NodeID: 12)
  │     │   💬 Args: [no args]
  │     │   👁️  Def: public
  ...
  │               💬 Args: [condition]
  │               👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ERC20.allowance(address,address) (NodeID: 13)
  │   💬 Args: [owner, msg.sender]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: ERC20._approve(address,address,uint256) (NodeID: 14)
  │   💬 Args: [owner, msg.sender, allowed - shares]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: ERC20._approve(address,address,uint256,bool) (NodeID: 15)
  │     💬 Args: [owner, spender, value, true]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ERC20._burn(address,uint256) (NodeID: 16)
  │   💬 Args: [owner, shares]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: ERC20._update(address,address,uint256) (NodeID: 17)
  │     💬 Args: [account, address(0), value]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: RuggableVault.calculateRuggedAmount(uint256) (NodeID: 18)
      💬 Args: [assets]
      👁️  Def: public
```
