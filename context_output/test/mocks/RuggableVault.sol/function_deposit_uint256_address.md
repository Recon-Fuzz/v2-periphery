...
- **Kind**: internal
- **Source**: 3657:126:609
- **Link**: `test/mocks/RuggableVault.sol:RuggableVault:previewDeposit(uint256)`
...
- **Kind**: internal
- **Source**: 2647:290:609
- **Link**: `test/mocks/RuggableVault.sol:RuggableVault:convertToShares(uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: RuggableVault.deposit(uint256,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: RuggableVault.previewDeposit(uint256) (NodeID: 1)
  │   💬 Args: [assets]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: RuggableVault.convertToShares(uint256) (NodeID: 2)
  │     💬 Args: [assets]
  │     👁️  Def: public
  │   ├─ [3] ⚙️ FUNCTION: ERC20.totalSupply() (NodeID: 3)
  │   │   💬 Args: [no args]
  │   │   👁️  Def: public
  │   ├─ [3] ⚙️ FUNCTION: RuggableVault.totalAssets() (NodeID: 4)
  │   │   💬 Args: [no args]
  │   │   👁️  Def: public
  │   └─ [3] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256,enum Math.Rounding) (NodeID: 5)
  │       💬 Args: [assets, supply, totalAssets_, Math.Rounding.Floor]
  │       👁️  Def: internal
  ...
  │               💬 Args: [condition]
  │               👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: RuggableVault.calculateRuggedAmount(uint256) (NodeID: 13)
  │   💬 Args: [shares]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: ERC20._mint(address,uint256) (NodeID: 14)
  │   💬 Args: [receiver, actualShares]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: ERC20._update(address,address,uint256) (NodeID: 15)
  │     💬 Args: [address(0), account, value]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: ERC20._mint(address,uint256) (NodeID: 16)
