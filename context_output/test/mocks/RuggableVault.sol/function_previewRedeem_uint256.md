...
```
┌─ [0] ⚙️ FUNCTION: RuggableVault.previewRedeem(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: RuggableVault.convertToAssets(uint256) (NodeID: 1)
      💬 Args: [shares]
      👁️  Def: public
    ...
    └─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256,enum Math.Rounding) (NodeID: 3)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: RuggableVault.totalAssets() (NodeID: 11)
      │   💬 Args: [no args]
      │   👁️  Def: public
