...
- **Name**: MockSuperHook
- **Type**: Contract
- **Path**: test/mocks/MockSuperHook.sol
- **Documentation**: @notice Mock SuperHook implementation for testing
...
### setShouldFailBuild(bool)

- **Signature**: `setShouldFailBuild(bool)`
- **Visibility**: external
- **Source Range**: 967:101:604
- **Details**: [function_setShouldFailBuild_bool.md](./function_setShouldFailBuild_bool.md)
...
### setShouldReturnEmptyExecutions(bool)

- **Signature**: `setShouldReturnEmptyExecutions(bool)`
- **Visibility**: external
- **Source Range**: 1074:139:604
- **Details**: [function_setShouldReturnEmptyExecutions_bool.md](./function_setShouldReturnEmptyExecutions_bool.md)
...
- **Details**: [function_setCallData_bytes.md](./function_setCallData_bytes.md)
