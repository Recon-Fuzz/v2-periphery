...
- **Kind**: internal
- **Source**: 2186:248:604
- **Link**: `test/mocks/MockSuperHook.sol:MockSuperHook:_preExecute(address,address,bytes)`
...
┌─ [0] ⚙️ FUNCTION: BaseHook.preExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, PRE_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MockSuperHook._preExecute(address,address,bytes) (NodeID: 7)
