...
- **Name**: MockNativeETHHook
- **Type**: Contract
- **Path**: test/mocks/MockNativeETHHook.sol
- **Documentation**: @title MockNativeETHHook
...
### setETHAmount(uint256)

- **Signature**: `setETHAmount(uint256)`
- **Visibility**: external
- **Source Range**: 2244:84:599
- **Details**: [function_setETHAmount_uint256.md](./function_setETHAmount_uint256.md)
...
### setUsePrevAmount(bool)

- **Signature**: `setUsePrevAmount(bool)`
- **Visibility**: external
- **Source Range**: 2450:91:599
- **Details**: [function_setUsePrevAmount_bool.md](./function_setUsePrevAmount_bool.md)
