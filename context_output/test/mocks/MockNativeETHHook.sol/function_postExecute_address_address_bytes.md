...
- **Kind**: internal
- **Source**: 5856:322:599
- **Link**: `test/mocks/MockNativeETHHook.sol:MockNativeETHHook:_postExecute(address,address,bytes)`

```solidity
function _postExecute(address, address account, bytes calldata) override internal {
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MockNativeETHHook._postExecute(address,address,bytes) (NodeID: 7)
      💬 Args: [prevHook, account, data]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseHook.getOutAmount(address) (NodeID: 8)
    │   💬 Args: [account]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: BaseHook._getOutAmount(uint256) (NodeID: 9)
    │     💬 Args: [_getCurrentExecutionContext(caller)]
    │     👁️  Def: private
    │   ├─ [4] ⚙️ FUNCTION: BaseHook._getCurrentExecutionContext(address) (NodeID: 11)
    │   │   💬 Args: [caller]
    │   │   👁️  Def: private
    │   │ └─ [5] ⚙️ FUNCTION: BaseHook._makeAccountContextKey(address) (NodeID: 12)
    │   │     💬 Args: [caller]
    │   │     👁️  Def: private
    │   └─ [4] ⚙️ FUNCTION: BaseHook._makeKey(uint256,uint256) (NodeID: 10)
    │       💬 Args: [context, OUT_AMOUNT_OFFSET]
    │       👁️  Def: private
    └─ [2] ⚙️ FUNCTION: BaseHook._setOutAmount(uint256,address) (NodeID: 13)
        💬 Args: [initialBalance - finalBalance, account]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BaseHook._getCurrentExecutionContext(address) (NodeID: 14)
      │   💬 Args: [caller]
      │   👁️  Def: private
      │ └─ [4] ⚙️ FUNCTION: BaseHook._makeAccountContextKey(address) (NodeID: 15)
      │     💬 Args: [caller]
      │     👁️  Def: private
      └─ [3] ⚙️ FUNCTION: BaseHook._makeKey(uint256,uint256) (NodeID: 16)
          💬 Args: [context, OUT_AMOUNT_OFFSET]
          👁️  Def: private
```
