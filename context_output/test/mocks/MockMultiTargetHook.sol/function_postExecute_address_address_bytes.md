...
- **Kind**: internal
- **Source**: 4034:158:597
- **Link**: `test/mocks/MockMultiTargetHook.sol:MockMultiTargetHook:_postExecute(address,address,bytes)`

```solidity
/// @notice Override _postExecute
function _postExecute(address prevHook, address sender, bytes calldata data) override internal {
...
┌─ [0] ⚙️ FUNCTION: BaseHook.postExecute(address,address,bytes) (NodeID: 0)
  ...
  │     💬 Args: [context, POST_EXECUTE_MUTEX_OFFSET]
  │     👁️  Def: private
  └─ [1] ⚙️ FUNCTION: MockMultiTargetHook._postExecute(address,address,bytes) (NodeID: 7)
