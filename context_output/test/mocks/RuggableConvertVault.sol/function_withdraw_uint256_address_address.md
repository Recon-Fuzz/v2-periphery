...
- **Kind**: internal
- **Source**: 4372:556:608
- **Link**: `test/mocks/RuggableConvertVault.sol:RuggableConvertVault:previewWithdraw(uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: RuggableConvertVault.withdraw(uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: RuggableConvertVault.previewWithdraw(uint256) (NodeID: 1)
  │   💬 Args: [assets]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: ERC20.totalSupply() (NodeID: 2)
  │     💬 Args: [no args]
  │     👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: ERC20.allowance(address,address) (NodeID: 3)
  │   💬 Args: [owner, msg.sender]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: ERC20._approve(address,address,uint256) (NodeID: 4)
  │   💬 Args: [owner, msg.sender, allowed - shares]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: ERC20._approve(address,address,uint256,bool) (NodeID: 5)
  │     💬 Args: [owner, spender, value, true]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: ERC20._burn(address,uint256) (NodeID: 6)
      💬 Args: [owner, shares]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: ERC20._update(address,address,uint256) (NodeID: 7)
