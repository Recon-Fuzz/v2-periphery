# Function: deposit(struct ISuperAsset.DepositArgs)
...
```
┌─ [0] ⚙️ FUNCTION: SuperAsset.deposit(struct ISuperAsset.DepositArgs) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │             💬 Args: [condition]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ERC20.totalSupply() (NodeID: 74)
  │   💬 Args: [no args]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: SuperAsset._settleIncentive(address,int256) (NodeID: 75)
  │   💬 Args: [args.receiver, ret.amountIncentiveUSDDeposit]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: ERC20._mint(address,uint256) (NodeID: 76)
      💬 Args: [args.receiver, ret.amountSharesMinted]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: ERC20._update(address,address,uint256) (NodeID: 77)
