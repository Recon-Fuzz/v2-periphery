# Function: previewDeposit(struct ISuperAsset.PreviewDepositArgs)
...
- **IIncentiveFundContract::incentivesEnabled()**
- **ISuperAssetFactory::getIncentiveFundContract(address)**
- **IIncentiveCalculationContract::calculateIncentive(uint256[],uint256[],uint256[],uint256[],uint256,uint256,uint256,uint256)**
- **ISuperAssetFactory::getIncentiveCalculationContract(address)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperAsset.previewDeposit(struct ISuperAsset.PreviewDepositArgs) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         💬 Args: [condition]
  │         👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: SuperAsset.getAllocationsPrePostOperationDeposit(address,uint256,uint256,bool) (NodeID: 6)
      💬 Args: [args.tokenIn, args.amountTokenToDeposit, args.amountTokenToDeposit - ret.swapFee, args.isSoft]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: EnumerableSet.length(struct EnumerableSet.AddressSet) (NodeID: 7)
    │   💬 Args: [_supportedAssets]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: EnumerableSet._length(struct EnumerableSet.Set) (NodeID: 8)
    │     💬 Args: [set._inner]
    │     👁️  Def: private
    ├─ [2] ⚙️ FUNCTION: EnumerableSet.at(struct EnumerableSet.AddressSet,uint256) (NodeID: 9)
    │   💬 Args: [_supportedAssets, i]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: EnumerableSet._at(struct EnumerableSet.Set,uint256) (NodeID: 10)
    │     💬 Args: [set._inner, index]
    │     👁️  Def: private
    ├─ [2] ⚙️ FUNCTION: SuperAsset.getPriceAndCircuitBreakers(address) (NodeID: 11)
    │   💬 Args: [s.token]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: SuperAssetPriceLib.getPriceWithCircuitBreakers(struct ISuperAsset.PriceArgs) (NodeID: 12)
    ...
    │     👁️  Def: external
    │   ├─ [4] ⚙️ FUNCTION: SuperAssetPriceLib._getPriceInfo(contract ISuperOracle,contract ISuperAsset,address,address) (NodeID: 13)
    │   │   💬 Args: [superOracle, superAsset, args.usd, args.token]
    │   │   👁️  Def: internal
    │   │ └─ [5] ⚙️ FUNCTION: SuperAssetPriceLib._derivePriceFromUnderlyingVault(contract ISuperOracle,contract ISuperAsset,address,address,address) (NodeID: 14)
    ...
    │   │               💬 Args: [condition]
    │   │               👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: SuperAssetPriceLib._getDepegAndDispersion(struct ISuperAsset.PriceArgs,uint256,uint256,uint256) (NodeID: 23)
    │       💬 Args: [args, precision, priceUSD, stddev]
    │       👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: SuperAssetPriceLib._getAssetPriceUSD(address,address,address) (NodeID: 24)
    │     │   💬 Args: [args.superOracle, args.superAsset, args.usd]
    │     │   👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: SuperAssetPriceLib._isTokenDepeg(uint256,uint256,uint256,uint256,uint256) (NodeID: 25)
    │     │   💬 Args: [priceUSD, precision, assetPriceUSD, args.depegLowerThreshold, args.depegUpperThreshold]
    │     │   👁️  Def: internal
    │     │ └─ [6] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 26)
    │     │     💬 Args: [priceUSD, precision, assetPriceUSD]
    │     │     👁️  Def: internal
    │     │   ├─ [7] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 27)
    │     │   │   💬 Args: [x, y]
    │     │   │   👁️  Def: internal
    │     │   └─ [7] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 28)
    │     │       💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
    │     │       👁️  Def: internal
    │     │     └─ [8] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 29)
    │     │         💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
    │     │         👁️  Def: internal
    │     │       └─ [9] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 30)
    │     │           💬 Args: [condition]
    │     │           👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: SuperAssetPriceLib._isSTDDevDegged(address,uint256,uint256,uint256) (NodeID: 31)
    │         💬 Args: [args.superAsset, stddev, priceUSD, args.dispersionThreshold]
    │         👁️  Def: internal
    │       └─ [6] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 32)
    │           💬 Args: [stddev, ISuperAsset(superAsset).getPrecision(), priceUSD]
    │           👁️  Def: internal
    │         ├─ [7] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 33)
    │         │   💬 Args: [x, y]
    │         │   👁️  Def: internal
    │         └─ [7] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 34)
    │             💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
    │             👁️  Def: internal
    │           └─ [8] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 35)
    │               💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
    │               👁️  Def: internal
    │             └─ [9] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 36)
    │                 💬 Args: [condition]
    │                 👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 37)
    │   💬 Args: [s.balance, ret.oraclePriceUSD, 10 ** decimals]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 38)
    │ │   💬 Args: [x, y]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 39)
    │     💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 40)
    │       💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
    │       👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 41)
    │         💬 Args: [condition]
    │         👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 42)
    │   💬 Args: [s.balance, ret.oraclePriceUSD, 10 ** decimals]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 43)
    │ │   💬 Args: [x, y]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 44)
    │     💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 45)
    │       💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
    │       👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 46)
    │         💬 Args: [condition]
    │         👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 47)
    │   💬 Args: [deltaToken, s.priceUSDToken, 10 ** decimals]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 48)
    │ │   💬 Args: [x, y]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 49)
    │     💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 50)
    │       💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
    │       👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 51)
    │         💬 Args: [condition]
    │         👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ERC20.totalSupply() (NodeID: 52)
    │   💬 Args: [no args]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 53)
    │   💬 Args: [s.totalValueUSD, PRECISION, totalSupply_]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 54)
    │ │   💬 Args: [x, y]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 55)
    │     💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 56)
    │       💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
    │       👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 57)
    │         💬 Args: [condition]
    │         👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 58)
    │   💬 Args: [amountToken, s.priceUSDToken, superAssetPPS]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 59)
    │ │   💬 Args: [x, y]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 60)
    │     💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 61)
    │       💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
    │       👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 62)
    │         💬 Args: [condition]
    │         👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 63)
    │   💬 Args: [ret.amountAssets, 10 ** (DECIMALS - decimalsToken), PRECISION]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 64)
    │ │   💬 Args: [x, y]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 65)
    │     💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 66)
    │       💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
    │       👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 67)
    │         💬 Args: [condition]
    │         👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 68)
        💬 Args: [ret.amountAssets, 10 ** (decimalsToken - DECIMALS), PRECISION]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 69)
      │   💬 Args: [x, y]
      │   👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 70)
          💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
          👁️  Def: internal
        └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 71)
            💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
            👁️  Def: internal
          └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 72)
              💬 Args: [condition]
              👁️  Def: internal
```
