# Function: previewRedeem(struct ISuperAsset.PreviewRedeemArgs)
...
```
┌─ [0] ⚙️ FUNCTION: SuperAsset.previewRedeem(struct ISuperAsset.PreviewRedeemArgs) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: SuperAsset.getAllocationsPrePostOperationRedeem(address,uint256,bool) (NodeID: 1)
  │   💬 Args: [args.tokenOut, args.amountSharesToRedeem, args.isSoft]
  │   👁️  Def: public
  │ ├─ [2] ⚙️ FUNCTION: EnumerableSet.length(struct EnumerableSet.AddressSet) (NodeID: 2)
  │ │   💬 Args: [_supportedAssets]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: EnumerableSet._length(struct EnumerableSet.Set) (NodeID: 3)
  │ │     💬 Args: [set._inner]
  │ │     👁️  Def: private
  │ ├─ [2] ⚙️ FUNCTION: EnumerableSet.at(struct EnumerableSet.AddressSet,uint256) (NodeID: 4)
  │ │   💬 Args: [_supportedAssets, i]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: EnumerableSet._at(struct EnumerableSet.Set,uint256) (NodeID: 5)
  │ │     💬 Args: [set._inner, index]
  │ │     👁️  Def: private
  │ ├─ [2] ⚙️ FUNCTION: SuperAsset.getPriceAndCircuitBreakers(address) (NodeID: 6)
  │ │   💬 Args: [s.token]
  │ │   👁️  Def: public
  │ │ └─ [3] ⚙️ FUNCTION: SuperAssetPriceLib.getPriceWithCircuitBreakers(struct ISuperAsset.PriceArgs) (NodeID: 7)
  ...
  │ │     👁️  Def: external
  │ │   ├─ [4] ⚙️ FUNCTION: SuperAssetPriceLib._getPriceInfo(contract ISuperOracle,contract ISuperAsset,address,address) (NodeID: 8)
  │ │   │   💬 Args: [superOracle, superAsset, args.usd, args.token]
  │ │   │   👁️  Def: internal
  │ │   │ └─ [5] ⚙️ FUNCTION: SuperAssetPriceLib._derivePriceFromUnderlyingVault(contract ISuperOracle,contract ISuperAsset,address,address,address) (NodeID: 9)
  │ │   │     💬 Args: [superOracle, superAsset, USD, token, tokenData.oracle]
  │ │   │     👁️  Def: internal
  │ │   │   └─ [6] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256,enum Math.Rounding) (NodeID: 10)
  ...
  │ │   │     │   👁️  Def: internal
  │ │   │     │ └─ [8] ⚙️ FUNCTION: Math.unsignedRoundsUp(enum Math.Rounding) (NodeID: 12)
  │ │   │     │     💬 Args: [rounding]
  │ │   │     │     👁️  Def: internal
  │ │   │     └─ [7] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 13)
  │ │   │         💬 Args: [x, y, denominator]
  │ │   │         👁️  Def: internal
  │ │   │       ├─ [8] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 14)
  │ │   │       │   💬 Args: [x, y]
  │ │   │       │   👁️  Def: internal
  │ │   │       └─ [8] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 15)
  │ │   │           💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
  │ │   │           👁️  Def: internal
  │ │   │         └─ [9] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 16)
  │ │   │             💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
  │ │   │             👁️  Def: internal
  │ │   │           └─ [10] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 17)
  │ │   │               💬 Args: [condition]
  │ │   │               👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: SuperAssetPriceLib._getDepegAndDispersion(struct ISuperAsset.PriceArgs,uint256,uint256,uint256) (NodeID: 18)
  │ │       💬 Args: [args, precision, priceUSD, stddev]
  │ │       👁️  Def: internal
  │ │     ├─ [5] ⚙️ FUNCTION: SuperAssetPriceLib._getAssetPriceUSD(address,address,address) (NodeID: 19)
  │ │     │   💬 Args: [args.superOracle, args.superAsset, args.usd]
  │ │     │   👁️  Def: internal
  │ │     ├─ [5] ⚙️ FUNCTION: SuperAssetPriceLib._isTokenDepeg(uint256,uint256,uint256,uint256,uint256) (NodeID: 20)
  ...
  │ │     │           💬 Args: [condition]
  │ │     │           👁️  Def: internal
  │ │     └─ [5] ⚙️ FUNCTION: SuperAssetPriceLib._isSTDDevDegged(address,uint256,uint256,uint256) (NodeID: 26)
  │ │         💬 Args: [args.superAsset, stddev, priceUSD, args.dispersionThreshold]
  │ │         👁️  Def: internal
  │ │       └─ [6] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 27)
  │ │           💬 Args: [stddev, ISuperAsset(superAsset).getPrecision(), priceUSD]
  │ │           👁️  Def: internal
  │ │         ├─ [7] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 28)
  │ │         │   💬 Args: [x, y]
  │ │         │   👁️  Def: internal
  │ │         └─ [7] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 29)
  │ │             💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
  │ │             👁️  Def: internal
  │ │           └─ [8] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 30)
  │ │               💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
  │ │               👁️  Def: internal
  │ │             └─ [9] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 31)
  │ │                 💬 Args: [condition]
  │ │                 👁️  Def: internal
  ...
  │ │         💬 Args: [condition]
  │ │         👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: ERC20.totalSupply() (NodeID: 37)
  │ │   💬 Args: [no args]
  │ │   👁️  Def: public
  ...
  │ │         💬 Args: [condition]
  │ │         👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 43)
  │ │   💬 Args: [amountToken, s.superAssetPPS, s.priceUSDToken]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 44)
  │ │ │   💬 Args: [x, y]
  │ │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 45)
  │ │     💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 46)
  │ │       💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
  │ │       👁️  Def: internal
  │ │     └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 47)
  │ │         💬 Args: [condition]
  │ │         👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 48)
  │ │   💬 Args: [ret.amountAssets, 10 ** (DECIMALS - s.decimalsToken), PRECISION]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 49)
  │ │ │   💬 Args: [x, y]
  │ │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 50)
  │ │     💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 51)
  │ │       💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
  │ │       👁️  Def: internal
  │ │     └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 52)
  │ │         💬 Args: [condition]
  │ │         👁️  Def: internal
  ...
  │ │         💬 Args: [condition]
  │ │         👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: EnumerableSet.at(struct EnumerableSet.AddressSet,uint256) (NodeID: 58)
  │ │   💬 Args: [_supportedAssets, i]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: EnumerableSet._at(struct EnumerableSet.Set,uint256) (NodeID: 59)
  │ │     💬 Args: [set._inner, index]
  │ │     👁️  Def: private
  │ ├─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 60)
  │ │   💬 Args: [s.balances[i], s.oraclePriceUSDs[i], 10 ** s.decimals[i]]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 61)
  │ │ │   💬 Args: [x, y]
  │ │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 62)
  │ │     💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 63)
  │ │       💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
  │ │       👁️  Def: internal
  │ │     └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 64)
  │ │         💬 Args: [condition]
  │ │         👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 65)
  │     💬 Args: [s.deltaToken, s.oraclePriceUSDs[i], 10 ** s.decimals[i]]
  │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 66)
  │   │   💬 Args: [x, y]
  │   │   👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 67)
  │       💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
  │       👁️  Def: internal
  │     └─ [4] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 68)
  │         💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
  │         👁️  Def: internal
  │       └─ [5] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 69)
  │           💬 Args: [condition]
  │           👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: Math.mulDiv(uint256,uint256,uint256) (NodeID: 70)
      💬 Args: [allocRet.amountAssets, swapFeeOutPercentage, SWAP_FEE_PERC]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Math.mul512(uint256,uint256) (NodeID: 71)
    │   💬 Args: [x, y]
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: Panic.panic(uint256) (NodeID: 72)
        💬 Args: [ternary(denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW)]
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: Math.ternary(bool,uint256,uint256) (NodeID: 73)
          💬 Args: [denominator == 0, Panic.DIVISION_BY_ZERO, Panic.UNDER_OVERFLOW]
          👁️  Def: internal
        └─ [4] ⚙️ FUNCTION: SafeCast.toUint(bool) (NodeID: 74)
            💬 Args: [condition]
            👁️  Def: internal
```
