# Function: addVaultBank(uint64,address)
...
- **_vaultBanks** (`struct EnumerableSet.AddressSet`)
- **_vaultBanksByChainId** (`mapping(uint64 => address)`)

## Call Tree

```
┌─ [0] ⚙️ FUNCTION: SuperRegistry.addVaultBank(uint64,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: EnumerableSet.remove(struct EnumerableSet.AddressSet,address) (NodeID: 1)
  │   💬 Args: [_vaultBanks, _vaultBanksByChainId[chainId]]
  │   👁️  Def: internal
