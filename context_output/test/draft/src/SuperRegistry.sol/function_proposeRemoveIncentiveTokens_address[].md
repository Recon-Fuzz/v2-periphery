# Function: proposeRemoveIncentiveTokens(address[])
...
function proposeRemoveIncentiveTokens(address[] memory tokens) external onlyRole(_REGISTRY_ADMIN_ROLE) {
    ...
    emit WhitelistedIncentiveTokensProposed(_proposedRemoveWhitelistedIncentiveTokens.values(), _proposedRemoveWhitelistedIncentiveTokensEffectiveTime);
}
```
...
```
┌─ [0] ⚙️ FUNCTION: SuperRegistry.proposeRemoveIncentiveTokens(address[]) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: EnumerableSet.add(struct EnumerableSet.AddressSet,address) (NodeID: 1)
  │   💬 Args: [_proposedRemoveWhitelistedIncentiveTokens, tokens[i]]
  │   👁️  Def: internal
  ...
  │       💬 Args: [set, value]
  │       👁️  Def: private
  ├─ [1] ⚙️ FUNCTION: EnumerableSet.values(struct EnumerableSet.AddressSet) (NodeID: 4)
  │   💬 Args: [_proposedRemoveWhitelistedIncentiveTokens]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: EnumerableSet._values(struct EnumerableSet.Set) (NodeID: 5)
  │     💬 Args: [set._inner]
  │     👁️  Def: private
