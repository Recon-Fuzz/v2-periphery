...
///  @param yieldSourceOracleId The yield source oracle ID
function burnSuperPosition(uint256 amount, address spAddress, uint64 forChainId, bytes32 yieldSourceOracleId) external;;
```
