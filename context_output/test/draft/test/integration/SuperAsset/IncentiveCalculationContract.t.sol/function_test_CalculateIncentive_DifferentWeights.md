# Function: test_CalculateIncentive_DifferentWeights()
...
```
┌─ [0] ⚙️ FUNCTION: IncentiveCalculationContractTest.test_CalculateIncentive_DifferentWeights() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(int256,int256) (NodeID: 2)
      💬 Args: [incentive, 300 * int256(PRECISION)]
      👁️  Def: internal
```
