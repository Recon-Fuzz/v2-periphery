...
- **Name**: IncentiveCalculationContractTest
- **Type**: Contract
- **Path**: test/draft/test/integration/SuperAsset/IncentiveCalculationContract.t.sol
...
```solidity
uint256 internal constant PERC = 100e18
```
...
### test_Energy_NormalCase()

- **Signature**: `test_Energy_NormalCase()`
- **Visibility**: public
- **Source Range**: 766:1091:564
- **Details**: [function_test_Energy_NormalCase.md](./function_test_Energy_NormalCase.md)
...
### test_Energy_ZeroAllocations()

- **Signature**: `test_Energy_ZeroAllocations()`
- **Visibility**: public
- **Source Range**: 1863:782:564
- **Details**: [function_test_Energy_ZeroAllocations.md](./function_test_Energy_ZeroAllocations.md)
...
### test_Energy_RevertOnMismatchedLengths()

- **Signature**: `test_Energy_RevertOnMismatchedLengths()`
- **Visibility**: public
- **Source Range**: 2651:419:564
- **Details**: [function_test_Energy_RevertOnMismatchedLengths.md](./function_test_Energy_RevertOnMismatchedLengths.md)
...
### test_Energy_DifferentWeights()

- **Signature**: `test_Energy_DifferentWeights()`
- **Visibility**: public
- **Source Range**: 3076:978:564
- **Details**: [function_test_Energy_DifferentWeights.md](./function_test_Energy_DifferentWeights.md)
...
### test_CalculateIncentive_PositiveCase()

- **Signature**: `test_CalculateIncentive_PositiveCase()`
- **Visibility**: public
- **Source Range**: 4060:1694:564
- **Details**: [function_test_CalculateIncentive_PositiveCase.md](./function_test_CalculateIncentive_PositiveCase.md)
...
### test_CalculateIncentive_NegativeCase()

- **Signature**: `test_CalculateIncentive_NegativeCase()`
- **Visibility**: public
- **Source Range**: 5760:1710:564
- **Details**: [function_test_CalculateIncentive_NegativeCase.md](./function_test_CalculateIncentive_NegativeCase.md)
...
### test_CalculateIncentive_NoChange()

- **Signature**: `test_CalculateIncentive_NoChange()`
- **Visibility**: public
- **Source Range**: 7476:1524:564
- **Details**: [function_test_CalculateIncentive_NoChange.md](./function_test_CalculateIncentive_NoChange.md)
...
### test_CalculateIncentive_RevertOnMismatchedLengths()

- **Signature**: `test_CalculateIncentive_RevertOnMismatchedLengths()`
- **Visibility**: public
- **Source Range**: 9006:673:564
- **Details**: [function_test_CalculateIncentive_RevertOnMismatchedLengths.md](./function_test_CalculateIncentive_RevertOnMismatchedLengths.md)
...
### test_CalculateIncentive_DifferentWeights()

- **Signature**: `test_CalculateIncentive_DifferentWeights()`
- **Visibility**: public
- **Source Range**: 9685:1780:564
- **Details**: [function_test_CalculateIncentive_DifferentWeights.md](./function_test_CalculateIncentive_DifferentWeights.md)
...
### test_CalculateIncentive_DifferentTotalAllocations()

- **Signature**: `test_CalculateIncentive_DifferentTotalAllocations()`
- **Visibility**: public
- **Source Range**: 11471:1591:564
- **Details**: [function_test_CalculateIncentive_DifferentTotalAllocations.md](./function_test_CalculateIncentive_DifferentTotalAllocations.md)
...
### test_CalculateIncentive_SmallChange()

- **Signature**: `test_CalculateIncentive_SmallChange()`
- **Visibility**: public
- **Source Range**: 13068:1640:564
- **Details**: [function_test_CalculateIncentive_SmallChange.md](./function_test_CalculateIncentive_SmallChange.md)
...
### test_CalculateIncentive_LargeValues()

- **Signature**: `test_CalculateIncentive_LargeValues()`
- **Visibility**: public
- **Source Range**: 14714:1690:564
- **Details**: [function_test_CalculateIncentive_LargeValues.md](./function_test_CalculateIncentive_LargeValues.md)
...
### test_CalculateIncentive_MultipleAssets()

- **Signature**: `test_CalculateIncentive_MultipleAssets()`
- **Visibility**: public
- **Source Range**: 16410:2264:564
- **Details**: [function_test_CalculateIncentive_MultipleAssets.md](./function_test_CalculateIncentive_MultipleAssets.md)
...
### test_CalculateIncentive_ExtremeExchangeRatio()

- **Signature**: `test_CalculateIncentive_ExtremeExchangeRatio()`
- **Visibility**: public
- **Source Range**: 18680:1543:564
- **Details**: [function_test_CalculateIncentive_ExtremeExchangeRatio.md](./function_test_CalculateIncentive_ExtremeExchangeRatio.md)
...
### test_CalculateIncentive_MixedImprovements()

- **Signature**: `test_CalculateIncentive_MixedImprovements()`
- **Visibility**: public
- **Source Range**: 20229:2053:564
- **Details**: [function_test_CalculateIncentive_MixedImprovements.md](./function_test_CalculateIncentive_MixedImprovements.md)
...
### test_CalculateIncentive_ZeroWeights()

- **Signature**: `test_CalculateIncentive_ZeroWeights()`
- **Visibility**: public
- **Source Range**: 22288:1720:564
- **Details**: [function_test_CalculateIncentive_ZeroWeights.md](./function_test_CalculateIncentive_ZeroWeights.md)
...
### test_CalculateIncentive_MaxValues()

- **Signature**: `test_CalculateIncentive_MaxValues()`
- **Visibility**: public
- **Source Range**: 24014:1416:564
- **Details**: [function_test_CalculateIncentive_MaxValues.md](./function_test_CalculateIncentive_MaxValues.md)
