# Function: test_CalculateIncentive_LargeValues()
...
```
┌─ [0] ⚙️ FUNCTION: IncentiveCalculationContractTest.test_CalculateIncentive_LargeValues() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(int256,int256) (NodeID: 2)
      💬 Args: [incentive, 3150 * int256(PRECISION)]
      👁️  Def: internal
```
