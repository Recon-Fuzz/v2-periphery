# Function: test_Energy_ZeroAllocations()
...
function test_Energy_ZeroAllocations() public view {
    ...
    weights[0] = PRECISION;
    weights[1] = PRECISION;
    (uint256 energy, bool isSuccess) = calculator.energy(currentAllocation, allocationTarget, weights, 1, 1);
...
```
┌─ [0] ⚙️ FUNCTION: IncentiveCalculationContractTest.test_Energy_ZeroAllocations() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
