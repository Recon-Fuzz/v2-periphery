...
### superRegistry (inherited from BaseTestSuperAsset)
...
**SuperAsset**: [test/draft/src/SuperAsset/SuperAsset.sol/contract_SuperAsset.md]
...
**SuperAssetFactory**: [test/draft/src/SuperAsset/SuperAssetFactory.sol/contract_SuperAssetFactory.md]
...
**IncentiveCalculationContract**: [test/draft/src/SuperAsset/IncentiveCalculationContract.sol/contract_IncentiveCalculationContract.md]
...
**IncentiveFundContract**: [test/draft/src/SuperAsset/IncentiveFundContract.sol/contract_IncentiveFundContract.md]
...
**ERC4626YieldSourceOracle**: [lib/v2-core/src/accounting/oracles/ERC4626YieldSourceOracle.sol/contract_ERC4626YieldSourceOracle.md]
...
### BasicDepositWithCircuitBreaker
...
- **Details**: [function_test_Initialize1.md](./function_test_Initialize1.md)
...
### test_Initialize_RevertIfAlreadyInitialized()

- **Signature**: `test_Initialize_RevertIfAlreadyInitialized()`
- **Visibility**: public
- **Source Range**: 18848:430:565
- **Details**: [function_test_Initialize_RevertIfAlreadyInitialized.md](./function_test_Initialize_RevertIfAlreadyInitialized.md)
...
### test_OnlyVaultManagerCanWhitelistTokens()

- **Signature**: `test_OnlyVaultManagerCanWhitelistTokens()`
- **Visibility**: public
- **Source Range**: 19322:611:565
- **Details**: [function_test_OnlyVaultManagerCanWhitelistTokens.md](./function_test_OnlyVaultManagerCanWhitelistTokens.md)
...
### test_OnlyAdminCanSetSwapFees()

- **Signature**: `test_OnlyAdminCanSetSwapFees()`
- **Visibility**: public
- **Source Range**: 19975:489:565
- **Details**: [function_test_OnlyAdminCanSetSwapFees.md](./function_test_OnlyAdminCanSetSwapFees.md)
...
### test_CannotSetFeesAboveMaximum()

- **Signature**: `test_CannotSetFeesAboveMaximum()`
- **Visibility**: public
- **Source Range**: 20470:306:565
- **Details**: [function_test_CannotSetFeesAboveMaximum.md](./function_test_CannotSetFeesAboveMaximum.md)
...
### test_BasicDepositSimple()

- **Signature**: `test_BasicDepositSimple()`
- **Visibility**: public
- **Source Range**: 20811:3263:565
- **Details**: [function_test_BasicDepositSimple.md](./function_test_BasicDepositSimple.md)
...
### test_BasicDepositWithCircuitBreaker()

- **Signature**: `test_BasicDepositWithCircuitBreaker()`
- **Visibility**: public
- **Source Range**: 24322:871:565
- **Details**: [function_test_BasicDepositWithCircuitBreaker.md](./function_test_BasicDepositWithCircuitBreaker.md)
...
### test_BasicDepositWithInsufficientGasCheck()

- **Signature**: `test_BasicDepositWithInsufficientGasCheck()`
- **Visibility**: public
- **Source Range**: 25199:2482:565
- **Details**: [function_test_BasicDepositWithInsufficientGasCheck.md](./function_test_BasicDepositWithInsufficientGasCheck.md)
...
### testGasCheckDirectly()

- **Signature**: `testGasCheckDirectly()`
- **Visibility**: external
- **Source Range**: 27753:2020:565
- **Details**: [function_testGasCheckDirectly.md](./function_testGasCheckDirectly.md)
...
### callGetPriceWithLimitedGas(address,address)

- **Signature**: `callGetPriceWithLimitedGas(address,address)`
- **Visibility**: external
- **Source Range**: 29854:256:565
- **Details**: [function_callGetPriceWithLimitedGas_address_address.md](./function_callGetPriceWithLimitedGas_address_address.md)
...
### test_DepositWithZeroAmount()

- **Signature**: `test_DepositWithZeroAmount()`
- **Visibility**: public
- **Source Range**: 30116:392:565
- **Details**: [function_test_DepositWithZeroAmount.md](./function_test_DepositWithZeroAmount.md)
...
### test_DepositWithUnsupportedToken()

- **Signature**: `test_DepositWithUnsupportedToken()`
- **Visibility**: public
- **Source Range**: 30514:476:565
- **Details**: [function_test_DepositWithUnsupportedToken.md](./function_test_DepositWithUnsupportedToken.md)
...
### test_DepositWithZeroAddress()

- **Signature**: `test_DepositWithZeroAddress()`
- **Visibility**: public
- **Source Range**: 30996:405:565
- **Details**: [function_test_DepositWithZeroAddress.md](./function_test_DepositWithZeroAddress.md)
...
### test_DepositSlippageProtection()

- **Signature**: `test_DepositSlippageProtection()`
- **Visibility**: public
- **Source Range**: 31407:658:565
- **Details**: [function_test_DepositSlippageProtection.md](./function_test_DepositSlippageProtection.md)
...
- **Details**: [function_test_BasicRedeem.md](./function_test_BasicRedeem.md)
...
### test_RedeemWithZeroAmount()

- **Signature**: `test_RedeemWithZeroAmount()`
- **Visibility**: public
- **Source Range**: 36948:386:565
- **Details**: [function_test_RedeemWithZeroAmount.md](./function_test_RedeemWithZeroAmount.md)
...
### test_RedeemWithUnsupportedToken()

- **Signature**: `test_RedeemWithUnsupportedToken()`
- **Visibility**: public
- **Source Range**: 37340:470:565
- **Details**: [function_test_RedeemWithUnsupportedToken.md](./function_test_RedeemWithUnsupportedToken.md)
...
### test_BasicRedeemWithCircuitBreaker()

- **Signature**: `test_BasicRedeemWithCircuitBreaker()`
- **Visibility**: public
- **Source Range**: 37816:1945:565
- **Details**: [function_test_BasicRedeemWithCircuitBreaker.md](./function_test_BasicRedeemWithCircuitBreaker.md)
...
### test_RedeemWithZeroAddress()

- **Signature**: `test_RedeemWithZeroAddress()`
- **Visibility**: public
- **Source Range**: 39767:399:565
- **Details**: [function_test_RedeemWithZeroAddress.md](./function_test_RedeemWithZeroAddress.md)
...
### test_RedeemSlippageProtection()

- **Signature**: `test_RedeemSlippageProtection()`
- **Visibility**: public
- **Source Range**: 40172:1051:565
- **Details**: [function_test_RedeemSlippageProtection.md](./function_test_RedeemSlippageProtection.md)
...
- **Details**: [function_test_BasicSwap.md](./function_test_BasicSwap.md)
...
### test_SwapWithZeroAmount()

- **Signature**: `test_SwapWithZeroAmount()`
- **Visibility**: public
- **Source Range**: 45839:450:565
- **Details**: [function_test_SwapWithZeroAmount.md](./function_test_SwapWithZeroAmount.md)
...
### test_SwapWithUnsupportedToken()

- **Signature**: `test_SwapWithUnsupportedToken()`
- **Visibility**: public
- **Source Range**: 46295:534:565
- **Details**: [function_test_SwapWithUnsupportedToken.md](./function_test_SwapWithUnsupportedToken.md)
...
### test_SwapWithZeroAddress()

- **Signature**: `test_SwapWithZeroAddress()`
- **Visibility**: public
- **Source Range**: 46835:463:565
- **Details**: [function_test_SwapWithZeroAddress.md](./function_test_SwapWithZeroAddress.md)
...
### test_SwapSlippageProtection()

- **Signature**: `test_SwapSlippageProtection()`
- **Visibility**: public
- **Source Range**: 47304:669:565
- **Details**: [function_test_SwapSlippageProtection.md](./function_test_SwapSlippageProtection.md)
...
### test_ERC20TokenActivationAndDeactivation()

- **Signature**: `test_ERC20TokenActivationAndDeactivation()`
- **Visibility**: public
- **Source Range**: 48017:1584:565
- **Details**: [function_test_ERC20TokenActivationAndDeactivation.md](./function_test_ERC20TokenActivationAndDeactivation.md)
...
### test_VaultTokenActivationAndDeactivation()

- **Signature**: `test_VaultTokenActivationAndDeactivation()`
- **Visibility**: public
- **Source Range**: 49607:1930:565
- **Details**: [function_test_VaultTokenActivationAndDeactivation.md](./function_test_VaultTokenActivationAndDeactivation.md)
...
### test_AutoPurgeWithZeroBalance()

- **Signature**: `test_AutoPurgeWithZeroBalance()`
- **Visibility**: public
- **Source Range**: 51543:1658:565
- **Details**: [function_test_AutoPurgeWithZeroBalance.md](./function_test_AutoPurgeWithZeroBalance.md)
...
### test_CannotDepositInactiveToken()

- **Signature**: `test_CannotDepositInactiveToken()`
- **Visibility**: public
- **Source Range**: 53207:1037:565
- **Details**: [function_test_CannotDepositInactiveToken.md](./function_test_CannotDepositInactiveToken.md)
...
### test_CanRedeemInactiveToken()

- **Signature**: `test_CanRedeemInactiveToken()`
- **Visibility**: public
- **Source Range**: 54250:1574:565
- **Details**: [function_test_CanRedeemInactiveToken.md](./function_test_CanRedeemInactiveToken.md)
...
### test_ReactivationErrors()

- **Signature**: `test_ReactivationErrors()`
- **Visibility**: public
- **Source Range**: 55830:1172:565
- **Details**: [function_test_ReactivationErrors.md](./function_test_ReactivationErrors.md)
...
### test_CircuitBreaker_OracleFailure()

- **Signature**: `test_CircuitBreaker_OracleFailure()`
- **Visibility**: public
- **Source Range**: 57008:709:565
- **Details**: [function_test_CircuitBreaker_OracleFailure.md](./function_test_CircuitBreaker_OracleFailure.md)
...
### test_CircuitBreaker_OracleOff()

- **Signature**: `test_CircuitBreaker_OracleOff()`
- **Visibility**: public
- **Source Range**: 57723:735:565
- **Details**: [function_test_CircuitBreaker_OracleOff.md](./function_test_CircuitBreaker_OracleOff.md)
...
### test_TargetAllocationManagement()

- **Signature**: `test_TargetAllocationManagement()`
- **Visibility**: public
- **Source Range**: 58464:1133:565
- **Details**: [function_test_TargetAllocationManagement.md](./function_test_TargetAllocationManagement.md)
...
### test_WeightManagement()

- **Signature**: `test_WeightManagement()`
- **Visibility**: public
- **Source Range**: 59603:820:565
- **Details**: [function_test_WeightManagement.md](./function_test_WeightManagement.md)
...
### test_MultiUserDepositRedeemSequence()

- **Signature**: `test_MultiUserDepositRedeemSequence()`
- **Visibility**: public
- **Source Range**: 60429:2153:565
- **Details**: [function_test_MultiUserDepositRedeemSequence.md](./function_test_MultiUserDepositRedeemSequence.md)
...
### test_CrossTokenSwapsWithDifferentDecimals()

- **Signature**: `test_CrossTokenSwapsWithDifferentDecimals()`
- **Visibility**: public
- **Source Range**: 62588:1934:565
- **Details**: [function_test_CrossTokenSwapsWithDifferentDecimals.md](./function_test_CrossTokenSwapsWithDifferentDecimals.md)
...
### test_CircuitBreaker_DispersionDetection1()

- **Signature**: `test_CircuitBreaker_DispersionDetection1()`
- **Visibility**: public
- **Source Range**: 64528:921:565
- **Details**: [function_test_CircuitBreaker_DispersionDetection1.md](./function_test_CircuitBreaker_DispersionDetection1.md)
...
### test_CircuitBreaker_DispersionDetection2()

- **Signature**: `test_CircuitBreaker_DispersionDetection2()`
- **Visibility**: public
- **Source Range**: 65455:872:565
- **Details**: [function_test_CircuitBreaker_DispersionDetection2.md](./function_test_CircuitBreaker_DispersionDetection2.md)
...
### test_LargeAmountOperations()

- **Signature**: `test_LargeAmountOperations()`
- **Visibility**: public
- **Source Range**: 66333:1106:565
- **Details**: [function_test_LargeAmountOperations.md](./function_test_LargeAmountOperations.md)
...
### test_MinimalAmountOperations()

- **Signature**: `test_MinimalAmountOperations()`
- **Visibility**: public
- **Source Range**: 67445:949:565
- **Details**: [function_test_MinimalAmountOperations.md](./function_test_MinimalAmountOperations.md)
...
### test_SequentialPriceUpdates()

- **Signature**: `test_SequentialPriceUpdates()`
- **Visibility**: public
- **Source Range**: 68400:1999:565
- **Details**: [function_test_SequentialPriceUpdates.md](./function_test_SequentialPriceUpdates.md)
...
### test_EmergencyPriceActivation()

- **Signature**: `test_EmergencyPriceActivation()`
- **Visibility**: public
- **Source Range**: 70405:1292:565
- **Details**: [function_test_EmergencyPriceActivation.md](./function_test_EmergencyPriceActivation.md)
...
### deploySuperRegistry(address,address,address) (inherited from BaseTestSuperAsset)

- **Signature**: `deploySuperRegistry(address,address,address)`
- **Visibility**: public
- **Source Range**: 754:202:572
- **Details**: [function_deploySuperRegistry_address_address_address.md](./function_deploySuperRegistry_address_address_address.md)
