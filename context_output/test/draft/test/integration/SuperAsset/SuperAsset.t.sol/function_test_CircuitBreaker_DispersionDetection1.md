# Function: test_CircuitBreaker_DispersionDetection1()
...
function test_CircuitBreaker_DispersionDetection1() public {
    ...
    mockFeed2.setAnswer((currentPrice * 95) / 100);
...
```
┌─ [0] ⚙️ FUNCTION: SuperAssetTest.test_CircuitBreaker_DispersionDetection1() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
