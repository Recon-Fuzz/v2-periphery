# Function: test_VaultTokenActivationAndDeactivation()
...
- **SuperAsset::activateVault(address)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperAssetTest.test_VaultTokenActivationAndDeactivation() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 1)
  │   💬 Args: [tokenData.isSupportedUnderlyingVault, "Vault should be supported"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 2)
  │   💬 Args: [tokenData.isActive, "Vault should be active after whitelisting"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdCheats.deal(address,address,uint256) (NodeID: 3)
  │   💬 Args: [address(testVault), address(superAsset), 100e18]
  │   👁️  Def: internal
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 101)
  │   💬 Args: [tokenData.isSupportedUnderlyingVault, "Vault should still be supported after deactivation when it has balance"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 102)
  │   💬 Args: [tokenData.isActive, "Vault should be inactive after deactivation"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 103)
      💬 Args: [tokenData.isActive, "Vault should be active after reactivation"]
      👁️  Def: internal
```
