...
- **Name**: VaultBankCrosschainTests
- **Type**: Contract
- **Path**: test/draft/test/integration/VaultBank/VaultBankCrosschainTests.sol
...
### acrossV3AdapterOnBase

```solidity
AcrossV3Adapter public acrossV3AdapterOnBase
```

**AcrossV3Adapter**: [lib/v2-core/src/adapters/AcrossV3Adapter.sol/contract_AcrossV3Adapter.md]

### superTargetExecutorOnBase
...
**IValidator**: [lib/v2-core/lib/modulekit/src/accounts/common/interfaces/IERC7579Module.sol/interface_IValidator.md]

### sourceValidatorOnETH
...
### test_Bridge_Deposit4626_MintSP()

- **Signature**: `test_Bridge_Deposit4626_MintSP()`
- **Visibility**: public
- **Source Range**: 3923:6468:566
- **Details**: [function_test_Bridge_Deposit4626_MintSP.md](./function_test_Bridge_Deposit4626_MintSP.md)
...
- **Details**: [function_test_Bridge_MintSP.md](./function_test_Bridge_MintSP.md)
