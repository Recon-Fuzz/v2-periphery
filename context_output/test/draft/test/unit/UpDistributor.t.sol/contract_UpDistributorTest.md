...
- **Name**: UpDistributorTest
- **Type**: Contract
- **Path**: test/draft/test/unit/UpDistributor.t.sol
...
**UpDistributor**: [test/draft/src/UP/UpDistributor.sol/contract_UpDistributor.md]
...
- **Details**: [function_test_SetMerkleRoot.md](./function_test_SetMerkleRoot.md)
...
### test_RevertWhen_SettingMerkleRootByNonOwner()

- **Signature**: `test_RevertWhen_SettingMerkleRootByNonOwner()`
- **Visibility**: public
- **Source Range**: 2375:242:569
- **Details**: [function_test_RevertWhen_SettingMerkleRootByNonOwner.md](./function_test_RevertWhen_SettingMerkleRootByNonOwner.md)
...
- **Details**: [function_test_Claim.md](./function_test_Claim.md)
...
### test_RevertWhen_ClaimingWithInvalidProof()

- **Signature**: `test_RevertWhen_ClaimingWithInvalidProof()`
- **Visibility**: public
- **Source Range**: 2981:222:569
- **Details**: [function_test_RevertWhen_ClaimingWithInvalidProof.md](./function_test_RevertWhen_ClaimingWithInvalidProof.md)
...
### test_RevertWhen_ClaimingWithInvalidAmount()

- **Signature**: `test_RevertWhen_ClaimingWithInvalidAmount()`
- **Visibility**: public
- **Source Range**: 3209:227:569
- **Details**: [function_test_RevertWhen_ClaimingWithInvalidAmount.md](./function_test_RevertWhen_ClaimingWithInvalidAmount.md)
...
### test_RevertWhen_ClaimingAlreadyClaimed()

- **Signature**: `test_RevertWhen_ClaimingAlreadyClaimed()`
- **Visibility**: public
- **Source Range**: 3442:299:569
- **Details**: [function_test_RevertWhen_ClaimingAlreadyClaimed.md](./function_test_RevertWhen_ClaimingAlreadyClaimed.md)
...
- **Details**: [function_test_ClaimOnBehalf.md](./function_test_ClaimOnBehalf.md)
...
### test_RevertWhen_ClaimingOnBehalfWithInvalidProof()

- **Signature**: `test_RevertWhen_ClaimingOnBehalfWithInvalidProof()`
- **Visibility**: public
- **Source Range**: 3976:245:569
- **Details**: [function_test_RevertWhen_ClaimingOnBehalfWithInvalidProof.md](./function_test_RevertWhen_ClaimingOnBehalfWithInvalidProof.md)
...
### test_RevertWhen_ClaimingOnBehalfWithInvalidAmount()

- **Signature**: `test_RevertWhen_ClaimingOnBehalfWithInvalidAmount()`
- **Visibility**: public
- **Source Range**: 4227:250:569
- **Details**: [function_test_RevertWhen_ClaimingOnBehalfWithInvalidAmount.md](./function_test_RevertWhen_ClaimingOnBehalfWithInvalidAmount.md)
...
### test_RevertWhen_ClaimingOnBehalfAlreadyClaimed()

- **Signature**: `test_RevertWhen_ClaimingOnBehalfAlreadyClaimed()`
- **Visibility**: public
- **Source Range**: 4483:337:569
- **Details**: [function_test_RevertWhen_ClaimingOnBehalfAlreadyClaimed.md](./function_test_RevertWhen_ClaimingOnBehalfAlreadyClaimed.md)
...
- **Details**: [function_test_ReclaimTokens.md](./function_test_ReclaimTokens.md)
...
### test_RevertWhen_ReclaimingTokensByNonOwner()

- **Signature**: `test_RevertWhen_ReclaimingTokensByNonOwner()`
- **Visibility**: public
- **Source Range**: 5274:232:569
- **Details**: [function_test_RevertWhen_ReclaimingTokensByNonOwner.md](./function_test_RevertWhen_ReclaimingTokensByNonOwner.md)
...
### test_RevertWhen_ReclaimingInsufficientBalance()

- **Signature**: `test_RevertWhen_ReclaimingInsufficientBalance()`
- **Visibility**: public
- **Source Range**: 5512:262:569
- **Details**: [function_test_RevertWhen_ReclaimingInsufficientBalance.md](./function_test_RevertWhen_ReclaimingInsufficientBalance.md)
...
### test_CompleteDistributionCycle()

- **Signature**: `test_CompleteDistributionCycle()`
- **Visibility**: public
- **Source Range**: 5835:965:569
- **Details**: [function_test_CompleteDistributionCycle.md](./function_test_CompleteDistributionCycle.md)
...
### test_NewDistributionCycle()

- **Signature**: `test_NewDistributionCycle()`
- **Visibility**: public
- **Source Range**: 6806:778:569
- **Details**: [function_test_NewDistributionCycle.md](./function_test_NewDistributionCycle.md)
