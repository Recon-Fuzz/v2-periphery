...
**VaultBank**: [test/draft/src/VaultBank/VaultBank.sol/contract_VaultBank.md]
...
```solidity
address internal deposit4626Hook
```

### mintSuperPositionsHook

```solidity
address internal mintSuperPositionsHook
```
...
**SuperValidator**: [lib/v2-core/src/validators/SuperValidator.sol/contract_SuperValidator.md]
...
### test_ShouldExecuteAll_AndLockAssetsInVaultBank_Test2HookChaining(uint256)

- **Signature**: `test_ShouldExecuteAll_AndLockAssetsInVaultBank_Test2HookChaining(uint256)`
- **Visibility**: external
- **Source Range**: 5751:2904:571
- **Details**: [function_test_ShouldExecuteAll_AndLockAssetsInVaultBank_Test2HookChaining_uint256.md](./function_test_ShouldExecuteAll_AndLockAssetsInVaultBank_Test2HookChaining_uint256.md)
...
### test_ShouldExecuteAll_AndLockAssetsInVaultBank_Test1ExistingShares(uint256)

- **Signature**: `test_ShouldExecuteAll_AndLockAssetsInVaultBank_Test1ExistingShares(uint256)`
- **Visibility**: external
- **Source Range**: 8661:1791:571
- **Details**: [function_test_ShouldExecuteAll_AndLockAssetsInVaultBank_Test1ExistingShares_uint256.md](./function_test_ShouldExecuteAll_AndLockAssetsInVaultBank_Test1ExistingShares_uint256.md)
