# Function: test_distributeSuperPosition_InvalidProofToken()
...
function test_distributeSuperPosition_InvalidProofToken() public {
    ...
    bytes memory mockTopics = abi.encodePacked(IVaultBankSource.SharesLocked.selector, sourceAsset.yieldSourceOracleId, bytes32(uint256(uint160(account))), keccak256(abi.encodePacked(wrongToken)));
...
```
┌─ [0] ⚙️ FUNCTION: VaultBankTest.test_distributeSuperPosition_InvalidProofToken() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
