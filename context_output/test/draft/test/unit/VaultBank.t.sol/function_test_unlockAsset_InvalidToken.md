# Function: test_unlockAsset_InvalidToken()
...
function test_unlockAsset_InvalidToken() public {
    ...
    mockProver.mockSuperpositionsBurnedEvent(user, address(0), lockAmount, CURRENT_CHAIN_ID, 0, uint32(DST_CHAIN_ID), yieldSourceOracleId);
...
```
┌─ [0] ⚙️ FUNCTION: VaultBankTest.test_unlockAsset_InvalidToken() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
