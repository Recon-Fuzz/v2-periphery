# Function: test_unlockAsset_InvalidProofToken()
...
function test_unlockAsset_InvalidProofToken() public {
    ...
    mockProver.mockSuperpositionsBurnedEvent(user, address(token2), lockAmount, CURRENT_CHAIN_ID, 0, uint32(DST_CHAIN_ID), yieldSourceOracleId);
...
```
┌─ [0] ⚙️ FUNCTION: VaultBankTest.test_unlockAsset_InvalidProofToken() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
