# Function: test_distributeSuperPosition_InvalidProofTargetedChain()
...
```
┌─ [0] ⚙️ FUNCTION: VaultBankTest.test_distributeSuperPosition_InvalidProofTargetedChain() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
