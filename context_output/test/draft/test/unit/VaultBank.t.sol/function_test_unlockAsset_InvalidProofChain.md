# Function: test_unlockAsset_InvalidProofChain()
...
function test_unlockAsset_InvalidProofChain() public {
    ...
    mockProver.setValidateEventReturn(uint32(DST_CHAIN_ID + 1), address(vaultBank), new bytes(0), new bytes(0));
...
```
┌─ [0] ⚙️ FUNCTION: VaultBankTest.test_unlockAsset_InvalidProofChain() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
