# Function: test_PendleRouterSwapWithExpiredLimitOrderReverts()
...
- **Signature**: `test_PendleRouterSwapWithExpiredLimitOrderReverts()`
- **Visibility**: public
- **Source Range**: 24716:2840:578
...
function test_PendleRouterSwapWithExpiredLimitOrderReverts() public {
    ...
    hookData[1] = _createPendleRouterSwapHookDataWithLimitOrder(pendlePufETHMarket, address(strategy), false, 0, false, amount, CHAIN_1_USDC, vars.syTokenIns[1], block.timestamp - 1);
...
### _createPendleRouterSwapHookDataWithLimitOrder(address,address,bool,uint256,bool,uint256,address,address,uint256)

- **Kind**: internal
- **Source**: 40601:1128:578
- **Link**: `test/integration/SuperVault/SuperVault.Pendle.t.sol:SuperVaultPendleTest:_createPendleRouterSwapHookDataWithLimitOrder(address,address,bool,uint256,bool,uint256,address,address,uint256)`
...
function _createPendleRouterSwapHookDataWithLimitOrder(address market_, address account_, bool usePrevHookAmount_, uint256 value_, bool ptToToken_, uint256 amount_, address tokenIn_, address tokenMint_, uint256 orderExpiry_) internal returns (bytes memory) {
    ...
    if (!ptToToken_) {
        ...
        pendleTxData = _createTokenToPtPendleTxDataWithLimitOrder(market_, account_, tokenIn_, amount_, tokenMint_, odosCalldata, orderExpiry_);
    } else {
...
### _createTokenToPtPendleTxDataWithLimitOrder(address,address,address,uint256,address,bytes,uint256)

- **Kind**: internal
- **Source**: 41800:2267:578
- **Link**: `test/integration/SuperVault/SuperVault.Pendle.t.sol:SuperVaultPendleTest:_createTokenToPtPendleTxDataWithLimitOrder(address,address,address,uint256,address,bytes,uint256)`

```solidity
/// @notice Creates Pendle transaction data with limit order
function _createTokenToPtPendleTxDataWithLimitOrder(address market_, address receiver_, address tokenIn_, uint256 amount_, address tokenMintSY_, bytes memory odosCalldata_, uint256 orderExpiry_) internal view returns (bytes memory pendleTxData) {
    (, , address yt) = _safeReadMarketTokens(market_);
    FillOrderParams[] memory normalFills = new FillOrderParams[](1);
    normalFills[0].order = Order({salt: uint256(keccak256(abi.encodePacked(block.timestamp, receiver_))), expiry: orderExpiry_, nonce: 0, orderType: OrderType.SY_FOR_PT, token: tokenIn_, YT: yt, maker: receiver_, receiver: receiver_, makingAmount: amount_ / 10, lnImpliedRate: 1e18, failSafeRate: 1e18, permit: bytes("")});
    normalFills[0].signature = bytes("mock_signature");
    normalFills[0].makingAmount = amount_ / 10;
    pendleTxData = abi.encodeWithSelector(IPendleRouterV4.swapExactTokenForPt.selector, receiver_, market_, 1, ApproxParams({guessMin: 1, guessMax: 1e24, guessOffchain: 1e18, maxIteration: 30, eps: 10_000_000_000_000}), TokenInput({tokenIn: tokenIn_, netTokenIn: amount_, tokenMintSy: tokenMintSY_, pendleSwap: CHAIN_1_PENDLE_SWAP, swapData: SwapData({extRouter: CHAIN_1_ODOS_ROUTER, extCalldata: odosCalldata_, needScale: false, swapType: SwapType.ODOS})}), LimitOrderData({limitRouter: CHAIN_1_PENDLE_ROUTER, epsSkipMarket: 0, normalFills: normalFills, flashFills: new FillOrderParams[](0), optData: "0x"}));
}
```
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultPendleTest.test_PendleRouterSwapWithExpiredLimitOrderReverts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [vault.balanceOf(accountEth), 0, "No shares minted to user"]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: InternalHelpers._createApproveHookData(address,address,uint256,bool) (NodeID: 196)
  │   💬 Args: [CHAIN_1_USDC, CHAIN_1_PENDLE_ROUTER, amount, false]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SuperVaultPendleTest._createPendleRouterSwapHookDataWithLimitOrder(address,address,bool,uint256,bool,uint256,address,address,uint256) (NodeID: 197)
  │   💬 Args: [pendlePufETHMarket, address(strategy), false, 0, false, amount, CHAIN_1_USDC, vars.syTokenIns[1], block.timestamp - 1]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SuperVaultPendleTest._createOdosSwapCalldataRequest(address,address,uint256,address) (NodeID: 198)
  │ │   💬 Args: [tokenIn_, tokenMint_, amount_, CHAIN_1_PENDLE_ROUTER]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: OdosAPIParser.surlCallQuoteV2(struct OdosAPIParser.QuoteInputToken[],struct OdosAPIParser.QuoteOutputToken[],address,uint256,bool) (NodeID: 199)
  │ │ │   💬 Args: [inputTokens, outputTokens, receiver_, ETH, true]
  │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: OdosAPIParser.buildQuoteV2RequestBody(struct OdosAPIParser.QuoteInputToken[],struct OdosAPIParser.QuoteOutputToken[],address,uint256,bool) (NodeID: 200)
  │ │ │ │   💬 Args: [_inputTokens, _outputTokens, _account, _chainId, _compact]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ ├─ [5] ⚙️ FUNCTION: BaseAPIParser.toChecksumString(address) (NodeID: 201)
  │ │ │ │ │   💬 Args: [_inputTokens[i].tokenAddress]
  │ │ │ │ │   👁️  Def: internal
  │ │ │ │ │ └─ [6] ⚙️ FUNCTION: Strings.toHexString(uint256,uint256) (NodeID: 202)
  ...
  │ │ │ │ │     💬 Args: [value]
  │ │ │ │ │     👁️  Def: internal
  │ │ │ │ ├─ [5] ⚙️ FUNCTION: BaseAPIParser.toChecksumString(address) (NodeID: 205)
  │ │ │ │ │   💬 Args: [_outputTokens[i].tokenAddress]
  │ │ │ │ │   👁️  Def: internal
  │ │ │ │ │ └─ [6] ⚙️ FUNCTION: Strings.toHexString(uint256,uint256) (NodeID: 206)
  │ │ │ │ │     💬 Args: [uint256(uint160(addr)), 20]
  │ │ │ │ │     👁️  Def: internal
  │ │ │ │ ├─ [5] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 207)
  │ │ │ │ │   💬 Args: [_outputTokens[i].proportion]
  │ │ │ │ │   👁️  Def: internal
  │ │ │ │ │ └─ [6] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 208)
  │ │ │ │ │     💬 Args: [value]
  │ │ │ │ │     👁️  Def: internal
  │ │ │ │ ├─ [5] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 209)
  │ │ │ │ │   💬 Args: [_chainId]
  │ │ │ │ │   👁️  Def: internal
  │ │ │ │ │ └─ [6] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 210)
  │ │ │ │ │     💬 Args: [value]
  │ │ │ │ │     👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: BaseAPIParser.toChecksumString(address) (NodeID: 211)
  │ │ │ │     💬 Args: [_account]
  │ │ │ │     👁️  Def: internal
  │ │ │ │   └─ [6] ⚙️ FUNCTION: Strings.toHexString(uint256,uint256) (NodeID: 212)
  │ │ │ │       💬 Args: [uint256(uint160(addr)), 20]
  │ │ │ │       👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: Surl.post(string,string[],string) (NodeID: 213)
  │ │ │ │   💬 Args: [API_QUOTE_URL, headers, body]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: Surl.curl(string,string[],string,string) (NodeID: 214)
  │ │ │ │     💬 Args: [self, headers, body, "POST"]
  │ │ │ │     👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: strings.toSlice(string) (NodeID: 215)
  │ │ │ │   💬 Args: [json]
  │ │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: strings.toSlice(string) (NodeID: 216)
  │ │ │ │   💬 Args: ["\"pathId\":\""]
  │ │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: strings.find(struct strings.slice,struct strings.slice) (NodeID: 217)
  │ │ │ │   💬 Args: [jsonSlice, key]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: strings.findPtr(uint256,uint256,uint256,uint256) (NodeID: 218)
  │ │ │ │     💬 Args: [self._len, self._ptr, needle._len, needle._ptr]
  │ │ │ │     👁️  Def: private
  │ │ │ ├─ [4] ⚙️ FUNCTION: strings.beyond(struct strings.slice,struct strings.slice) (NodeID: 219)
  │ │ │ │   💬 Args: [jsonSlice.find(key), key]
  │ │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: strings.split(struct strings.slice,struct strings.slice) (NodeID: 220)
  │ │ │ │   💬 Args: [afterKey, "\"".toSlice()]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ ├─ [5] ⚙️ FUNCTION: strings.toSlice(string) (NodeID: 223)
  │ │ │ │ │   💬 Args: ["\""]
  │ │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: strings.split(struct strings.slice,struct strings.slice,struct strings.slice) (NodeID: 221)
  │ │ │ │     💬 Args: [self, needle, token]
  │ │ │ │     👁️  Def: internal
  │ │ │ │   └─ [6] ⚙️ FUNCTION: strings.findPtr(uint256,uint256,uint256,uint256) (NodeID: 222)
  │ │ │ │       💬 Args: [self._len, self._ptr, needle._len, needle._ptr]
  │ │ │ │       👁️  Def: private
  │ │ │ └─ [4] ⚙️ FUNCTION: strings.toString(struct strings.slice) (NodeID: 224)
  │ │ │     💬 Args: [pathId]
  │ │ │     👁️  Def: internal
  │ │ │   └─ [5] ⚙️ FUNCTION: strings.memcpy(uint256,uint256,uint256) (NodeID: 225)
  │ │ │       💬 Args: [retptr, self._ptr, self._len]
  │ │ │       👁️  Def: private
  │ │ ├─ [3] ⚙️ FUNCTION: OdosAPIParser.surlCallAssemble(string,address) (NodeID: 226)
  │ │ │   💬 Args: [pathId, receiver_]
  │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: OdosAPIParser.buildAssembleRequestBody(string,address) (NodeID: 227)
  │ │ │ │   💬 Args: [_pathId, _userAddr]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: BaseAPIParser.toChecksumString(address) (NodeID: 228)
  │ │ │ │     💬 Args: [_userAddr]
  │ │ │ │     👁️  Def: internal
  │ │ │ │   └─ [6] ⚙️ FUNCTION: Strings.toHexString(uint256,uint256) (NodeID: 229)
  │ │ │ │       💬 Args: [uint256(uint160(addr)), 20]
  │ │ │ │       👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: Surl.post(string,string[],string) (NodeID: 230)
  │ │ │ │   💬 Args: [API_ASSEMBLE_URL, headers, body]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: Surl.curl(string,string[],string,string) (NodeID: 231)
  │ │ │ │     💬 Args: [self, headers, body, "POST"]
  │ │ │ │     👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: strings.toSlice(string) (NodeID: 232)
  │ │ │ │   💬 Args: [json]
  │ │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: strings.toSlice(string) (NodeID: 233)
  │ │ │ │   💬 Args: ["\"data\":\""]
  │ │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: strings.find(struct strings.slice,struct strings.slice) (NodeID: 234)
  │ │ │ │   💬 Args: [jsonSlice, key]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: strings.findPtr(uint256,uint256,uint256,uint256) (NodeID: 235)
  │ │ │ │     💬 Args: [self._len, self._ptr, needle._len, needle._ptr]
  │ │ │ │     👁️  Def: private
  │ │ │ ├─ [4] ⚙️ FUNCTION: strings.beyond(struct strings.slice,struct strings.slice) (NodeID: 236)
  │ │ │ │   💬 Args: [jsonSlice.find(key), key]
  │ │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: strings.split(struct strings.slice,struct strings.slice) (NodeID: 237)
  │ │ │ │   💬 Args: [afterKey, "\"".toSlice()]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ ├─ [5] ⚙️ FUNCTION: strings.toSlice(string) (NodeID: 240)
  │ │ │ │ │   💬 Args: ["\""]
  │ │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: strings.split(struct strings.slice,struct strings.slice,struct strings.slice) (NodeID: 238)
  │ │ │ │     💬 Args: [self, needle, token]
  │ │ │ │     👁️  Def: internal
  │ │ │ │   └─ [6] ⚙️ FUNCTION: strings.findPtr(uint256,uint256,uint256,uint256) (NodeID: 239)
  │ │ │ │       💬 Args: [self._len, self._ptr, needle._len, needle._ptr]
  │ │ │ │       👁️  Def: private
  │ │ │ └─ [4] ⚙️ FUNCTION: strings.toString(struct strings.slice) (NodeID: 241)
  │ │ │     💬 Args: [swapData]
  │ │ │     👁️  Def: internal
  │ │ │   └─ [5] ⚙️ FUNCTION: strings.memcpy(uint256,uint256,uint256) (NodeID: 242)
  │ │ │       💬 Args: [retptr, self._ptr, self._len]
  │ │ │       👁️  Def: private
  │ │ └─ [3] ⚙️ FUNCTION: BaseAPIParser.fromHex(string) (NodeID: 243)
  │ │     💬 Args: [swapCompactData]
  │ │     👁️  Def: public
  │ │   ├─ [4] ⚙️ FUNCTION: BaseAPIParser._fromHexChar(uint8) (NodeID: 244)
  │ │   │   💬 Args: [uint8(ss[(2 * i) + 3])]
  │ │   │   👁️  Def: private
  │ │   └─ [4] ⚙️ FUNCTION: BaseAPIParser._fromHexChar(uint8) (NodeID: 245)
  │ │       💬 Args: [uint8(ss[(2 * i) + 2])]
  │ │       👁️  Def: private
  │ ├─ [2] ⚙️ FUNCTION: OdosAPIParser.decodeOdosSwapCalldata(bytes) (NodeID: 246)
  │ │   💬 Args: [odosCalldata]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: BytesLib.slice(bytes,uint256,uint256) (NodeID: 247)
  │ │ │   💬 Args: [txData, 0, 4]
  │ │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: BytesLib.slice(bytes,uint256,uint256) (NodeID: 248)
  │ │ │   💬 Args: [txData, 4, txData.length - 4]
  │ │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: OdosAPIParser._decode(bytes) (NodeID: 249)
  │ │     💬 Args: [data]
  │ │     👁️  Def: private
  │ └─ [2] ⚙️ FUNCTION: SuperVaultPendleTest._createTokenToPtPendleTxDataWithLimitOrder(address,address,address,uint256,address,bytes,uint256) (NodeID: 250)
  │     💬 Args: [market_, account_, tokenIn_, amount_, tokenMint_, odosCalldata, orderExpiry_]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: SuperVaultPendleTest._safeReadMarketTokens(address) (NodeID: 251)
  │       💬 Args: [market_]
  │       👁️  Def: internal
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 351)
  │   💬 Args: [asset.balanceOf(address(strategy)), vars.strategyBalance, "USDC balance should be unchanged after revert"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 352)
      💬 Args: [IERC20(vars.pt).balanceOf(address(strategy)), 0, "Strategy should have no PT tokens after failed swap"]
      👁️  Def: internal
```
