...
- **Name**: SuperVaultPendleTest
- **Type**: Contract
- **Path**: test/integration/SuperVault/SuperVault.Pendle.t.sol
- **Documentation**: @notice Separate test file for Pendle integration tests
...
```solidity
uint256 public constant FORK_BLOCK_NUMBER = 20_500_000
```
...
**PendleRouterSwapHook**: [lib/v2-core/src/hooks/swappers/pendle/PendleRouterSwapHook.sol/contract_PendleRouterSwapHook.md]

### approveAndSwapOdosHookAddress
...
- **Details**: [function_test_PendleRouterSwap.md](./function_test_PendleRouterSwap.md)
...
- **Details**: [function_test_PendleRouterSwapAndRedeemX.md](./function_test_PendleRouterSwapAndRedeemX.md)
...
- **Details**: [function_test_PendleRouterSwapAndRedeemBeforeMaturity.md](./function_test_PendleRouterSwapAndRedeemBeforeMaturity.md)
...
- **Details**: [function_test_PendleRouterSwapWithValidLimitOrderValidation.md](./function_test_PendleRouterSwapWithValidLimitOrderValidation.md)
...
- **Details**: [function_test_PendleRouterSwapWithExpiredLimitOrderReverts.md](./function_test_PendleRouterSwapWithExpiredLimitOrderReverts.md)
...
- **Details**: [function_test_PendleRouterSwapWithTightSlippageReverts.md](./function_test_PendleRouterSwapWithTightSlippageReverts.md)
...
### test_PendleRouterSwap_NoVmMock()

- **Signature**: `test_PendleRouterSwap_NoVmMock()`
- **Visibility**: public
- **Source Range**: 31394:4406:578
- **Details**: [function_test_PendleRouterSwap_NoVmMock.md](./function_test_PendleRouterSwap_NoVmMock.md)
