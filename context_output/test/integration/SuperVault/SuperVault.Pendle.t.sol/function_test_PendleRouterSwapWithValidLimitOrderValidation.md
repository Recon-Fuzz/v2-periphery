# Function: test_PendleRouterSwapWithValidLimitOrderValidation()
...
- **Signature**: `test_PendleRouterSwapWithValidLimitOrderValidation()`
- **Visibility**: public
- **Source Range**: 21631:2942:578
...
function test_PendleRouterSwapWithValidLimitOrderValidation() public {
    ...
    hookData[1] = _createPendleRouterSwapHookDataWithLimitOrder(pendlePufETHMarket, address(strategy), false, 0, false, amount, CHAIN_1_USDC, vars.syTokenIns[1], block.timestamp + 1 hours);
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultPendleTest.test_PendleRouterSwapWithValidLimitOrderValidation() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [pendlePufETHMarket, address(strategy), false, 0, false, amount, CHAIN_1_USDC, vars.syTokenIns[1], block.timestamp + 1 hours]
  │   👁️  Def: internal
