# Function: test_PendleRouterSwap_NoVmMock()
...
- **Signature**: `test_PendleRouterSwap_NoVmMock()`
- **Visibility**: public
- **Source Range**: 31394:4406:578
...
function test_PendleRouterSwap_NoVmMock() public {
    ...
    try strategy.executeHooks(ISuperVaultStrategy.ExecuteArgs({hooks: hookAddresses_, hookCalldata: hookData, expectedAssetsOrSharesOut: new uint256[](2), globalProofs: new bytes32[][](2), strategyProofs: new bytes32[][](2)})) {
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultPendleTest.test_PendleRouterSwap_NoVmMock() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: SuperVaultPendleTest._createPendleRouterSwapHookDataWithOdos(address,address,bool,uint256,bool,uint256,address,address) (NodeID: 197)
