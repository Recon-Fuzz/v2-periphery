# Function: test_PendleRouterSwap()
...
- **Signature**: `test_PendleRouterSwap()`
- **Visibility**: public
- **Source Range**: 6947:2995:578
...
function test_PendleRouterSwap() public {
    ...
    hookData[1] = _createPendleRouterSwapHookDataWithOdos(pendlePufETHMarket, address(strategy), false, 0, false, amount, CHAIN_1_USDC, syTokenIns[1]);
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultPendleTest.test_PendleRouterSwap() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [pendlePufETHMarket, address(strategy), false, 0, false, amount, CHAIN_1_USDC, syTokenIns[1]]
  │   👁️  Def: internal
  ...
  │   💬 Args: [syTokenIns[1], CHAIN_1_PENDLE_ROUTER, _scaleTokenAmount(CHAIN_1_USDC, syTokenIns[1], amount)]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SuperVaultPendleTest._scaleTokenAmount(address,address,uint256) (NodeID: 350)
  │ │   💬 Args: [CHAIN_1_USDC, syTokenIns[1], amount]
  │ │   👁️  Def: internal
  ...
  │   💬 Args: [ptBalance, 0, "No PT tokens received"]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGe(uint256,uint256,string) (NodeID: 353)
      💬 Args: [ptBalance, minExpectedPT, "PT amount too low - possible slippage or swap issue"]
      👁️  Def: internal
```
