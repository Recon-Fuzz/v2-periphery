# Function: test_MultipleControllers_ProRataDistribution()
...
function test_MultipleControllers_ProRataDistribution() public pure {
    ...
    uint256 available = 998e6;
    uint256[] memory fulfillRedeemTotalAssetsOut = calculateFulfillRedeemTotalAssetsOut(controllers, theoretical, totalTheoretical, available);
    assertTrue((fulfillRedeemTotalAssetsOut[0] >= 498e6) && (fulfillRedeemTotalAssetsOut[0] <= 500e6), "Controller 0 should get ~50%");
    assertTrue((fulfillRedeemTotalAssetsOut[1] >= 298e6) && (fulfillRedeemTotalAssetsOut[1] <= 300e6), "Controller 1 should get ~30%");
    assertTrue((fulfillRedeemTotalAssetsOut[2] >= 198e6) && (fulfillRedeemTotalAssetsOut[2] <= 200e6), "Controller 2 should get ~20%");
...
```
┌─ [0] ⚙️ FUNCTION: AssetAdjustmentHelperTest.test_MultipleControllers_ProRataDistribution() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: AssetAdjustmentHelper.calculateFulfillRedeemTotalAssetsOut(address[],uint256[],uint256,uint256) (NodeID: 1)
  │   💬 Args: [controllers, theoretical, totalTheoretical, available]
  │   👁️  Def: internal
  ...
  │   💬 Args: [(fulfillRedeemTotalAssetsOut[0] >= 498e6) && (fulfillRedeemTotalAssetsOut[0] <= 500e6), "Controller 0 should get ~50%"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 17)
  │   💬 Args: [(fulfillRedeemTotalAssetsOut[1] >= 298e6) && (fulfillRedeemTotalAssetsOut[1] <= 300e6), "Controller 1 should get ~30%"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 18)
  │   💬 Args: [(fulfillRedeemTotalAssetsOut[2] >= 198e6) && (fulfillRedeemTotalAssetsOut[2] <= 200e6), "Controller 2 should get ~20%"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 19)
      💬 Args: [verifyFulfillRedeemSum(fulfillRedeemTotalAssetsOut, available), "TotalAssetsOut should be valid"]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: AssetAdjustmentHelper.verifyFulfillRedeemSum(uint256[],uint256) (NodeID: 20)
        💬 Args: [fulfillRedeemTotalAssetsOut, available]
        👁️  Def: internal
```
