...
- **Name**: AssetAdjustmentHelperTest
- **Type**: Contract
- **Path**: test/integration/SuperVault/AssetAdjustmentHelper.t.sol
- **Documentation**:  @title AssetAdjustmentHelperTest
...
### test_IntegrationExample_FixingInsufficientLiquidity()

- **Signature**: `test_IntegrationExample_FixingInsufficientLiquidity()`
- **Visibility**: public
- **Source Range**: 13324:2685:575
- **Details**: [function_test_IntegrationExample_FixingInsufficientLiquidity.md](./function_test_IntegrationExample_FixingInsufficientLiquidity.md)
...
### test_RecommendedIntegrationPattern()

- **Signature**: `test_RecommendedIntegrationPattern()`
- **Visibility**: public
- **Source Range**: 16471:2287:575
- **Details**: [function_test_RecommendedIntegrationPattern.md](./function_test_RecommendedIntegrationPattern.md)
...
### test_SingleController_FullLossAttribution()

- **Signature**: `test_SingleController_FullLossAttribution()`
- **Visibility**: public
- **Source Range**: 18941:1135:575
- **Details**: [function_test_SingleController_FullLossAttribution.md](./function_test_SingleController_FullLossAttribution.md)
...
### test_MultipleControllers_ProRataDistribution()

- **Signature**: `test_MultipleControllers_ProRataDistribution()`
- **Visibility**: public
- **Source Range**: 20082:1688:575
- **Details**: [function_test_MultipleControllers_ProRataDistribution.md](./function_test_MultipleControllers_ProRataDistribution.md)
...
### test_ZeroLoss_NoAdjustment()

- **Signature**: `test_ZeroLoss_NoAdjustment()`
- **Visibility**: public
- **Source Range**: 21776:914:575
- **Details**: [function_test_ZeroLoss_NoAdjustment.md](./function_test_ZeroLoss_NoAdjustment.md)
...
### test_EdgeCase_LargeLoss()

- **Signature**: `test_EdgeCase_LargeLoss()`
- **Visibility**: public
- **Source Range**: 22696:1221:575
- **Details**: [function_test_EdgeCase_LargeLoss.md](./function_test_EdgeCase_LargeLoss.md)
