# Function: test_SingleController_FullLossAttribution()
...
function test_SingleController_FullLossAttribution() public pure {
    ...
    theoretical[0] = 1000e6;
    uint256 totalTheoretical = theoretical[0];
    uint256 available = 999_999_998;
    ...
    assertTrue(fulfillRedeemTotalAssetsOut[0] >= (available - 2), "Single controller should get close to their fair share");
...
```
┌─ [0] ⚙️ FUNCTION: AssetAdjustmentHelperTest.test_SingleController_FullLossAttribution() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [fulfillRedeemTotalAssetsOut[0] <= available, "Single controller should not exceed available"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 17)
  │   💬 Args: [fulfillRedeemTotalAssetsOut[0] >= (available - 2), "Single controller should get close to their fair share"]
  │   👁️  Def: internal
