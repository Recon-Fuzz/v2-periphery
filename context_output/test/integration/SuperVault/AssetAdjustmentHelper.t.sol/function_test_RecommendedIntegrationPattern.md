# Function: test_RecommendedIntegrationPattern()
...
function test_RecommendedIntegrationPattern() public {
    ...
    expectedFromHooks[0] = 500e6 - 1;
    expectedFromHooks[1] = 500e6 - 1;
    uint256 totalAvailable = expectedFromHooks[0] + expectedFromHooks[1];
    uint256[] memory theoreticalAmounts = new uint256[](1);
    theoreticalAmounts[0] = 1000e6;
    uint256 totalTheoreticalNetAssets = theoreticalAmounts[0];
    uint256[] memory fulfillRedeemTotalAssetsOut = calculateFulfillRedeemTotalAssetsOut(controllers, theoreticalAmounts, totalTheoreticalNetAssets, totalAvailable);
...
```
┌─ [0] ⚙️ FUNCTION: AssetAdjustmentHelperTest.test_RecommendedIntegrationPattern() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: AssetAdjustmentHelper.calculateFulfillRedeemTotalAssetsOut(address[],uint256[],uint256,uint256) (NodeID: 1)
  │   💬 Args: [controllers, theoreticalAmounts, totalTheoreticalNetAssets, totalAvailable]
  │   👁️  Def: internal
