# Function: test_EdgeCase_LargeLoss()
...
function test_EdgeCase_LargeLoss() public pure {
    ...
    assertTrue((fulfillRedeemTotalAssetsOut[0] >= 349e6) && (fulfillRedeemTotalAssetsOut[0] <= 351e6), "Large loss should be proportional");
    assertTrue((fulfillRedeemTotalAssetsOut[1] >= 149e6) && (fulfillRedeemTotalAssetsOut[1] <= 151e6), "Large loss should be proportional");
...
```
┌─ [0] ⚙️ FUNCTION: AssetAdjustmentHelperTest.test_EdgeCase_LargeLoss() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [(fulfillRedeemTotalAssetsOut[0] >= 349e6) && (fulfillRedeemTotalAssetsOut[0] <= 351e6), "Large loss should be proportional"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 17)
  │   💬 Args: [(fulfillRedeemTotalAssetsOut[1] >= 149e6) && (fulfillRedeemTotalAssetsOut[1] <= 151e6), "Large loss should be proportional"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 18)
      💬 Args: [verifyFulfillRedeemSum(fulfillRedeemTotalAssetsOut, available), "Large loss should be valid"]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: AssetAdjustmentHelper.verifyFulfillRedeemSum(uint256[],uint256) (NodeID: 19)
