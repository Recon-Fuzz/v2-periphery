...
- **Name**: RedemptionSlippageIssueDemo
- **Type**: Contract
- **Path**: test/integration/SuperVault/RedemptionSlippageIssueDemo.t.sol
- **Documentation**:  @title RedemptionSlippageIssueDemo
...
### test_DemonstrateSlippageIssue_WithLoss()

- **Signature**: `test_DemonstrateSlippageIssue_WithLoss()`
- **Visibility**: public
- **Source Range**: 887:5163:577
- **Details**: [function_test_DemonstrateSlippageIssue_WithLoss.md](./function_test_DemonstrateSlippageIssue_WithLoss.md)
...
### test_ShowAsymmetricRiskProfile()

- **Signature**: `test_ShowAsymmetricRiskProfile()`
- **Visibility**: public
- **Source Range**: 6056:2225:577
- **Details**: [function_test_ShowAsymmetricRiskProfile.md](./function_test_ShowAsymmetricRiskProfile.md)
...
### test_ShowWorkaroundLimitations()

- **Signature**: `test_ShowWorkaroundLimitations()`
- **Visibility**: public
- **Source Range**: 8287:2037:577
- **Details**: [function_test_ShowWorkaroundLimitations.md](./function_test_ShowWorkaroundLimitations.md)
