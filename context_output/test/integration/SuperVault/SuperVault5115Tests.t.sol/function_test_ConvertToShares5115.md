# Function: test_ConvertToShares5115()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVault5115Tests.test_ConvertToShares5115() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [shares, assetsAmount, "Initial share conversion should be 1:1"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseSuperVaultTest._deposit(uint256,address,address) (NodeID: 32)
  │   💬 Args: [assetsAmount, address(sv5115), address(asset5115)]
  │   👁️  Def: internal
  ...
  │                     💬 Args: [slot, id]
  │                     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqRel(uint256,uint256,uint256,string) (NodeID: 223)
      💬 Args: [sharesAfter, assetsAmount, 0.01e18, "Share conversion should be close to 1:1"]
      👁️  Def: internal
```
