...
```
┌─ [0] ⚙️ FUNCTION: SuperVault5115Tests.test_FulfillRedeem_FullAmount() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [vaultBalance, address(sv5115)]
  │   👁️  Def: internal
  ...
  │   💬 Args: [vaultBalance, address(sv5115), address(strategy5115SuperVault)]
  │   👁️  Def: internal
