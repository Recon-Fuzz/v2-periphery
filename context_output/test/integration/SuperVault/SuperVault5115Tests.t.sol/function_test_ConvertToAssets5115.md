# Function: test_ConvertToAssets5115()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVault5115Tests.test_ConvertToAssets5115() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [assets, sharesAmount, "Initial asset conversion should be 1:1"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseSuperVaultTest._deposit(uint256) (NodeID: 32)
  │   💬 Args: [2000e6]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: BaseSuperVaultTest.__deposit(struct AccountInstance,uint256) (NodeID: 33)
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqRel(uint256,uint256,uint256,string) (NodeID: 223)
      💬 Args: [assetsAfter, sharesAmount, 0.01e18, "Asset conversion should be close to 1:1"]
      👁️  Def: internal
```
