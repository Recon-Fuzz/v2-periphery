...
```
┌─ [0] ⚙️ FUNCTION: SuperVault5115Tests.test_Deposit5115() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [sharesBefore, 0, "User has shares before deposit"]
  │   👁️  Def: internal
  ...
  │                     💬 Args: [slot, id]
  │                     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 223)
  │   💬 Args: [userShares, 0, "No shares minted to user"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 224)
  │   💬 Args: [asset5115.balanceOf(address(strategy5115SuperVault)), depositAmount, "Wrong strategy balance"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 225)
      💬 Args: [sharesAfter, 0, "No shares minted to user"]
      👁️  Def: internal
```
