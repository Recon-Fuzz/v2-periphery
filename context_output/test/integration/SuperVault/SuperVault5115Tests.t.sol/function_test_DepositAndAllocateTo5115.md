# Function: test_DepositAndAllocateTo5115()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVault5115Tests.test_DepositAndAllocateTo5115() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 242)
  │   💬 Args: [userShares, 0, "No shares minted to user"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 243)
      💬 Args: [pendleEthena.balanceOf(address(strategy5115SuperVault)), 0, "No shares allocated"]
      👁️  Def: internal
```
