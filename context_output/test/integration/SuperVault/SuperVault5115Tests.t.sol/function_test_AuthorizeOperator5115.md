# Function: test_AuthorizeOperator5115()
...
function test_AuthorizeOperator5115() public {
    ...
    bytes32 digest = keccak256(abi.encodePacked("\u0019\u0001", sv5115.DOMAIN_SEPARATOR(), keccak256(abi.encode(sv5115.AUTHORIZE_OPERATOR_TYPEHASH(), userAddress, operator, approved, nonce, deadline))));
...
```
┌─ [0] ⚙️ FUNCTION: SuperVault5115Tests.test_AuthorizeOperator5115() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 40)
  │   💬 Args: [success, "Authorization failed"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 41)
  │   💬 Args: [sv5115.isOperator(userAddress, operator), "Operator not authorized"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 42)
      💬 Args: [sv5115.authorizations(userAddress, nonce), "Nonce not marked as used"]
      👁️  Def: internal
```
