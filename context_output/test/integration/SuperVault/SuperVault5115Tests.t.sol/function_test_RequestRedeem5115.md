# Function: test_RequestRedeem5115()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVault5115Tests.test_RequestRedeem5115() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [strategy5115SuperVault.pendingRedeemRequest(accountEth), redeemShares, "Wrong pending redeem amount"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 436)
      💬 Args: [sv5115.balanceOf(address(escrow5115SuperVault)), redeemShares, "Wrong escrow balance"]
      👁️  Def: internal
```
