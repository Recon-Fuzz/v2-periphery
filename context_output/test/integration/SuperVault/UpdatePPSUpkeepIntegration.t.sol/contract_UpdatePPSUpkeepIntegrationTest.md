...
- **Name**: UpdatePPSUpkeepIntegrationTest
- **Type**: Contract
- **Path**: test/integration/SuperVault/UpdatePPSUpkeepIntegration.t.sol
- **Documentation**: @title UpdatePPSUpkeepIntegrationTest
...
```solidity
uint256 internal constant FORK_BLOCK = 21_679_000
```
...
### test_UpdatePPS_UsesUpTokenForUpkeep()

- **Signature**: `test_UpdatePPS_UsesUpTokenForUpkeep()`
- **Visibility**: public
- **Source Range**: 10577:2989:583
- **Details**: [function_test_UpdatePPS_UsesUpTokenForUpkeep.md](./function_test_UpdatePPS_UsesUpTokenForUpkeep.md)
...
### test_UpkeepCostCalculation()

- **Signature**: `test_UpkeepCostCalculation()`
- **Visibility**: public
- **Source Range**: 13641:605:583
- **Details**: [function_test_UpkeepCostCalculation.md](./function_test_UpkeepCostCalculation.md)
...
### test_InsufficientUpkeep_PausesStrategy()

- **Signature**: `test_InsufficientUpkeep_PausesStrategy()`
- **Visibility**: public
- **Source Range**: 14323:1535:583
- **Details**: [function_test_InsufficientUpkeep_PausesStrategy.md](./function_test_InsufficientUpkeep_PausesStrategy.md)
