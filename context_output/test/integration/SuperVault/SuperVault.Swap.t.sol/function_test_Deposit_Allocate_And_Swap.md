# Function: test_Deposit_Allocate_And_Swap()
...
### _depositAndSwap(uint256,address,address,address,address)

- **Kind**: internal
- **Source**: 26680:4211:579
- **Link**: `test/integration/SuperVault/SuperVault.Swap.t.sol:SuperVaultSwapTest:_depositAndSwap(uint256,address,address,address,address)`
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultSwapTest.test_Deposit_Allocate_And_Swap() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SuperVaultSwapTest._depositAndSwap(uint256,address,address,address,address) (NodeID: 194)
  │   💬 Args: [depositAmount, address(asset), address(strategy), address(fluidVault), address(aaveVault)]
  │   👁️  Def: private
