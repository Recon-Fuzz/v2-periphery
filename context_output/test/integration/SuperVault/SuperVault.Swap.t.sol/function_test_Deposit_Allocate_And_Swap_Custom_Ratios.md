# Function: test_Deposit_Allocate_And_Swap_Custom_Ratios()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultSwapTest.test_Deposit_Allocate_And_Swap_Custom_Ratios() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [1000e6, address(asset), address(strategy), address(fluidVault), address(aaveVault), 3, 1]
  │   👁️  Def: private
  ...
  │   💬 Args: [fluidVault.balanceOf(address(strategy)), aaveVault.balanceOf(address(strategy)), "Fluid vault has more shares than aave vault"]
  │   👁️  Def: internal
