...
- **Name**: SuperVaultSwapTest
- **Type**: Contract
- **Path**: test/integration/SuperVault/SuperVault.Swap.t.sol
...
**MockOdosRouterV2**: [test/mocks/MockOdosRouterV2.sol/contract_MockOdosRouterV2.md]
...
### test_Deposit_Allocate_And_Swap()

- **Signature**: `test_Deposit_Allocate_And_Swap()`
- **Visibility**: public
- **Source Range**: 4995:1013:579
- **Details**: [function_test_Deposit_Allocate_And_Swap.md](./function_test_Deposit_Allocate_And_Swap.md)
...
### test_Deposit_Allocate_And_Swap_Custom_Ratios()

- **Signature**: `test_Deposit_Allocate_And_Swap_Custom_Ratios()`
- **Visibility**: public
- **Source Range**: 6014:1213:579
- **Details**: [function_test_Deposit_Allocate_And_Swap_Custom_Ratios.md](./function_test_Deposit_Allocate_And_Swap_Custom_Ratios.md)
...
### test_Deposit_Allocate_And_Swap_SingleVault()

- **Signature**: `test_Deposit_Allocate_And_Swap_SingleVault()`
- **Visibility**: public
- **Source Range**: 7233:1431:579
- **Details**: [function_test_Deposit_Allocate_And_Swap_SingleVault.md](./function_test_Deposit_Allocate_And_Swap_SingleVault.md)
...
### test_MerklHook_And_Swap()

- **Signature**: `test_MerklHook_And_Swap()`
- **Visibility**: public
- **Source Range**: 8836:3828:579
- **Details**: [function_test_MerklHook_And_Swap.md](./function_test_MerklHook_And_Swap.md)
...
### test_MerklHook_With_Swap()

- **Signature**: `test_MerklHook_With_Swap()`
- **Visibility**: public
- **Source Range**: 12686:6282:579
- **Details**: [function_test_MerklHook_With_Swap.md](./function_test_MerklHook_With_Swap.md)
...
### test_MerklHook_WithPrev_OneVault()

- **Signature**: `test_MerklHook_WithPrev_OneVault()`
- **Visibility**: public
- **Source Range**: 18990:3237:579
- **Details**: [function_test_MerklHook_WithPrev_OneVault.md](./function_test_MerklHook_WithPrev_OneVault.md)
