# Function: test_FulfillRedeemRequests_RevertsOnZeroSharesWithNonZeroAssets()
...
function test_FulfillRedeemRequests_RevertsOnZeroSharesWithNonZeroAssets() public {
    ...
    controllers[0] = (user1 < user2) ? user1 : user2;
    controllers[1] = (user1 < user2) ? user2 : user1;
    uint256[] memory totalAssetsOut = new uint256[](2);
    if (user1 < user2) {
        totalAssetsOut[0] = assetsForUser1[0];
        totalAssetsOut[1] = 100e6;
    } else {
        totalAssetsOut[0] = 100e6;
        totalAssetsOut[1] = assetsForUser1[0];
    }
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_FulfillRedeemRequests_RevertsOnZeroSharesWithNonZeroAssets() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [strategy, address(asset), tempArray]
  │   👁️  Def: internal
  ...
  │           💬 Args: [_sendLogPayloadView]
  │           👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: console.log(string) (NodeID: 221)
      💬 Args: ["fulfillRedeemRequests correctly reverts when zero-share controller is included"]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 222)
        💬 Args: [abi.encodeWithSignature("log(string)", p0)]
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 223)
          💬 Args: [_sendLogPayloadView]
          👁️  Def: internal
```
