# Function: test_DepositDirectlyMintsShares()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_DepositDirectlyMintsShares() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │                     💬 Args: [slot, id]
  │                     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 193)
  │   💬 Args: [sharesAfter, 0, "No shares minted to user"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 194)
