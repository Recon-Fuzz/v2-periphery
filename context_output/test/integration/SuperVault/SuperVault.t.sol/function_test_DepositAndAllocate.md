# Function: test_DepositAndAllocate()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_DepositAndAllocate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 218)
