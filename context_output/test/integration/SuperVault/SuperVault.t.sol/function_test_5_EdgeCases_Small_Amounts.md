# Function: test_5_EdgeCases_Small_Amounts()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_5_EdgeCases_Small_Amounts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseSuperVaultTest._updateRedeemSlippages(uint16) (NodeID: 300)
  │   💬 Args: [500]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseSuperVaultTest._requestRedeemForAllUsers(uint256) (NodeID: 301)
  │   💬 Args: [0]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: BaseSuperVaultTest._requestRedeemForAccount(struct AccountInstance,uint256) (NodeID: 302)
  │     💬 Args: [accInstances[i], redeemShares]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: BaseSuperVaultTest.__requestRedeem(struct AccountInstance,uint256,bool) (NodeID: 303)
  │       💬 Args: [accInst, redeemShares, false]
  │       👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: BaseTest._getHookAddress(uint64,string) (NodeID: 304)
  │     │   💬 Args: [ETH, REQUEST_REDEEM_7540_VAULT_HOOK_KEY]
  │     │   👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: InternalHelpers._createRequestRedeem7540VaultHookData(bytes32,address,uint256,bool) (NodeID: 305)
  │     │   💬 Args: [_getYieldSourceOracleId(bytes32(bytes(ERC7540_YIELD_SOURCE_ORACLE_KEY)), MANAGER), address(vault), redeemShares, false]
  │     │   👁️  Def: internal
  │     │ └─ [5] ⚙️ FUNCTION: InternalHelpers._getYieldSourceOracleId(bytes32,address) (NodeID: 306)
  │     │     💬 Args: [bytes32(bytes(ERC7540_YIELD_SOURCE_ORACLE_KEY)), MANAGER]
  │     │     👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 307)
  ...
  │     │       👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: InternalHelpers._getExecOps(struct AccountInstance,contract ISuperExecutor,bytes) (NodeID: 310)
  │     │   💬 Args: [accInst, superExecutorOnEth, abi.encode(redeemEntry)]
  │     │   👁️  Def: internal
  │     │ └─ [5] ⚙️ FUNCTION: ModuleKitHelpers.getExecOps(struct AccountInstance,address,uint256,bytes,address) (NodeID: 311)
  │     │     💬 Args: [instance, address(superExecutor), 0, abi.encodeCall(superExecutor.execute, (data)), address(instance.defaultValidator)]
  │     │     👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: ModuleKitHelpers.expect4337Revert(struct AccountInstance) (NodeID: 312)
  │     │   💬 Args: [accInst]
  │     │   👁️  Def: internal
  │     │ └─ [5] ⚙️ FUNCTION: Unknown.writeExpectRevert(bytes) (NodeID: 313)
  │     │     💬 Args: [""]
  │     │     👁️  Def: internal
  │     └─ [4] ⚙️ FUNCTION: InternalHelpers.executeOp(struct UserOpData) (NodeID: 314)
  │         💬 Args: [redeemUserOpData]
  │         👁️  Def: public
  │       └─ [5] ⚙️ FUNCTION: ModuleKitHelpers.execUserOps(struct UserOpData) (NodeID: 315)
  │           💬 Args: [userOpData]
  │           👁️  Def: internal
  │         └─ [6] ⚙️ FUNCTION: ERC4337Helpers.exec4337(struct PackedUserOperation,contract IEntryPoint) (NodeID: 316)
  │             💬 Args: [userOpData.userOp, userOpData.entrypoint]
  │             👁️  Def: internal
  │           └─ [7] ⚙️ FUNCTION: ERC4337Helpers.exec4337(struct PackedUserOperation[],contract IEntryPoint) (NodeID: 317)
  │               💬 Args: [userOps, onEntryPoint]
  │               👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Unknown.getExpectRevert() (NodeID: 318)
  │             │   💬 Args: [no args]
  │             │   👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Unknown.getSimulateUserOp() (NodeID: 319)
  │             │   💬 Args: [no args]
  │             │   👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Helpers.envOr(string,bool) (NodeID: 320)
  │             │   💬 Args: ["SIMULATE", false]
  │             │   👁️  Def: public
  │             ├─ [8] ⚙️ FUNCTION: Simulator.simulateUserOp(struct PackedUserOperation,address) (NodeID: 321)
  │             │   💬 Args: [userOps[0], address(onEntryPoint)]
  │             │   👁️  Def: internal
  │             │ ├─ [9] ⚙️ FUNCTION: Simulator._preSimulation() (NodeID: 322)
  │             │ │   💬 Args: [no args]
  │             │ │   👁️  Def: internal
  │             │ │ ├─ [10] ⚙️ FUNCTION: Unknown.snapshotState() (NodeID: 323)
  │             │ │ │   💬 Args: [no args]
  │             │ │ │   👁️  Def: internal
  │             │ │ ├─ [10] ⚙️ FUNCTION: Unknown.startMappingRecording() (NodeID: 324)
  │             │ │ │   💬 Args: [no args]
  │             │ │ │   👁️  Def: internal
  │             │ │ └─ [10] ⚙️ FUNCTION: Unknown.startDebugTraceRecording() (NodeID: 325)
  │             │ │     💬 Args: [no args]
  │             │ │     👁️  Def: internal
  │             │ └─ [9] ⚙️ FUNCTION: Simulator._postSimulation(struct UserOperationDetails) (NodeID: 326)
  │             │     💬 Args: [userOpDetails]
  │             │     👁️  Def: internal
  │             │   ├─ [10] ⚙️ FUNCTION: Unknown.stopAndReturnDebugTraceRecording() (NodeID: 327)
  │             │   │   💬 Args: [no args]
  │             │   │   👁️  Def: internal
  │             │   ├─ [10] ⚙️ FUNCTION: ERC4337SpecsParser.parseValidation(struct UserOperationDetails,struct VmSafe.DebugStep[]) (NodeID: 328)
  │             │   │   💬 Args: [userOpDetails, debugTrace]
  │             │   │   👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.getEntities(struct UserOperationDetails) (NodeID: 329)
  │             │   │ │   💬 Args: [userOpDetails]
  │             │   │ │   👁️  Def: internal
  ...
  │             │   │ │ │   💬 Args: [paymaster, userOpDetails.entryPoint]
  │             │   │ │ │   👁️  Def: internal
  │             │   │ │ └─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isStaked(address,address) (NodeID: 332)
  │             │   │ │     💬 Args: [aggregator, userOpDetails.entryPoint]
  │             │   │ │     👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.filterDebugTrace(struct VmSafe.DebugStep[],struct ERC4337SpecsParser.Entities,address) (NodeID: 333)
  │             │   │ │   💬 Args: [debugTrace, entities, userOpDetails.entryPoint]
  │             │   │ │   👁️  Def: private
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateBannedOpcodes(struct VmSafe.DebugStep[],struct ERC4337SpecsParser.Entities) (NodeID: 334)
  │             │   │ │   💬 Args: [filteredUserOpSteps, entities]
  │             │   │ │   👁️  Def: internal
  │             │   │ │ ├─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isForbiddenOpcode(uint8) (NodeID: 335)
  │             │   │ │ │   💬 Args: [debugTrace[i].opcode]
  │             │   │ │ │   👁️  Def: private
  │             │   │ │ └─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isEntityAndStaked(struct ERC4337SpecsParser.Entities,address) (NodeID: 336)
  │             │   │ │     💬 Args: [entities, debugTrace[i].contractAddr]
  │             │   │ │     👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateBannedOpcodes(struct VmSafe.DebugStep[],struct ERC4337SpecsParser.Entities) (NodeID: 337)
  │             │   │ │   💬 Args: [filteredPaymasterUserOpSteps, entities]
  │             │   │ │   👁️  Def: internal
  │             │   │ │ ├─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isForbiddenOpcode(uint8) (NodeID: 338)
  │             │   │ │ │   💬 Args: [debugTrace[i].opcode]
  │             │   │ │ │   👁️  Def: private
  │             │   │ │ └─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isEntityAndStaked(struct ERC4337SpecsParser.Entities,address) (NodeID: 339)
  │             │   │ │     💬 Args: [entities, debugTrace[i].contractAddr]
  │             │   │ │     👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateOutOfGas(struct VmSafe.DebugStep[]) (NodeID: 340)
  │             │   │ │   💬 Args: [filteredUserOpSteps]
  │             │   │ │   👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateOutOfGas(struct VmSafe.DebugStep[]) (NodeID: 341)
  │             │   │ │   💬 Args: [filteredPaymasterUserOpSteps]
  │             │   │ │   👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateBannedStorageLocations(struct VmSafe.DebugStep[],struct ERC4337SpecsParser.Entities,struct UserOperationDetails) (NodeID: 342)
  │             │   │ │   💬 Args: [filteredUserOpSteps, entities, userOpDetails]
  │             │   │ │   👁️  Def: internal
  │             │   │ │ ├─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isEntity(struct ERC4337SpecsParser.Entities,address) (NodeID: 343)
  │             │   │ │ │   💬 Args: [entities, currentAccessAccount]
  │             │   │ │ │   👁️  Def: internal
  │             │   │ │ ├─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isAssociatedStorage(bytes32,address,address) (NodeID: 344)
  │             │   │ │ │   💬 Args: [currentSlot, currentAccessAccount, entities.account]
  │             │   │ │ │   👁️  Def: internal
  │             │   │ │ │ ├─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.slotMatchesEntity(bytes32,address) (NodeID: 345)
  │             │   │ │ │ │   💬 Args: [currentSlot, entity]
  │             │   │ │ │ │   👁️  Def: internal
  │             │   │ │ │ ├─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.getMappingParent(address,bytes32) (NodeID: 346)
  │             │   │ │ │ │   💬 Args: [currentAccessAccount, currentSlot]
  │             │   │ │ │ │   👁️  Def: internal
  ...
  │             │   │ │ │ │     💬 Args: [currentAccessAccount, bytes32(uint256(currentSlot) - k)]
  │             │   │ │ │ │     👁️  Def: internal
  │             │   │ │ │ └─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.slotMatchesEntity(bytes32,address) (NodeID: 349)
  │             │   │ │ │     💬 Args: [key, entity]
  │             │   │ │ │     👁️  Def: internal
  │             │   │ │ ├─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isAssociatedStorage(bytes32,address,address) (NodeID: 350)
  │             │   │ │ │   💬 Args: [currentSlot, currentAccessAccount, entities.paymaster]
  │             │   │ │ │   👁️  Def: internal
  │             │   │ │ │ ├─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.slotMatchesEntity(bytes32,address) (NodeID: 351)
  │             │   │ │ │ │   💬 Args: [currentSlot, entity]
  │             │   │ │ │ │   👁️  Def: internal
  │             │   │ │ │ ├─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.getMappingParent(address,bytes32) (NodeID: 352)
  │             │   │ │ │ │   💬 Args: [currentAccessAccount, currentSlot]
  │             │   │ │ │ │   👁️  Def: internal
  │             │   │ │ │ │ ├─ [14] ⚙️ FUNCTION: Unknown.getMappingKeyAndParentOf(address,bytes32) (NodeID: 353)
  │             │   │ │ │ │ │   💬 Args: [currentAccessAccount, currentSlot]
  │             │   │ │ │ │ │   👁️  Def: internal
  │             │   │ │ │ │ └─ [14] ⚙️ FUNCTION: Unknown.getMappingKeyAndParentOf(address,bytes32) (NodeID: 354)
  │             │   │ │ │ │     💬 Args: [currentAccessAccount, bytes32(uint256(currentSlot) - k)]
  │             │   │ │ │ │     👁️  Def: internal
  │             │   │ │ │ └─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.slotMatchesEntity(bytes32,address) (NodeID: 355)
  │             │   │ │ │     💬 Args: [key, entity]
  │             │   │ │ │     👁️  Def: internal
  │             │   │ │ ├─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isAssociatedStorage(bytes32,address,address) (NodeID: 356)
  │             │   │ │ │   💬 Args: [currentSlot, currentAccessAccount, entities.factory]
  │             │   │ │ │   👁️  Def: internal
  │             │   │ │ │ ├─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.slotMatchesEntity(bytes32,address) (NodeID: 357)
  │             │   │ │ │ │   💬 Args: [currentSlot, entity]
  │             │   │ │ │ │   👁️  Def: internal
  │             │   │ │ │ ├─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.getMappingParent(address,bytes32) (NodeID: 358)
  │             │   │ │ │ │   💬 Args: [currentAccessAccount, currentSlot]
  │             │   │ │ │ │   👁️  Def: internal
  │             │   │ │ │ │ ├─ [14] ⚙️ FUNCTION: Unknown.getMappingKeyAndParentOf(address,bytes32) (NodeID: 359)
  │             │   │ │ │ │ │   💬 Args: [currentAccessAccount, currentSlot]
  │             │   │ │ │ │ │   👁️  Def: internal
  │             │   │ │ │ │ └─ [14] ⚙️ FUNCTION: Unknown.getMappingKeyAndParentOf(address,bytes32) (NodeID: 360)
  │             │   │ │ │ │     💬 Args: [currentAccessAccount, bytes32(uint256(currentSlot) - k)]
  │             │   │ │ │ │     👁️  Def: internal
  │             │   │ │ │ └─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.slotMatchesEntity(bytes32,address) (NodeID: 361)
  │             │   │ │ │     💬 Args: [key, entity]
  │             │   │ │ │     👁️  Def: internal
  │             │   │ │ └─ [12] ⚙️ FUNCTION: Unknown.getLabel(address) (NodeID: 362)
  │             │   │ │     💬 Args: [currentAccessAccount]
  │             │   │ │     👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateBannedStorageLocations(struct VmSafe.DebugStep[],struct ERC4337SpecsParser.Entities,struct UserOperationDetails) (NodeID: 363)
  │             │   │ │   💬 Args: [filteredPaymasterUserOpSteps, entities, userOpDetails]
  │             │   │ │   👁️  Def: internal
  │             │   │ │ ├─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isEntity(struct ERC4337SpecsParser.Entities,address) (NodeID: 364)
  │             │   │ │ │   💬 Args: [entities, currentAccessAccount]
  │             │   │ │ │   👁️  Def: internal
  ...
  │             │   │ │ │     💬 Args: [key, entity]
  │             │   │ │ │     👁️  Def: internal
  │             │   │ │ ├─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isAssociatedStorage(bytes32,address,address) (NodeID: 371)
  │             │   │ │ │   💬 Args: [currentSlot, currentAccessAccount, entities.paymaster]
  │             │   │ │ │   👁️  Def: internal
  │             │   │ │ │ ├─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.slotMatchesEntity(bytes32,address) (NodeID: 372)
  │             │   │ │ │ │   💬 Args: [currentSlot, entity]
  │             │   │ │ │ │   👁️  Def: internal
  │             │   │ │ │ ├─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.getMappingParent(address,bytes32) (NodeID: 373)
  │             │   │ │ │ │   💬 Args: [currentAccessAccount, currentSlot]
  │             │   │ │ │ │   👁️  Def: internal
  │             │   │ │ │ │ ├─ [14] ⚙️ FUNCTION: Unknown.getMappingKeyAndParentOf(address,bytes32) (NodeID: 374)
  │             │   │ │ │ │ │   💬 Args: [currentAccessAccount, currentSlot]
  │             │   │ │ │ │ │   👁️  Def: internal
  │             │   │ │ │ │ └─ [14] ⚙️ FUNCTION: Unknown.getMappingKeyAndParentOf(address,bytes32) (NodeID: 375)
  │             │   │ │ │ │     💬 Args: [currentAccessAccount, bytes32(uint256(currentSlot) - k)]
  │             │   │ │ │ │     👁️  Def: internal
  │             │   │ │ │ └─ [13] ⚙️ FUNCTION: ERC4337SpecsParser.slotMatchesEntity(bytes32,address) (NodeID: 376)
  │             │   │ │ │     💬 Args: [key, entity]
  │             │   │ │ │     👁️  Def: internal
  ...
  │             │   │ │ │     💬 Args: [key, entity]
  │             │   │ │ │     👁️  Def: internal
  │             │   │ │ └─ [12] ⚙️ FUNCTION: Unknown.getLabel(address) (NodeID: 383)
  │             │   │ │     💬 Args: [currentAccessAccount]
  │             │   │ │     👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateCalls(struct VmSafe.DebugStep[],struct ERC4337SpecsParser.Entities,address) (NodeID: 384)
  │             │   │ │   💬 Args: [filteredUserOpSteps, entities, userOpDetails.entryPoint]
  │             │   │ │   👁️  Def: internal
  │             │   │ │ └─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isPrecompile(address) (NodeID: 385)
  │             │   │ │     💬 Args: [targetAddr]
  │             │   │ │     👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateCalls(struct VmSafe.DebugStep[],struct ERC4337SpecsParser.Entities,address) (NodeID: 386)
  │             │   │ │   💬 Args: [filteredPaymasterUserOpSteps, entities, userOpDetails.entryPoint]
  │             │   │ │   👁️  Def: internal
  │             │   │ │ └─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isPrecompile(address) (NodeID: 387)
  │             │   │ │     💬 Args: [targetAddr]
  │             │   │ │     👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateExtOpcodes(struct VmSafe.DebugStep[],struct ERC4337SpecsParser.Entities) (NodeID: 388)
  │             │   │ │   💬 Args: [filteredUserOpSteps, entities]
  │             │   │ │   👁️  Def: internal
  │             │   │ │ └─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isPrecompile(address) (NodeID: 389)
  │             │   │ │     💬 Args: [targetAddr]
  │             │   │ │     👁️  Def: internal
  │             │   │ ├─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateExtOpcodes(struct VmSafe.DebugStep[],struct ERC4337SpecsParser.Entities) (NodeID: 390)
  │             │   │ │   💬 Args: [filteredPaymasterUserOpSteps, entities]
  │             │   │ │   👁️  Def: internal
  │             │   │ │ └─ [12] ⚙️ FUNCTION: ERC4337SpecsParser.isPrecompile(address) (NodeID: 391)
  │             │   │ │     💬 Args: [targetAddr]
  │             │   │ │     👁️  Def: internal
  ...
  │             │   │ │   💬 Args: [filteredUserOpSteps, entities, userOpDetails]
  │             │   │ │   👁️  Def: internal
  │             │   │ └─ [11] ⚙️ FUNCTION: ERC4337SpecsParser.validateCreate(struct VmSafe.DebugStep[],struct ERC4337SpecsParser.Entities,struct UserOperationDetails) (NodeID: 393)
  │             │   │     💬 Args: [filteredPaymasterUserOpSteps, entities, userOpDetails]
  │             │   │     👁️  Def: internal
  │             │   ├─ [10] ⚙️ FUNCTION: Unknown.stopMappingRecording() (NodeID: 394)
  │             │   │   💬 Args: [no args]
  │             │   │   👁️  Def: internal
  │             │   └─ [10] ⚙️ FUNCTION: Unknown.revertToState(uint256) (NodeID: 395)
  │             │       💬 Args: [snapShotId]
  │             │       👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Unknown.recordLogs() (NodeID: 396)
  │             │   💬 Args: [no args]
  │             │   👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: ERC4337Helpers.checkRevertMessage(bytes) (NodeID: 397)
  │             │   💬 Args: [ctx.returnData]
  │             │   👁️  Def: internal
  │             │ ├─ [9] ⚙️ FUNCTION: Unknown.getExpectRevertMessage() (NodeID: 398)
  │             │ │   💬 Args: [no args]
  │             │ │   👁️  Def: internal
  │             │ └─ [9] ⚙️ FUNCTION: ERC4337Helpers.parseFailedOpWithRevert(bytes,bytes) (NodeID: 399)
  │             │     💬 Args: [actualReason, revertMessage]
  │             │     👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Unknown.getRecordedLogs() (NodeID: 400)
  │             │   💬 Args: [no args]
  │             │   👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: ERC4337Helpers.getUserOpRevertReason(struct VmSafe.Log[],bytes32) (NodeID: 401)
  │             │   💬 Args: [logs, userOpHash]
  │             │   👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Unknown.getLabel(address) (NodeID: 402)
  │             │   💬 Args: [account]
  │             │   👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: ERC4337Helpers.checkRevertMessage(bytes) (NodeID: 403)
  │             │   💬 Args: [getUserOpRevertReason(logs, userOpHash)]
  │             │   👁️  Def: internal
  │             │ ├─ [9] ⚙️ FUNCTION: ERC4337Helpers.getUserOpRevertReason(struct VmSafe.Log[],bytes32) (NodeID: 406)
  │             │ │   💬 Args: [logs, userOpHash]
  │             │ │   👁️  Def: internal
  │             │ ├─ [9] ⚙️ FUNCTION: Unknown.getExpectRevertMessage() (NodeID: 404)
  │             │ │   💬 Args: [no args]
  │             │ │   👁️  Def: internal
  │             │ └─ [9] ⚙️ FUNCTION: ERC4337Helpers.parseFailedOpWithRevert(bytes,bytes) (NodeID: 405)
  │             │     💬 Args: [actualReason, revertMessage]
  │             │     👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Unknown.clearExpectRevert() (NodeID: 407)
  │             │   💬 Args: [no args]
  │             │   👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Unknown.writeInstalledModule(struct InstalledModule,address) (NodeID: 408)
  │             │   💬 Args: [InstalledModule(moduleType, module), logs[i].emitter]
  │             │   👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Unknown.getInstalledModules(address) (NodeID: 409)
  │             │   💬 Args: [logs[i].emitter]
  │             │   👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Unknown.removeInstalledModule(uint256,address) (NodeID: 410)
  │             │   💬 Args: [j, logs[i].emitter]
  │             │   👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Unknown.getGasIdentifier() (NodeID: 411)
  │             │   💬 Args: [no args]
  │             │   👁️  Def: internal
  │             │ └─ [9] ⚙️ FUNCTION: Unknown.readString(bytes32) (NodeID: 412)
  │             │     💬 Args: [slot]
  │             │     👁️  Def: internal
  │             ├─ [8] ⚙️ FUNCTION: Helpers.envOr(string,bool) (NodeID: 413)
  │             │   💬 Args: ["GAS", false]
  │             │   👁️  Def: public
  │             └─ [8] ⚙️ FUNCTION: ERC4337Helpers.calculateGas(struct PackedUserOperation[],contract IEntryPoint,address,string,uint256) (NodeID: 414)
  │                 💬 Args: [userOps, onEntryPoint, ctx.beneficiary, gasIdentifier, totalUserOpGas]
  │                 👁️  Def: internal
  │               └─ [9] ⚙️ FUNCTION: GasParser.parseAndWriteGas(bytes,address,string,address,uint256) (NodeID: 415)
  │                   💬 Args: [userOpCalldata, address(onEntryPoint), gasIdentifier, userOps[0].sender, totalUserOpGas]
  │                   👁️  Def: internal
  │                 ├─ [10] ⚙️ FUNCTION: Unknown.getArbitrumL1Gas(bytes) (NodeID: 416)
  │                 │   💬 Args: [userOpCalldata]
  │                 │   👁️  Def: internal
  │                 │ ├─ [11] ⚙️ FUNCTION: LibZip.flzCompress(bytes) (NodeID: 417)
  │                 │ │   💬 Args: [data]
  │                 │ │   👁️  Def: internal
  │                 │ └─ [11] ⚙️ FUNCTION: Unknown.getCallDataGas(bytes) (NodeID: 418)
  │                 │     💬 Args: [compressed]
  │                 │     👁️  Def: internal
  │                 ├─ [10] ⚙️ FUNCTION: Unknown.getOpStackL1Gas(bytes) (NodeID: 419)
  │                 │   💬 Args: [userOpCalldata]
  │                 │   👁️  Def: internal
  │                 │ ├─ [11] ⚙️ FUNCTION: Unknown.ud(uint256) (NodeID: 420)
  │                 │ │   💬 Args: [0.684e18]
  │                 │ │   👁️  Def: internal
  │                 │ └─ [11] ⚙️ FUNCTION: Unknown.intoUint256(UD60x18) (NodeID: 421)
  │                 │     💬 Args: [PRBMathCastingUint256.intoUD60x18(getCallDataGas(data)).mul(opStackScalar)]
  │                 │     👁️  Def: internal
  │                 │   ├─ [12] ⚙️ FUNCTION: PRBMathCastingUint256.intoUD60x18(uint256) (NodeID: 422)
  │                 │   │   💬 Args: [getCallDataGas(data)]
  │                 │   │   👁️  Def: internal
  │                 │   │ └─ [13] ⚙️ FUNCTION: Unknown.getCallDataGas(bytes) (NodeID: 423)
  │                 │   │     💬 Args: [data]
  │                 │   │     👁️  Def: internal
  │                 │   └─ [12] ⚙️ FUNCTION: Unknown.mul(UD60x18,UD60x18) (NodeID: 424)
  │                 │       💬 Args: [PRBMathCastingUint256.intoUD60x18(getCallDataGas(data)), opStackScalar]
  │                 │       👁️  Def: internal
  │                 │     └─ [13] ⚙️ FUNCTION: Unknown.wrap(uint256) (NodeID: 425)
  │                 │         💬 Args: [Common.mulDiv18(x.unwrap(), y.unwrap())]
  │                 │         👁️  Def: internal
  │                 │       └─ [14] ⚙️ FUNCTION: Unknown.mulDiv18(uint256,uint256) (NodeID: 426)
  │                 │           💬 Args: [Common, x.unwrap(), y.unwrap()]
  │                 │           👁️  Def: internal
  │                 │         ├─ [15] ⚙️ FUNCTION: Unknown.unwrap(UD60x18) (NodeID: 427)
  │                 │         │   💬 Args: [x]
  │                 │         │   👁️  Def: internal
  │                 │         └─ [15] ⚙️ FUNCTION: Unknown.unwrap(UD60x18) (NodeID: 428)
  │                 │             💬 Args: [y]
  │                 │             👁️  Def: internal
  │                 ├─ [10] ⚙️ FUNCTION: Unknown.exists(string) (NodeID: 429)
  │                 │   💬 Args: [fileName]
  │                 │   👁️  Def: internal
  │                 ├─ [10] ⚙️ FUNCTION: Unknown.readFile(string) (NodeID: 430)
  │                 │   💬 Args: [fileName]
  │                 │   👁️  Def: internal
  │                 ├─ [10] ⚙️ FUNCTION: Unknown.parsePrevGasReport(string) (NodeID: 431)
  │                 │   💬 Args: [fileContent]
  │                 │   👁️  Def: internal
  │                 │ ├─ [11] ⚙️ FUNCTION: Unknown.parseUintFromASCII(bytes) (NodeID: 432)
  │                 │ │   💬 Args: [parseJson(fileContent, ".Total")]
  │                 │ │   👁️  Def: internal
  │                 │ │ └─ [12] ⚙️ FUNCTION: Unknown.parseJson(string,string) (NodeID: 433)
  │                 │ │     💬 Args: [fileContent, ".Total"]
  │                 │ │     👁️  Def: internal
  │                 │ ├─ [11] ⚙️ FUNCTION: Unknown.parseUintFromASCII(bytes) (NodeID: 434)
  │                 │ │   💬 Args: [parseJson(fileContent, ".Phases.Creation")]
  │                 │ │   👁️  Def: internal
  │                 │ │ └─ [12] ⚙️ FUNCTION: Unknown.parseJson(string,string) (NodeID: 435)
  │                 │ │     💬 Args: [fileContent, ".Phases.Creation"]
  │                 │ │     👁️  Def: internal
  │                 │ ├─ [11] ⚙️ FUNCTION: Unknown.parseUintFromASCII(bytes) (NodeID: 436)
  │                 │ │   💬 Args: [parseJson(fileContent, ".Phases.Validation")]
  │                 │ │   👁️  Def: internal
  │                 │ │ └─ [12] ⚙️ FUNCTION: Unknown.parseJson(string,string) (NodeID: 437)
  │                 │ │     💬 Args: [fileContent, ".Phases.Validation"]
  │                 │ │     👁️  Def: internal
  │                 │ ├─ [11] ⚙️ FUNCTION: Unknown.parseUintFromASCII(bytes) (NodeID: 438)
  │                 │ │   💬 Args: [parseJson(fileContent, ".Phases.Execution")]
  │                 │ │   👁️  Def: internal
  │                 │ │ └─ [12] ⚙️ FUNCTION: Unknown.parseJson(string,string) (NodeID: 439)
  │                 │ │     💬 Args: [fileContent, ".Phases.Execution"]
  │                 │ │     👁️  Def: internal
  │                 │ ├─ [11] ⚙️ FUNCTION: Unknown.parseUintFromASCII(bytes) (NodeID: 440)
  │                 │ │   💬 Args: [parseJson(fileContent, ".Calldata.Arbitrum")]
  │                 │ │   👁️  Def: internal
  │                 │ │ └─ [12] ⚙️ FUNCTION: Unknown.parseJson(string,string) (NodeID: 441)
  │                 │ │     💬 Args: [fileContent, ".Calldata.Arbitrum"]
  │                 │ │     👁️  Def: internal
  │                 │ └─ [11] ⚙️ FUNCTION: Unknown.parseUintFromASCII(bytes) (NodeID: 442)
  │                 │     💬 Args: [parseJson(fileContent, ".Calldata.OP-Stack")]
  │                 │     👁️  Def: internal
  │                 │   └─ [12] ⚙️ FUNCTION: Unknown.parseJson(string,string) (NodeID: 443)
  │                 │       💬 Args: [fileContent, ".Calldata.OP-Stack"]
  │                 │       👁️  Def: internal
  │                 ├─ [10] ⚙️ FUNCTION: GasParser.formatGasToWrite(string,struct GasCalculations,struct GasCalculations) (NodeID: 444)
  │                 │   💬 Args: [gasIdentifier, prevGasCalculations, gasCalculations]
  │                 │   👁️  Def: internal
  ...
  │                 │ │   💬 Args: [phasesObj, "Validation", formatGasValue({prevValue: prevGasCalculations.validation, newValue: gasCalculations.validation})]
  │                 │ │   👁️  Def: internal
  │                 │ │ └─ [12] ⚙️ FUNCTION: Unknown.formatGasValue(uint256,uint256) (NodeID: 462)
  │                 │ │     💬 Args: [prevGasCalculations.validation, gasCalculations.validation]
  │                 │ │     👁️  Def: internal
  │                 │ │   ├─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 463)
  │                 │ │   │   💬 Args: [int256(newValue)]
  │                 │ │   │   👁️  Def: internal
  │                 │ │   │ └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 464)
  │                 │ │   │     💬 Args: [value]
  │                 │ │   │     👁️  Def: internal
  │                 │ │   ├─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 465)
  │                 │ │   │   💬 Args: [int256(newValue)]
  │                 │ │   │   👁️  Def: internal
  │                 │ │   │ └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 466)
  │                 │ │   │     💬 Args: [value]
  │                 │ │   │     👁️  Def: internal
  │                 │ │   └─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 467)
  │                 │ │       💬 Args: [int256(newValue) - int256(prevValue)]
  │                 │ │       👁️  Def: internal
  │                 │ │     └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 468)
  │                 │ │         💬 Args: [value]
  │                 │ │         👁️  Def: internal
  │                 │ ├─ [11] ⚙️ FUNCTION: Unknown.serializeString(string,string,string) (NodeID: 469)
  │                 │ │   💬 Args: [phasesObj, "Execution", formatGasValue({prevValue: prevGasCalculations.execution, newValue: gasCalculations.execution})]
  │                 │ │   👁️  Def: internal
  │                 │ │ └─ [12] ⚙️ FUNCTION: Unknown.formatGasValue(uint256,uint256) (NodeID: 470)
  │                 │ │     💬 Args: [prevGasCalculations.execution, gasCalculations.execution]
  │                 │ │     👁️  Def: internal
  │                 │ │   ├─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 471)
  │                 │ │   │   💬 Args: [int256(newValue)]
  │                 │ │   │   👁️  Def: internal
  │                 │ │   │ └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 472)
  │                 │ │   │     💬 Args: [value]
  │                 │ │   │     👁️  Def: internal
  │                 │ │   ├─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 473)
  │                 │ │   │   💬 Args: [int256(newValue)]
  │                 │ │   │   👁️  Def: internal
  │                 │ │   │ └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 474)
  │                 │ │   │     💬 Args: [value]
  │                 │ │   │     👁️  Def: internal
  │                 │ │   └─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 475)
  │                 │ │       💬 Args: [int256(newValue) - int256(prevValue)]
  │                 │ │       👁️  Def: internal
  │                 │ │     └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 476)
  │                 │ │         💬 Args: [value]
  │                 │ │         👁️  Def: internal
  │                 │ ├─ [11] ⚙️ FUNCTION: Unknown.serializeString(string,string,string) (NodeID: 477)
  │                 │ │   💬 Args: [l2sObj, "OP-Stack", formatGasValue({prevValue: prevGasCalculations.opStack, newValue: gasCalculations.opStack})]
  │                 │ │   👁️  Def: internal
  │                 │ │ └─ [12] ⚙️ FUNCTION: Unknown.formatGasValue(uint256,uint256) (NodeID: 478)
  │                 │ │     💬 Args: [prevGasCalculations.opStack, gasCalculations.opStack]
  │                 │ │     👁️  Def: internal
  │                 │ │   ├─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 479)
  │                 │ │   │   💬 Args: [int256(newValue)]
  │                 │ │   │   👁️  Def: internal
  │                 │ │   │ └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 480)
  │                 │ │   │     💬 Args: [value]
  │                 │ │   │     👁️  Def: internal
  │                 │ │   ├─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 481)
  │                 │ │   │   💬 Args: [int256(newValue)]
  │                 │ │   │   👁️  Def: internal
  │                 │ │   │ └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 482)
  │                 │ │   │     💬 Args: [value]
  │                 │ │   │     👁️  Def: internal
  │                 │ │   └─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 483)
  │                 │ │       💬 Args: [int256(newValue) - int256(prevValue)]
  │                 │ │       👁️  Def: internal
  │                 │ │     └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 484)
  │                 │ │         💬 Args: [value]
  │                 │ │         👁️  Def: internal
  │                 │ ├─ [11] ⚙️ FUNCTION: Unknown.serializeString(string,string,string) (NodeID: 485)
  │                 │ │   💬 Args: [l2sObj, "Arbitrum", formatGasValue({prevValue: prevGasCalculations.arbitrum, newValue: gasCalculations.arbitrum})]
  │                 │ │   👁️  Def: internal
  │                 │ │ └─ [12] ⚙️ FUNCTION: Unknown.formatGasValue(uint256,uint256) (NodeID: 486)
  │                 │ │     💬 Args: [prevGasCalculations.arbitrum, gasCalculations.arbitrum]
  │                 │ │     👁️  Def: internal
  │                 │ │   ├─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 487)
  │                 │ │   │   💬 Args: [int256(newValue)]
  │                 │ │   │   👁️  Def: internal
  │                 │ │   │ └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 488)
  │                 │ │   │     💬 Args: [value]
  │                 │ │   │     👁️  Def: internal
  │                 │ │   ├─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 489)
  │                 │ │   │   💬 Args: [int256(newValue)]
  │                 │ │   │   👁️  Def: internal
  │                 │ │   │ └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 490)
  │                 │ │   │     💬 Args: [value]
  │                 │ │   │     👁️  Def: internal
  │                 │ │   └─ [13] ⚙️ FUNCTION: Unknown.formatGas(int256) (NodeID: 491)
  │                 │ │       💬 Args: [int256(newValue) - int256(prevValue)]
  │                 │ │       👁️  Def: internal
  │                 │ │     └─ [14] ⚙️ FUNCTION: Unknown.toString(int256) (NodeID: 492)
  │                 │ │         💬 Args: [value]
  │                 │ │         👁️  Def: internal
  ...
  │                 │     💬 Args: [jsonObj, "Calldata", l2sOutput]
  │                 │     👁️  Def: internal
  │                 ├─ [10] ⚙️ FUNCTION: Unknown.writeJson(string,string) (NodeID: 495)
  │                 │   💬 Args: [finalJson, fileName]
  │                 │   👁️  Def: internal
  │                 └─ [10] ⚙️ FUNCTION: Unknown.writeGasIdentifier(string) (NodeID: 496)
  │                     💬 Args: [""]
  │                     👁️  Def: internal
  │                   └─ [11] ⚙️ FUNCTION: Unknown.writeString(bytes32,string) (NodeID: 497)
  │                       💬 Args: [slot, id]
  │                       👁️  Def: internal
