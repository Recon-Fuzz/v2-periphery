# Function: test_DustBugInClaimRedeem()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_DustBugInClaimRedeem() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: ["Claimable amount:", claimableAmount]
  │   👁️  Def: internal
  ...
  │   💬 Args: ["Escrow balance before reduction:", escrowBalanceBefore]
  │   👁️  Def: internal
  ...
  │   💬 Args: ["Difference:", claimableAmount - escrowBalanceAfter]
  │   👁️  Def: internal
  ...
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 529)
  │   💬 Args: [claimableAmount > escrowBalanceAfter, "Claimable should be greater than available"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 530)
      💬 Args: [(claimableAmount - escrowBalanceAfter) <= 10, "Difference should be within tolerance"]
      👁️  Def: internal
```
