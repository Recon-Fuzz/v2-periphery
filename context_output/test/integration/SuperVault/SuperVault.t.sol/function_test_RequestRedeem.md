...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_RequestRedeem() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 218)
  │   💬 Args: [vault.balanceOf(address(escrow)), redeemShares, "Wrong escrow balance"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 219)
      💬 Args: [reqId, 0, "Request ID should be 0"]
      👁️  Def: internal
```
