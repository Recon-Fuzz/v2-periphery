# Function: test_FulfillRedemptionWithPendingCancellation()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_FulfillRedemptionWithPendingCancellation() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 616)
      💬 Args: [hasPendingCancelAfter, "Pending cancel should be cleared after fulfillment"]
      👁️  Def: internal
```
