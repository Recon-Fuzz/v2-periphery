# Function: test_Fix1_TransferDoesNotAffectRequestClaimState()
...
function test_Fix1_TransferDoesNotAffectRequestClaimState() public {
    ...
    assertEq(strategy.pendingRedeemRequest(accInstances[0].account), pendingBefore, "pendingRedeemRequest should not change");
    assertEq(strategy.claimableWithdraw(accInstances[0].account), maxWithdrawBefore, "maxWithdraw should not change");
    assertEq(strategy.getSuperVaultState(accInstances[0].account).averageRequestPPS, avgRequestPPSBefore, "averageRequestPPS should not change");
    assertEq(strategy.getAverageWithdrawPrice(accInstances[0].account), avgWithdrawPriceBefore, "averageWithdrawPrice should not change");
    assertEq(strategy.pendingRedeemRequest(accInstances[1].account), 0, "Receiver should have no pendingRedeemRequest");
    assertEq(strategy.claimableWithdraw(accInstances[1].account), 0, "Receiver should have no claimable");
    assertEq(strategy.getSuperVaultState(accInstances[1].account).averageRequestPPS, 0, "Receiver should have no averageRequestPPS");
    assertEq(strategy.getAverageWithdrawPrice(accInstances[1].account), 0, "Receiver should have no averageWithdrawPrice");
}
```
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Fix1_TransferDoesNotAffectRequestClaimState() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │             💬 Args: [_sendLogPayloadView]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 612)
  │   💬 Args: [strategy.pendingRedeemRequest(accInstances[0].account), pendingBefore, "pendingRedeemRequest should not change"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 613)
  │   💬 Args: [strategy.claimableWithdraw(accInstances[0].account), maxWithdrawBefore, "maxWithdraw should not change"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 614)
  │   💬 Args: [strategy.getSuperVaultState(accInstances[0].account).averageRequestPPS, avgRequestPPSBefore, "averageRequestPPS should not change"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 615)
  │   💬 Args: [strategy.getAverageWithdrawPrice(accInstances[0].account), avgWithdrawPriceBefore, "averageWithdrawPrice should not change"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 616)
  │   💬 Args: [strategy.pendingRedeemRequest(accInstances[1].account), 0, "Receiver should have no pendingRedeemRequest"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 617)
  │   💬 Args: [strategy.claimableWithdraw(accInstances[1].account), 0, "Receiver should have no claimable"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 618)
  │   💬 Args: [strategy.getSuperVaultState(accInstances[1].account).averageRequestPPS, 0, "Receiver should have no averageRequestPPS"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 619)
      💬 Args: [strategy.getAverageWithdrawPrice(accInstances[1].account), 0, "Receiver should have no averageWithdrawPrice"]
      👁️  Def: internal
```
