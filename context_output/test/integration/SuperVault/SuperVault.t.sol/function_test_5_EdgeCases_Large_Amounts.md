# Function: test_5_EdgeCases_Large_Amounts()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_5_EdgeCases_Large_Amounts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │             💬 Args: [_sendLogPayloadView]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 598)
  │   💬 Args: [strategy.pendingRedeemRequest(accInstances[i].account), 0]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 599)
