# Function: test_SkimFeeFlow_PPSUpdateEventEmitted()
...
function test_SkimFeeFlow_PPSUpdateEventEmitted() public {
    ...
    emit PPSUpdatedAfterSkim(address(strategy), 0, 0, 0, 0);
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_SkimFeeFlow_PPSUpdateEventEmitted() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         💬 Args: [_sendLogPayloadView]
  │         👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: console.log(string) (NodeID: 573)
      💬 Args: ["Event emission test passed"]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 574)
        💬 Args: [abi.encodeWithSignature("log(string)", p0)]
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 575)
          💬 Args: [_sendLogPayloadView]
          👁️  Def: internal
```
