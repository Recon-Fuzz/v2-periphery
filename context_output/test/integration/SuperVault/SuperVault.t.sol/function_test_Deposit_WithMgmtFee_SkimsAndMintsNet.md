# Function: test_Deposit_WithMgmtFee_SkimsAndMintsNet()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Deposit_WithMgmtFee_SkimsAndMintsNet() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseSuperVaultTest._setFeeConfig(uint256,uint256,address) (NodeID: 1)
  │   💬 Args: [100, 100, TREASURY]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Helpers._getTokens(address,address,uint256) (NodeID: 2)
  │   💬 Args: [address(asset), accInstances[0].account, assets]
  │   👁️  Def: internal
  ...
  │   💬 Args: [asset.balanceOf(TREASURY), 10e6, "fee skimmed to recipient"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 102)
  │   💬 Args: [asset.balanceOf(address(strategy)), 990e6, "strategy got net assets"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 103)
      💬 Args: [shares, expectedShares, "minted shares = previewDeposit"]
      👁️  Def: internal
```
