# Function: test_SkimFeeFlow_ZeroFee_NoPPSUpdate()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_SkimFeeFlow_ZeroFee_NoPPSUpdate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [ppsAfterSkim, ppsBeforeSkim, "PPS should not change when no fee is collected"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 218)
      💬 Args: ["PPS unchanged:", ppsBeforeSkim]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 219)
        💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 220)
