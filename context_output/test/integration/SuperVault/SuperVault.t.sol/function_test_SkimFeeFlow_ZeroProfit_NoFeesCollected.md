# Function: test_SkimFeeFlow_ZeroProfit_NoFeesCollected()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_SkimFeeFlow_ZeroProfit_NoFeesCollected() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [currentPPS, hwmPpsBefore, "Should have no PPS growth"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 193)
      💬 Args: [strategy.vaultHwmPps(), hwmPpsBefore, "HWM PPS unchanged"]
      👁️  Def: internal
```
