# Function: test_FulfillRedeem_FullAmount()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_FulfillRedeem_FullAmount() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [vaultBalance, address(fluidVault), address(aaveVault), new address[](0)]
  │   👁️  Def: internal
  ...
  │   💬 Args: [strategy.pendingRedeemRequest(accountEth), 0, "Pending redeem request not cleared"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 515)
      💬 Args: [strategy.claimableWithdraw(accountEth), 0, "No assets available to withdraw"]
      👁️  Def: internal
```
