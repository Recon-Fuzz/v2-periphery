# Function: test_PendingRedeemRequest()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_PendingRedeemRequest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [initialPending, 0, "Should have no initial pending request"]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 414)
      💬 Args: [pendingAfterRequest, redeemAmount, "Pending request should match requested amount"]
      👁️  Def: internal
```
