# Function: test_Fix1_ZeroValueTransferIsNoOp()
...
function test_Fix1_ZeroValueTransferIsNoOp() public {
    ...
    ISuperVaultStrategy.SuperVaultState memory fromStateBefore = strategy.getSuperVaultState(accInstances[0].account);
    ...
    assertEq(fromStateAfter.pendingRedeemRequest, fromStateBefore.pendingRedeemRequest, "pendingRedeemRequest should not change");
    assertEq(fromStateAfter.maxWithdraw, fromStateBefore.maxWithdraw, "maxWithdraw should not change");
    assertEq(fromStateAfter.averageRequestPPS, fromStateBefore.averageRequestPPS, "averageRequestPPS should not change");
    assertEq(fromStateAfter.averageWithdrawPrice, fromStateBefore.averageWithdrawPrice, "averageWithdrawPrice should not change");
}
```
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Fix1_ZeroValueTransferIsNoOp() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 315)
  │   💬 Args: [fromStateAfter.pendingRedeemRequest, fromStateBefore.pendingRedeemRequest, "pendingRedeemRequest should not change"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 316)
  │   💬 Args: [fromStateAfter.maxWithdraw, fromStateBefore.maxWithdraw, "maxWithdraw should not change"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 317)
  │   💬 Args: [fromStateAfter.averageRequestPPS, fromStateBefore.averageRequestPPS, "averageRequestPPS should not change"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 318)
      💬 Args: [fromStateAfter.averageWithdrawPrice, fromStateBefore.averageWithdrawPrice, "averageWithdrawPrice should not change"]
      👁️  Def: internal
```
