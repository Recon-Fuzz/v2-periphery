# Function: test_Fix10_DepositAccountingFollowsReceiver()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Fix10_DepositAccountingFollowsReceiver() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 100)
      💬 Args: [vault.balanceOf(receiver), shares, "Receiver should have all shares"]
      👁️  Def: internal
```
