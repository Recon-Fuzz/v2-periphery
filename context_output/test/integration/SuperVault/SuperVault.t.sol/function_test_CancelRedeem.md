...
- **SuperVault::claimableCancelRedeemRequest(uint256,address)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_CancelRedeem() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │                     💬 Args: [slot, id]
  │                     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 413)
  │   💬 Args: [vault.balanceOf(address(escrow)), redeemAmount, "Escrow should hold shares"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 414)
  │   💬 Args: [strategy.pendingCancelRedeemRequest(accountEth), "Pending cancel request should be true"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 415)
  │   💬 Args: [claimableCancelShares, redeemAmount, "Should have claimable cancel shares equal to original request"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 416)
  │   💬 Args: [claimableCancelSharesVault, claimableCancelShares, "Should have claimable cancel shares equal to original request"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 417)
  │   💬 Args: [vault.pendingRedeemRequest(0, accountEth), 0, "Pending request should be cleared"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 418)
  │   💬 Args: [vault.balanceOf(accountEth), userShares, "User should have original shares back"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 419)
      💬 Args: [vault.balanceOf(address(escrow)), 0, "Escrow should no longer hold shares"]
      👁️  Def: internal
```
