# Function: test_Redeem_RevertCases()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Redeem_RevertCases() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
