# Function: test_Fix15_RevertWhen_ControllerNotEqualOwner()
...
function test_Fix15_RevertWhen_ControllerNotEqualOwner() public {
    ...
    address controller = accInstances[1].account;
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Fix15_RevertWhen_ControllerNotEqualOwner() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
