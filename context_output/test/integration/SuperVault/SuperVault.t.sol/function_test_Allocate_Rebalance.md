# Function: test_Allocate_Rebalance()
...
function test_Allocate_Rebalance() public {
    ...
    assertApproxEqRel(vars.finalTotalAssets, vars.initialTotalValue, 0.01e18, "Total value should be preserved during rebalancing");
}
```
...
### _rebalanceFromAaveToFluid(struct SuperVaultTest.RebalanceVars,address[],bytes[])

- **Kind**: internal
- **Source**: 234853:423:580
- **Link**: `test/integration/SuperVault/SuperVault.t.sol:SuperVaultTest:_rebalanceFromAaveToFluid(struct SuperVaultTest.RebalanceVars,address[],bytes[])`

```solidity
function _rebalanceFromAaveToFluid(RebalanceVars memory vars, address[] memory hooksAddresses, bytes[] memory hooksData) private {
    _rebalanceFromVaultToVault(hooksAddresses, hooksData, address(aaveVault), address(fluidVault), vars.targetFluidVaultAssets, vars.currentFluidVaultAssets);
}
```
...
### _rebalanceFromFluidToAave(struct SuperVaultTest.RebalanceVars,address[],bytes[])

- **Kind**: internal
- **Source**: 235282:421:580
- **Link**: `test/integration/SuperVault/SuperVault.t.sol:SuperVaultTest:_rebalanceFromFluidToAave(struct SuperVaultTest.RebalanceVars,address[],bytes[])`

```solidity
function _rebalanceFromFluidToAave(RebalanceVars memory vars, address[] memory hooksAddresses, bytes[] memory hooksData) private {
    _rebalanceFromVaultToVault(hooksAddresses, hooksData, address(fluidVault), address(aaveVault), vars.targetAaveVaultAssets, vars.currentAaveVaultAssets);
}
```
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Allocate_Rebalance() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 306)
  │   💬 Args: ["vars.totalAssets", vars.totalAssets]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 307)
  │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 308)
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 309)
  │   💬 Args: ["vars.targetFluidVaultAssets", vars.targetFluidVaultAssets]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 310)
  │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 311)
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 312)
  │   💬 Args: ["vars.targetAaveVaultAssets", vars.targetAaveVaultAssets]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 313)
  │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 314)
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 315)
  │   💬 Args: ["vars.currentFluidVaultAssets", vars.currentFluidVaultAssets]
  │   👁️  Def: internal
  ...
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 318)
  │   💬 Args: ["vars.currentAaveVaultAssets", vars.currentAaveVaultAssets]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 319)
  │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 320)
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 321)
  │   💬 Args: ["Current FluidVault assets:", vars.currentFluidVaultAssets]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 322)
  │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 323)
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 324)
  │   💬 Args: ["Current AaveVault assets:", vars.currentAaveVaultAssets]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 325)
  │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 326)
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 327)
  │   💬 Args: ["Target FluidVault assets:", vars.targetFluidVaultAssets]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 328)
  │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 329)
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 330)
  │   💬 Args: ["Target AaveVault assets:", vars.targetAaveVaultAssets]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 331)
  │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 332)
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest._getHookAddress(uint64,string) (NodeID: 333)
  │   💬 Args: [ETH, REDEEM_4626_VAULT_HOOK_KEY]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest._getHookAddress(uint64,string) (NodeID: 334)
  │   💬 Args: [ETH, APPROVE_AND_DEPOSIT_4626_VAULT_HOOK_KEY]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SuperVaultTest._rebalanceFromAaveToFluid(struct SuperVaultTest.RebalanceVars,address[],bytes[]) (NodeID: 335)
  │   💬 Args: [vars, hooksAddresses, hooksData]
  │   👁️  Def: private
  │ └─ [2] ⚙️ FUNCTION: BaseSuperVaultTest._rebalanceFromVaultToVault(address[],bytes[],address,address,uint256,uint256) (NodeID: 336)
  │     💬 Args: [hooksAddresses, hooksData, address(aaveVault), address(fluidVault), vars.targetFluidVaultAssets, vars.currentFluidVaultAssets]
  │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: InternalHelpers._createRedeem4626HookData(bytes32,address,address,uint256,bool) (NodeID: 337)
  ...
  │   │   👁️  Def: internal
  │   │ └─ [4] ⚙️ FUNCTION: InternalHelpers._getYieldSourceOracleId(bytes32,address) (NodeID: 338)
  │   │     💬 Args: [bytes32(bytes(ERC4626_YIELD_SOURCE_ORACLE_KEY)), MANAGER]
  │   │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: InternalHelpers._createApproveAndDeposit4626HookData(bytes32,address,address,uint256,bool,address,uint256) (NodeID: 339)
  ...
  │   │   👁️  Def: internal
  │   │ └─ [4] ⚙️ FUNCTION: InternalHelpers._getYieldSourceOracleId(bytes32,address) (NodeID: 340)
  │   │     💬 Args: [bytes32(bytes(APPROVE_AND_DEPOSIT_4626_VAULT_HOOK_KEY)), MANAGER]
  │   │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: MerkleReader._getMerkleProofsForHooks(address[],bytes[]) (NodeID: 341)
  │       💬 Args: [hooksAddresses, argsForProofs]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SuperVaultTest._rebalanceFromFluidToAave(struct SuperVaultTest.RebalanceVars,address[],bytes[]) (NodeID: 342)
  │   💬 Args: [vars, hooksAddresses, hooksData]
  │   👁️  Def: private
  │ └─ [2] ⚙️ FUNCTION: BaseSuperVaultTest._rebalanceFromVaultToVault(address[],bytes[],address,address,uint256,uint256) (NodeID: 343)
  │     💬 Args: [hooksAddresses, hooksData, address(fluidVault), address(aaveVault), vars.targetAaveVaultAssets, vars.currentAaveVaultAssets]
  │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: InternalHelpers._createRedeem4626HookData(bytes32,address,address,uint256,bool) (NodeID: 344)
  │   │   💬 Args: [_getYieldSourceOracleId(bytes32(bytes(ERC4626_YIELD_SOURCE_ORACLE_KEY)), MANAGER), sourceVault, address(strategy), sharesToRedeem, false]
  │   │   👁️  Def: internal
  │   │ └─ [4] ⚙️ FUNCTION: InternalHelpers._getYieldSourceOracleId(bytes32,address) (NodeID: 345)
  │   │     💬 Args: [bytes32(bytes(ERC4626_YIELD_SOURCE_ORACLE_KEY)), MANAGER]
  │   │     👁️  Def: internal
  ...
  │   │     💬 Args: [bytes32(bytes(APPROVE_AND_DEPOSIT_4626_VAULT_HOOK_KEY)), MANAGER]
  │   │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: MerkleReader._getMerkleProofsForHooks(address[],bytes[]) (NodeID: 348)
  │       💬 Args: [hooksAddresses, argsForProofs]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 349)
  │   💬 Args: ["Final FluidVault assets:", vars.finalFluidVaultAssets]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 350)
  │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 351)
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 352)
  │   💬 Args: ["Final AaveVault assets:", vars.finalAaveVaultAssets]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 353)
  │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 354)
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256,string) (NodeID: 355)
  │   💬 Args: ["Final FluidVault percentage:", vars.fluidVaultPercentage, "%"]
  │   👁️  Def: internal
  ...
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: console.log(string,uint256,string) (NodeID: 358)
  │   💬 Args: ["Final AaveVault percentage:", vars.aaveVaultPercentage, "%"]
  │   👁️  Def: internal
  ...
  │       💬 Args: [_sendLogPayloadView]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqRel(uint256,uint256,uint256,string) (NodeID: 361)
  │   💬 Args: [vars.fluidVaultPercentage, 7000, 0.02e18, "FluidVault should have ~70% allocation"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqRel(uint256,uint256,uint256,string) (NodeID: 362)
  │   💬 Args: [vars.aaveVaultPercentage, 3000, 0.02e18, "AaveVault should have ~30% allocation"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqRel(uint256,uint256,uint256,string) (NodeID: 363)
      💬 Args: [vars.finalTotalAssets, vars.initialTotalValue, 0.01e18, "Total value should be preserved during rebalancing"]
      👁️  Def: internal
```
