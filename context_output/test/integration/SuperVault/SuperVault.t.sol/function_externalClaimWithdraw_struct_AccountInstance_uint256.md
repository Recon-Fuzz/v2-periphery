# Function: externalClaimWithdraw(struct AccountInstance,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.externalClaimWithdraw(struct AccountInstance,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: BaseSuperVaultTest._claimWithdrawForAccount(struct AccountInstance,uint256) (NodeID: 1)
      💬 Args: [accInst, assets]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: BaseSuperVaultTest.__claimWithdraw(struct AccountInstance,uint256) (NodeID: 2)
        💬 Args: [accInst, assets]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: BaseTest._getHookAddress(uint64,string) (NodeID: 3)
      │   💬 Args: [ETH, REDEEM_7540_VAULT_HOOK_KEY]
      │   👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: InternalHelpers._createRedeem7540VaultHookData(bytes32,address,uint256,bool) (NodeID: 4)
