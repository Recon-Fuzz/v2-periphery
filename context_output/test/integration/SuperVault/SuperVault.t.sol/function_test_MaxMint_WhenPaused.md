# Function: test_MaxMint_WhenPaused()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_MaxMint_WhenPaused() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseSuperVaultTest._deployVault(string) (NodeID: 1)
  │   💬 Args: ["SV_USDC_MINT_PAUSE_TEST"]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: BaseSuperVaultTest._deployVault(address,string) (NodeID: 2)
  │     💬 Args: [address(asset), _superVaultSymbol]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 3)
  │   💬 Args: [maxMintBeforePause, type(uint256).max, "maxMint should return type(uint256).max when not paused"]
  │   👁️  Def: internal
  ...
  │   💬 Args: ["Deviating PPS (10% decrease):", deviatingPPS]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 13)
      💬 Args: [maxMintAfterPause, 0, "maxMint should return 0 when paused"]
      👁️  Def: internal
```
