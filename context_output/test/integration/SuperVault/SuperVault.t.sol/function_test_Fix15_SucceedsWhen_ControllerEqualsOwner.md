# Function: test_Fix15_SucceedsWhen_ControllerEqualsOwner()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Fix15_SucceedsWhen_ControllerEqualsOwner() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [requestId, 0, "Should return request ID 0"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 316)
  │   💬 Args: [strategy.pendingRedeemRequest(ownerController), shares, "Should have pending redeem request"]
  │   👁️  Def: internal
