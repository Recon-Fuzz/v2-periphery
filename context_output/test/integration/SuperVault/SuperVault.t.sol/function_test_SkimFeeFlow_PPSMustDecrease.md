# Function: test_SkimFeeFlow_PPSMustDecrease()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_SkimFeeFlow_PPSMustDecrease() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: console.log(string) (NodeID: 217)
      💬 Args: ["PPS decrease validation test passed"]
      👁️  Def: internal
