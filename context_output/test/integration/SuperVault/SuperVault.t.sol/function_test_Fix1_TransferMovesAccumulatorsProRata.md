# Function: test_Fix1_TransferMovesAccumulatorsProRata()
...
function test_Fix1_TransferMovesAccumulatorsProRata() public {
    ...
    uint256 transferShares = totalShares / 3;
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Fix1_TransferMovesAccumulatorsProRata() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
