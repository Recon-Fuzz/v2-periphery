# Function: test_gasReport_RequestRedeem()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_gasReport_RequestRedeem() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [strategy.pendingRedeemRequest(accountEth), redeemShares, "Wrong pending redeem amount"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 414)
      💬 Args: [vault.balanceOf(address(escrow)), redeemShares, "Wrong escrow balance"]
      👁️  Def: internal
```
