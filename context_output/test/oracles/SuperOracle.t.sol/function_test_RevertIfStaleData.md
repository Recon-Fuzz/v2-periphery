# Function: test_RevertIfStaleData()
...
```
┌─ [0] ⚙️ FUNCTION: SuperOracleTest.test_RevertIfStaleData() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 1)
  │   💬 Args: [quoteAmount, 0.95e6, "Average quote should be $950 excluding stale provider"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 2)
  │   💬 Args: [totalProviders, 3, "Total providers should still be 3"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 3)
      💬 Args: [availableProviders, 2, "Available providers should be 2 (1 is stale)"]
      👁️  Def: internal
```
