# Function: test_UpdatePPS_InsufficientQuorumReverts()
...
function test_UpdatePPS_InsufficientQuorumReverts() public {
    ...
    bytes32 structHash = keccak256(abi.encodePacked(oracleECDSA.UPDATE_PPS_TYPEHASH(), address(svStrategy), PPS, PPS_STDEV, block.timestamp, oracleECDSA.noncePerStrategy(address(svStrategy))));
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracleTest.test_UpdatePPS_InsufficientQuorumReverts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
