# Function: test_FreshPPSAfterUnpause_Succeeds()
...
function test_FreshPPSAfterUnpause_Succeeds() public {
    ...
    vm.prank(user);
    oracleECDSA.updatePPS(IECDSAPPSOracle.UpdatePPSArgs({strategies: _createSingleStrategyArray(svStrategy), proofsArray: _createSingleProofArray(proofsAfterUnpause), ppss: _createSinglePPSArray(PPS * 3), timestamps: _createSingleTimestampArray(timestampAfterUnpause)}));
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracleTest.test_FreshPPSAfterUnpause_Succeeds() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [svStrategy, PPS * 3, timestampAfterUnpause, new uint256[](0)]
  │   👁️  Def: internal
  ...
  │   💬 Args: [timestampAfterUnpause]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 15)
  │   💬 Args: [aggregatorSuperVault.getPPS(svStrategy), PPS * 3, "PPS should be updated"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 16)
      💬 Args: [oracleECDSA.noncePerStrategy(svStrategy), 2, "Nonce should be 2"]
      👁️  Def: internal
```
