# Function: test_ValidateProofs_RevertsOnQuorumNotMet()
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracleTest.test_ValidateProofs_RevertsOnQuorumNotMet() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createValidProofs(address,uint256,uint256,uint256[]) (NodeID: 1)
      💬 Args: [address(svStrategy), PPS, block.timestamp, signerKeys]
      👁️  Def: internal
