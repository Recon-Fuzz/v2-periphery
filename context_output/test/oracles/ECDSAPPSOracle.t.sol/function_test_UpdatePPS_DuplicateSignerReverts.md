# Function: test_UpdatePPS_DuplicateSignerReverts()
...
function test_UpdatePPS_DuplicateSignerReverts() public {
    ...
    proofs[1] = abi.encodePacked(r, s, v);
    vm.prank(user);
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracleTest.test_UpdatePPS_DuplicateSignerReverts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
