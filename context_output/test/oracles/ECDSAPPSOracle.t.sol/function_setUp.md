...
function setUp() override public {
    ...
    governor = SuperGovernor(payable(VmContractHelper620(0x7109709ECfa91a80626fF3989D68f67F5b1DD12D).deployCode({_artifact: "src/SuperGovernor.sol:SuperGovernor", _args: encodeArgs438(DeployHelper438.FoundryPpConstructorArgs(governorAddress, governorAddress, governorAddress, governorAddress, governorAddress, governorAddress, TREASURY, false))})));
    address vaultImpl = address(SuperVault(payable(VmContractHelper620(0x7109709ECfa91a80626fF3989D68f67F5b1DD12D).deployCode({_artifact: "src/SuperVault/SuperVault.sol:SuperVault", _args: encodeArgs470(DeployHelper470.FoundryPpConstructorArgs(address(governor)))}))));
    address strategyImpl = address(SuperVaultStrategy(payable(VmContractHelper620(0x7109709ECfa91a80626fF3989D68f67F5b1DD12D).deployCode({_artifact: "src/SuperVault/SuperVaultStrategy.sol:SuperVaultStrategy", _args: encodeArgs472(DeployHelper472.FoundryPpConstructorArgs(address(governor)))}))));
    ...
    aggregatorSuperVault = SuperVaultAggregator(payable(VmContractHelper620(0x7109709ECfa91a80626fF3989D68f67F5b1DD12D).deployCode({_artifact: "src/SuperVault/SuperVaultAggregator.sol:SuperVaultAggregator", _args: encodeArgs474(DeployHelper474.FoundryPpConstructorArgs(address(governor), vaultImpl, strategyImpl, escrowImpl))})));
    (sv, svStrategy, ) = aggregatorSuperVault.createVault(ISuperVaultAggregator.VaultCreationParams({asset: address(asset), name: "TestVault", symbol: "TV", mainManager: mockManager, secondaryManagers: new address[](0), minUpdateInterval: 5, maxStaleness: 300, feeConfig: ISuperVaultStrategy.FeeConfig({performanceFeeBps: 1000, managementFeeBps: 0, recipient: TREASURY})}));
    oracleECDSA = ECDSAPPSOracle(payable(VmContractHelper620(0x7109709ECfa91a80626fF3989D68f67F5b1DD12D).deployCode({_artifact: "src/oracles/ECDSAPPSOracle.sol:ECDSAPPSOracle", _args: encodeArgs478(DeployHelper478.FoundryPpConstructorArgs(address(governor), ECDSAPPS_ORACLE_KEY, ECDSAPPS_ORACLE_VERSION))})));
    ...
    governor.setValidatorConfig(1, validators, validatorPublicKeys, 2, "");
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracleTest.setUp() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Helpers._deployAccount(uint256,string) (NodeID: 1290)
  │   💬 Args: [0x2, "User"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Helpers._deployAccount(uint256,string) (NodeID: 1291)
  │   💬 Args: [validator1PrivateKey, "Validator1"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Helpers._deployAccount(uint256,string) (NodeID: 1292)
  │   💬 Args: [validator2PrivateKey, "Validator2"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Helpers._deployAccount(uint256,string) (NodeID: 1293)
  │   💬 Args: [validator3PrivateKey, "Validator3"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Helpers._deployAccount(uint256,string) (NodeID: 1294)
  │   💬 Args: [0x6, "mockManager"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Helpers._deployAccount(uint256,string) (NodeID: 1295)
  │   💬 Args: [0x7, "GovernorRole"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(bool,bool) (NodeID: 1296)
      💬 Args: [governor.isActivePPSOracle(address(oracleECDSA)), true]
      👁️  Def: internal
```
