# Function: test_ValidateProofs_Line180_Equality_DuplicateSigner()
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracleTest.test_ValidateProofs_Line180_Equality_DuplicateSigner() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
