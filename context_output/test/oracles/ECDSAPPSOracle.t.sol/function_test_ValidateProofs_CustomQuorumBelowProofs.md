# Function: test_ValidateProofs_CustomQuorumBelowProofs()
...
function test_ValidateProofs_CustomQuorumBelowProofs() public view {
    ...
    oracleECDSA.validateProofs(IECDSAPPSOracle.ValidationParams({strategy: address(svStrategy), proofs: proofs, pps: PPS, timestamp: block.timestamp}), 1);
}
```
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracleTest.test_ValidateProofs_CustomQuorumBelowProofs() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
