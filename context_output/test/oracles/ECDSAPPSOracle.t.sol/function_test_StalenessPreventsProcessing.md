# Function: test_StalenessPreventsProcessing()
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracleTest.test_StalenessPreventsProcessing() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdCheats.deal(address,address,uint256) (NodeID: 1)
  │   💬 Args: [upToken, mockManager, 100 ether]
  │   👁️  Def: internal
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createValidProofs(address,uint256,uint256,uint256[]) (NodeID: 99)
  │   💬 Args: [svStrategy, PPS, timestamp1, new uint256[](0)]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: MessageHashUtils.toTypedDataHash(bytes32,bytes32) (NodeID: 100)
  │ │   💬 Args: [domainSeparator, structHash]
  │ │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: ECDSAPPSOracleTest._sortSignerKeysByAddress(uint256[]) (NodeID: 101)
  │     💬 Args: [signerKeys]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSingleStrategyArray(address) (NodeID: 102)
  │   💬 Args: [svStrategy]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSingleProofArray(bytes[]) (NodeID: 103)
  │   💬 Args: [proofs1]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSinglePPSArray(uint256) (NodeID: 104)
  │   💬 Args: [PPS]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSingleTimestampArray(uint256) (NodeID: 105)
  │   💬 Args: [timestamp1]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createValidProofs(address,uint256,uint256,uint256[]) (NodeID: 106)
  │   💬 Args: [svStrategy, PPS * 2, timestamp2, new uint256[](0)]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: MessageHashUtils.toTypedDataHash(bytes32,bytes32) (NodeID: 107)
  │ │   💬 Args: [domainSeparator, structHash]
  │ │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: ECDSAPPSOracleTest._sortSignerKeysByAddress(uint256[]) (NodeID: 108)
  │     💬 Args: [signerKeys]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSingleStrategyArray(address) (NodeID: 109)
  │   💬 Args: [svStrategy]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSingleProofArray(bytes[]) (NodeID: 110)
  │   💬 Args: [proofs2]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSinglePPSArray(uint256) (NodeID: 111)
  │   💬 Args: [PPS * 2]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSingleTimestampArray(uint256) (NodeID: 112)
  │   💬 Args: [timestamp2]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 114)
      💬 Args: [oracleECDSA.noncePerStrategy(svStrategy), 2, "Nonce should be 2 (burned despite staleness rejection)"]
      👁️  Def: internal
```
