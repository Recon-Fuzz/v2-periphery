# Function: test_BatchUpdatePPS_ValidationFailureReverts()
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracleTest.test_BatchUpdatePPS_ValidationFailureReverts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createValidProofs(address,uint256,uint256,uint256[]) (NodeID: 1)
      💬 Args: [data.strategy1, data.ppss[0], data.timestamps[0], new uint256[](0)]
      👁️  Def: internal
