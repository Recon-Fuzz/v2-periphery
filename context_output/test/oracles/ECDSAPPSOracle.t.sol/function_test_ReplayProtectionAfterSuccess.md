# Function: test_ReplayProtectionAfterSuccess()
...
```
┌─ [0] ⚙️ FUNCTION: ECDSAPPSOracleTest.test_ReplayProtectionAfterSuccess() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [nonceAfterFirst, 1, "Nonce should be 1 after first update"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSingleStrategyArray(address) (NodeID: 9)
  │   💬 Args: [svStrategy]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSingleProofArray(bytes[]) (NodeID: 10)
  │   💬 Args: [proofs1]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSinglePPSArray(uint256) (NodeID: 11)
  │   💬 Args: [PPS]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ECDSAPPSOracleTest._createSingleTimestampArray(uint256) (NodeID: 12)
  │   💬 Args: [timestamp1]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 13)
  │   💬 Args: [oracleECDSA.noncePerStrategy(svStrategy), 1, "Nonce should still be 1"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 14)
      💬 Args: [aggregatorSuperVault.getPPS(svStrategy), PPS, "PPS should not change"]
      👁️  Def: internal
```
