# Function: test_GetQuoteFromOracle_RevertsOnNegativeAnswerWithRevertOnError()
...
```
┌─ [0] ⚙️ FUNCTION: SuperOracleL2Test.test_GetQuoteFromOracle_RevertsOnNegativeAnswerWithRevertOnError() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
