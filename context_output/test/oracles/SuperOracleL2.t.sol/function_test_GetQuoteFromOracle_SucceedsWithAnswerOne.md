# Function: test_GetQuoteFromOracle_SucceedsWithAnswerOne()
...
```
┌─ [0] ⚙️ FUNCTION: SuperOracleL2Test.test_GetQuoteFromOracle_SucceedsWithAnswerOne() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 1)
      💬 Args: [quoteAmount, 0, "Should succeed with positive answer"]
      👁️  Def: internal
```
