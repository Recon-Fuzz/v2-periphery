# Function: test_GetQuoteFromOracle_ReturnsZeroOnNegativeAnswerWithoutRevert()
...
```
┌─ [0] ⚙️ FUNCTION: SuperOracleL2Test.test_GetQuoteFromOracle_ReturnsZeroOnNegativeAnswerWithoutRevert() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 1)
      💬 Args: [quoteAmount, 0, "Should get quote from valid provider despite one provider having invalid answer"]
      👁️  Def: internal
```
