# Function: test_GasInfo_SetGasInfo_Success()
...
```
┌─ [0] ⚙️ FUNCTION: SuperGovernorTest.test_GasInfo_SetGasInfo_Success() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 3)
      💬 Args: [superGovernor.getGasInfo(oracle), gasIncreasePerBatch, "Gas per entry should match"]
      👁️  Def: internal
```
