# Function: test_GasInfo_SetGasInfo_LargeValue()
...
```
┌─ [0] ⚙️ FUNCTION: SuperGovernorTest.test_GasInfo_SetGasInfo_LargeValue() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 3)
      💬 Args: [superGovernor.getGasInfo(oracle), largeGasValue, "Large gas value should be stored correctly"]
      👁️  Def: internal
```
