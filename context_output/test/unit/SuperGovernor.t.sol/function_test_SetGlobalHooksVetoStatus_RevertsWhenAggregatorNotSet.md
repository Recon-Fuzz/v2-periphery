# Function: test_SetGlobalHooksVetoStatus_RevertsWhenAggregatorNotSet()
...
```
┌─ [0] ⚙️ FUNCTION: SuperGovernorTest.test_SetGlobalHooksVetoStatus_RevertsWhenAggregatorNotSet() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: Helpers._deployAccount(uint256,string) (NodeID: 1)
      💬 Args: [0xFB, "FreshSuperGovernor4"]
      👁️  Def: internal
```
