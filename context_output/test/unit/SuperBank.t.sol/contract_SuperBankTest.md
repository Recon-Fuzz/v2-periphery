...
**MockOdosRouterV2**: [lib/v2-core/test/mocks/MockOdosRouterV2.sol/contract_MockOdosRouterV2.md]
...
**Mock4626Vault**: [test/mocks/Mock4626Vault.sol/contract_Mock4626Vault.md]
...
**AcrossV3Helper**: [lib/v2-core/lib/pigeon/src/across/AcrossV3Helper.sol/contract_AcrossV3Helper.md]
...
### test_SuperBank_Constructor()

- **Signature**: `test_SuperBank_Constructor()`
- **Visibility**: public
- **Source Range**: 5125:461:658
- **Details**: [function_test_SuperBank_Constructor.md](./function_test_SuperBank_Constructor.md)
...
### test_SuperBank_receive()

- **Signature**: `test_SuperBank_receive()`
- **Visibility**: public
- **Source Range**: 5592:463:658
- **Details**: [function_test_SuperBank_receive.md](./function_test_SuperBank_receive.md)
...
### test_SuperBank_distribute_NotBankManager()

- **Signature**: `test_SuperBank_distribute_NotBankManager()`
- **Visibility**: public
- **Source Range**: 6217:314:658
- **Details**: [function_test_SuperBank_distribute_NotBankManager.md](./function_test_SuperBank_distribute_NotBankManager.md)
...
### test_SuperBank_distribute_ZeroAmount()

- **Signature**: `test_SuperBank_distribute_ZeroAmount()`
- **Visibility**: public
- **Source Range**: 6537:289:658
- **Details**: [function_test_SuperBank_distribute_ZeroAmount.md](./function_test_SuperBank_distribute_ZeroAmount.md)
...
### test_SuperBank_distribute_InvalidUpAmountToDistribute()

- **Signature**: `test_SuperBank_distribute_InvalidUpAmountToDistribute()`
- **Visibility**: public
- **Source Range**: 6832:597:658
- **Details**: [function_test_SuperBank_distribute_InvalidUpAmountToDistribute.md](./function_test_SuperBank_distribute_InvalidUpAmountToDistribute.md)
...
### test_SuperBank_distribute_success_unit()

- **Signature**: `test_SuperBank_distribute_success_unit()`
- **Visibility**: public
- **Source Range**: 7435:1523:658
- **Details**: [function_test_SuperBank_distribute_success_unit.md](./function_test_SuperBank_distribute_success_unit.md)
...
### test_SuperBank_distribute_RevenueShareExceedsPrecision()

- **Signature**: `test_SuperBank_distribute_RevenueShareExceedsPrecision()`
- **Visibility**: public
- **Source Range**: 9149:1042:658
- **Details**: [function_test_SuperBank_distribute_RevenueShareExceedsPrecision.md](./function_test_SuperBank_distribute_RevenueShareExceedsPrecision.md)
...
### test_SuperBank_distribute_RevenueShareAtPrecision()

- **Signature**: `test_SuperBank_distribute_RevenueShareAtPrecision()`
- **Visibility**: public
- **Source Range**: 10381:1525:658
- **Details**: [function_test_SuperBank_distribute_RevenueShareAtPrecision.md](./function_test_SuperBank_distribute_RevenueShareAtPrecision.md)
...
### test_SuperBank_distribute_RevenueShareLargeValue()

- **Signature**: `test_SuperBank_distribute_RevenueShareLargeValue()`
- **Visibility**: public
- **Source Range**: 12079:1012:658
- **Details**: [function_test_SuperBank_distribute_RevenueShareLargeValue.md](./function_test_SuperBank_distribute_RevenueShareLargeValue.md)
...
### test_SuperBank_distribute_SupAmountZero()

- **Signature**: `test_SuperBank_distribute_SupAmountZero()`
- **Visibility**: public
- **Source Range**: 13258:1564:658
- **Details**: [function_test_SuperBank_distribute_SupAmountZero.md](./function_test_SuperBank_distribute_SupAmountZero.md)
...
### test_SuperBank_distribute_SupAmountGreaterThanZero()

- **Signature**: `test_SuperBank_distribute_SupAmountGreaterThanZero()`
- **Visibility**: public
- **Source Range**: 14981:1621:658
- **Details**: [function_test_SuperBank_distribute_SupAmountGreaterThanZero.md](./function_test_SuperBank_distribute_SupAmountGreaterThanZero.md)
...
### test_SuperBank_distribute_SmallAmountRounding()

- **Signature**: `test_SuperBank_distribute_SmallAmountRounding()`
- **Visibility**: public
- **Source Range**: 16771:1488:658
- **Details**: [function_test_SuperBank_distribute_SmallAmountRounding.md](./function_test_SuperBank_distribute_SmallAmountRounding.md)
...
### test_SuperBank_distribute_TreasuryAmountZero()

- **Signature**: `test_SuperBank_distribute_TreasuryAmountZero()`
- **Visibility**: public
- **Source Range**: 18446:1374:658
- **Details**: [function_test_SuperBank_distribute_TreasuryAmountZero.md](./function_test_SuperBank_distribute_TreasuryAmountZero.md)
...
### test_SuperBank_distribute_TreasuryAmountGreaterThanZero()

- **Signature**: `test_SuperBank_distribute_TreasuryAmountGreaterThanZero()`
- **Visibility**: public
- **Source Range**: 19994:1479:658
- **Details**: [function_test_SuperBank_distribute_TreasuryAmountGreaterThanZero.md](./function_test_SuperBank_distribute_TreasuryAmountGreaterThanZero.md)
...
### test_SuperBank_executeHooks_NotBankManager()

- **Signature**: `test_SuperBank_executeHooks_NotBankManager()`
- **Visibility**: public
- **Source Range**: 21633:914:658
- **Details**: [function_test_SuperBank_executeHooks_NotBankManager.md](./function_test_SuperBank_executeHooks_NotBankManager.md)
...
### test_SuperBank_executeHooks_ZeroLengthArray()

- **Signature**: `test_SuperBank_executeHooks_ZeroLengthArray()`
- **Visibility**: public
- **Source Range**: 22553:828:658
- **Details**: [function_test_SuperBank_executeHooks_ZeroLengthArray.md](./function_test_SuperBank_executeHooks_ZeroLengthArray.md)
...
### test_SuperBank_executeHooks_InvalidArrayLength()

- **Signature**: `test_SuperBank_executeHooks_InvalidArrayLength()`
- **Visibility**: public
- **Source Range**: 23387:1050:658
- **Details**: [function_test_SuperBank_executeHooks_InvalidArrayLength.md](./function_test_SuperBank_executeHooks_InvalidArrayLength.md)
...
### test_SuperBank_executeHooks_ZeroAddressHook()

- **Signature**: `test_SuperBank_executeHooks_ZeroAddressHook()`
- **Visibility**: public
- **Source Range**: 24599:943:658
- **Details**: [function_test_SuperBank_executeHooks_ZeroAddressHook.md](./function_test_SuperBank_executeHooks_ZeroAddressHook.md)
...
### test_SuperBank_executeHooks_ZeroAddressAtDifferentPositions()

- **Signature**: `test_SuperBank_executeHooks_ZeroAddressAtDifferentPositions()`
- **Visibility**: public
- **Source Range**: 25729:1150:658
- **Details**: [function_test_SuperBank_executeHooks_ZeroAddressAtDifferentPositions.md](./function_test_SuperBank_executeHooks_ZeroAddressAtDifferentPositions.md)
...
### test_SuperBank_executeHooks_HookNotRegistered()

- **Signature**: `test_SuperBank_executeHooks_HookNotRegistered()`
- **Visibility**: public
- **Source Range**: 27056:1055:658
- **Details**: [function_test_SuperBank_executeHooks_HookNotRegistered.md](./function_test_SuperBank_executeHooks_HookNotRegistered.md)
...
### test_SuperBank_executeHooks_DifferentUnregisteredHooks()

- **Signature**: `test_SuperBank_executeHooks_DifferentUnregisteredHooks()`
- **Visibility**: public
- **Source Range**: 28283:1364:658
- **Details**: [function_test_SuperBank_executeHooks_DifferentUnregisteredHooks.md](./function_test_SuperBank_executeHooks_DifferentUnregisteredHooks.md)
...
### test_SuperBank_executeHooks_RegisteredHookPassesCheck()

- **Signature**: `test_SuperBank_executeHooks_RegisteredHookPassesCheck()`
- **Visibility**: public
- **Source Range**: 29827:1305:658
- **Details**: [function_test_SuperBank_executeHooks_RegisteredHookPassesCheck.md](./function_test_SuperBank_executeHooks_RegisteredHookPassesCheck.md)
...
### test_SuperBank_executeHooks_InspectMethodFails()

- **Signature**: `test_SuperBank_executeHooks_InspectMethodFails()`
- **Visibility**: public
- **Source Range**: 31291:1510:658
- **Details**: [function_test_SuperBank_executeHooks_InspectMethodFails.md](./function_test_SuperBank_executeHooks_InspectMethodFails.md)
...
### test_SuperBank_executeHooks_HookMissingInspectInterface()

- **Signature**: `test_SuperBank_executeHooks_HookMissingInspectInterface()`
- **Visibility**: public
- **Source Range**: 32981:1538:658
- **Details**: [function_test_SuperBank_executeHooks_HookMissingInspectInterface.md](./function_test_SuperBank_executeHooks_HookMissingInspectInterface.md)
...
### test_SuperBank_executeHooks_MerkleRootZero()

- **Signature**: `test_SuperBank_executeHooks_MerkleRootZero()`
- **Visibility**: public
- **Source Range**: 34665:1482:658
- **Details**: [function_test_SuperBank_executeHooks_MerkleRootZero.md](./function_test_SuperBank_executeHooks_MerkleRootZero.md)
...
### test_SuperBank_executeHooks_InvalidMerkleProof()

- **Signature**: `test_SuperBank_executeHooks_InvalidMerkleProof()`
- **Visibility**: public
- **Source Range**: 36153:1525:658
- **Details**: [function_test_SuperBank_executeHooks_InvalidMerkleProof.md](./function_test_SuperBank_executeHooks_InvalidMerkleProof.md)
...
### test_SuperBank_executeHooks_InvalidProofNonZeroRoot()

- **Signature**: `test_SuperBank_executeHooks_InvalidProofNonZeroRoot()`
- **Visibility**: public
- **Source Range**: 37851:1597:658
- **Details**: [function_test_SuperBank_executeHooks_InvalidProofNonZeroRoot.md](./function_test_SuperBank_executeHooks_InvalidProofNonZeroRoot.md)
...
### test_SuperBank_executeHooks_SingleLeafTreeValidation()

- **Signature**: `test_SuperBank_executeHooks_SingleLeafTreeValidation()`
- **Visibility**: public
- **Source Range**: 39597:1978:658
- **Details**: [function_test_SuperBank_executeHooks_SingleLeafTreeValidation.md](./function_test_SuperBank_executeHooks_SingleLeafTreeValidation.md)
...
### test_SuperBank_executeHooks_HookExecutionFailed()

- **Signature**: `test_SuperBank_executeHooks_HookExecutionFailed()`
- **Visibility**: public
- **Source Range**: 41581:1783:658
- **Details**: [function_test_SuperBank_executeHooks_HookExecutionFailed.md](./function_test_SuperBank_executeHooks_HookExecutionFailed.md)
...
### test_SuperBank_executeHooks_Success()

- **Signature**: `test_SuperBank_executeHooks_Success()`
- **Visibility**: public
- **Source Range**: 43370:1852:658
- **Details**: [function_test_SuperBank_executeHooks_Success.md](./function_test_SuperBank_executeHooks_Success.md)
...
### test_SuperBank_executeHooks_MultipleHooks()

- **Signature**: `test_SuperBank_executeHooks_MultipleHooks()`
- **Visibility**: public
- **Source Range**: 45228:2374:658
- **Details**: [function_test_SuperBank_executeHooks_MultipleHooks.md](./function_test_SuperBank_executeHooks_MultipleHooks.md)
...
### test_SuperBank_SwapHookOdos()

- **Signature**: `test_SuperBank_SwapHookOdos()`
- **Visibility**: public
- **Source Range**: 47608:4123:658
- **Details**: [function_test_SuperBank_SwapHookOdos.md](./function_test_SuperBank_SwapHookOdos.md)
...
### test_SuperBank_RedeemHookOdos()

- **Signature**: `test_SuperBank_RedeemHookOdos()`
- **Visibility**: public
- **Source Range**: 51737:2445:658
- **Details**: [function_test_SuperBank_RedeemHookOdos.md](./function_test_SuperBank_RedeemHookOdos.md)
...
### test_SuperBank_Across()

- **Signature**: `test_SuperBank_Across()`
- **Visibility**: public
- **Source Range**: 54188:4695:658
- **Details**: [function_test_SuperBank_Across.md](./function_test_SuperBank_Across.md)
...
### test_SuperBank_executeHooks_EmptyHookArgs_Reverts()

- **Signature**: `test_SuperBank_executeHooks_EmptyHookArgs_Reverts()`
- **Visibility**: public
- **Source Range**: 58972:1852:658
- **Details**: [function_test_SuperBank_executeHooks_EmptyHookArgs_Reverts.md](./function_test_SuperBank_executeHooks_EmptyHookArgs_Reverts.md)
...
### test_SuperBank_MultiTargetHook_Success()

- **Signature**: `test_SuperBank_MultiTargetHook_Success()`
- **Visibility**: public
- **Source Range**: 61230:3518:658
- **Details**: [function_test_SuperBank_MultiTargetHook_Success.md](./function_test_SuperBank_MultiTargetHook_Success.md)
...
### test_SuperBank_executeHooks_SlippageProtection_Success()

- **Signature**: `test_SuperBank_executeHooks_SlippageProtection_Success()`
- **Visibility**: public
- **Source Range**: 64985:1715:658
- **Details**: [function_test_SuperBank_executeHooks_SlippageProtection_Success.md](./function_test_SuperBank_executeHooks_SlippageProtection_Success.md)
...
### test_SuperBank_executeHooks_SlippageProtection_Reverts()

- **Signature**: `test_SuperBank_executeHooks_SlippageProtection_Reverts()`
- **Visibility**: public
- **Source Range**: 66783:1818:658
- **Details**: [function_test_SuperBank_executeHooks_SlippageProtection_Reverts.md](./function_test_SuperBank_executeHooks_SlippageProtection_Reverts.md)
...
### test_SuperBank_executeHooks_SlippageProtection_MultipleHooks()

- **Signature**: `test_SuperBank_executeHooks_SlippageProtection_MultipleHooks()`
- **Visibility**: public
- **Source Range**: 68679:2453:658
- **Details**: [function_test_SuperBank_executeHooks_SlippageProtection_MultipleHooks.md](./function_test_SuperBank_executeHooks_SlippageProtection_MultipleHooks.md)
...
### test_SuperBank_executeHooks_SlippageProtection_ZeroExpected()

- **Signature**: `test_SuperBank_executeHooks_SlippageProtection_ZeroExpected()`
- **Visibility**: public
- **Source Range**: 71191:1679:658
- **Details**: [function_test_SuperBank_executeHooks_SlippageProtection_ZeroExpected.md](./function_test_SuperBank_executeHooks_SlippageProtection_ZeroExpected.md)
...
### test_SuperBank_executeHooks_SlippageProtection_ExactMatch()

- **Signature**: `test_SuperBank_executeHooks_SlippageProtection_ExactMatch()`
- **Visibility**: public
- **Source Range**: 72920:1720:658
- **Details**: [function_test_SuperBank_executeHooks_SlippageProtection_ExactMatch.md](./function_test_SuperBank_executeHooks_SlippageProtection_ExactMatch.md)
...
### test_SuperBank_executeHooks_InvalidArrayLength_ExpectedOutputs()

- **Signature**: `test_SuperBank_executeHooks_InvalidArrayLength_ExpectedOutputs()`
- **Visibility**: public
- **Source Range**: 74719:1102:658
- **Details**: [function_test_SuperBank_executeHooks_InvalidArrayLength_ExpectedOutputs.md](./function_test_SuperBank_executeHooks_InvalidArrayLength_ExpectedOutputs.md)
