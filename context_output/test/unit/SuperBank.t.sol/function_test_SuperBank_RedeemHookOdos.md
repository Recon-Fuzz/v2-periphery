# Function: test_SuperBank_RedeemHookOdos()
...
```
┌─ [0] ⚙️ FUNCTION: SuperBankTest.test_SuperBank_RedeemHookOdos() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: Helpers._getTokens(address,address,uint256) (NodeID: 1)
  │   💬 Args: [address(token), address(this), amount]
  │   👁️  Def: internal
  ...
  │               💬 Args: [self]
  │               👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 100)
  │   💬 Args: [shares, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 101)
  │   💬 Args: [superBankTokenBalanceBefore, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: InternalHelpers._createRedeem4626HookData(bytes32,address,address,uint256,bool) (NodeID: 102)
  │   💬 Args: [bytes32(0), address(vault), address(superBank), shares, false]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 103)
  │   💬 Args: [shares, 0]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 104)
      💬 Args: [superBankTokenBalanceAfter, superBankTokenBalanceBefore]
      👁️  Def: internal
```
