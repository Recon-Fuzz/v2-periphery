# Function: test_SuperBank_executeHooks_RegisteredHookPassesCheck()
...
```
┌─ [0] ⚙️ FUNCTION: SuperBankTest.test_SuperBank_executeHooks_RegisteredHookPassesCheck() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
