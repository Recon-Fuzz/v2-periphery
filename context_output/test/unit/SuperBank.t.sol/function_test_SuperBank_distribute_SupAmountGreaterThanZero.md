# Function: test_SuperBank_distribute_SupAmountGreaterThanZero()
...
```
┌─ [0] ⚙️ FUNCTION: SuperBankTest.test_SuperBank_distribute_SupAmountGreaterThanZero() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 1)
  │   💬 Args: [up.balanceOf(supToken), initialSupBalance + expectedSupAmount, "sUP token should receive 50%"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 2)
      💬 Args: [up.balanceOf(treasury), initialTreasuryBalance + expectedTreasuryAmount, "Treasury should receive 50%"]
      👁️  Def: internal
```
