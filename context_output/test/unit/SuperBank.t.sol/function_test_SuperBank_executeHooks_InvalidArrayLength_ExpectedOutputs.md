# Function: test_SuperBank_executeHooks_InvalidArrayLength_ExpectedOutputs()
...
```
┌─ [0] ⚙️ FUNCTION: SuperBankTest.test_SuperBank_executeHooks_InvalidArrayLength_ExpectedOutputs() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
