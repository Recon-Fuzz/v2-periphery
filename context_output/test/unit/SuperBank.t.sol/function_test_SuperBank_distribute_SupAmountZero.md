# Function: test_SuperBank_distribute_SupAmountZero()
...
function test_SuperBank_distribute_SupAmountZero() public {
    ...
    vm.stopPrank();
    vm.mockCall(address(superGovernor), abi.encodeWithSignature("getFee(uint8)", uint8(FeeType.REVENUE_SHARE)), abi.encode(uint256(0)));
...
```
┌─ [0] ⚙️ FUNCTION: SuperBankTest.test_SuperBank_distribute_SupAmountZero() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 1)
  │   💬 Args: [up.balanceOf(supToken), initialSupBalance, "sUP token should receive 0"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 2)
      💬 Args: [up.balanceOf(treasury), initialTreasuryBalance + upAmount, "Treasury should receive 100%"]
      👁️  Def: internal
```
