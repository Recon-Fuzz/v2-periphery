# Function: test_SuperBank_executeHooks_DifferentUnregisteredHooks()
...
```
┌─ [0] ⚙️ FUNCTION: SuperBankTest.test_SuperBank_executeHooks_DifferentUnregisteredHooks() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
