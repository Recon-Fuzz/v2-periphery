# Function: test_SuperBank_distribute_TreasuryAmountZero()
...
```
┌─ [0] ⚙️ FUNCTION: SuperBankTest.test_SuperBank_distribute_TreasuryAmountZero() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 1)
  │   💬 Args: [up.balanceOf(supToken), initialSupBalance + upAmount, "sUP token should receive 100%"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 2)
      💬 Args: [up.balanceOf(treasury), initialTreasuryBalance, "Treasury should receive 0 (no transfer)"]
      👁️  Def: internal
```
