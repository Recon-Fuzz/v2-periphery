# Function: test_SuperBank_executeHooks_SlippageProtection_Success()
...
```
┌─ [0] ⚙️ FUNCTION: SuperBankTest.test_SuperBank_executeHooks_SlippageProtection_Success() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
