...
- **Name**: SuperVaultEscrowTest
- **Type**: Contract
- **Path**: test/unit/SuperVaultEscrow.t.sol
...
### test_Initialize_RevertZeroAddress()

- **Signature**: `test_Initialize_RevertZeroAddress()`
- **Visibility**: public
- **Source Range**: 1205:164:662
- **Details**: [function_test_Initialize_RevertZeroAddress.md](./function_test_Initialize_RevertZeroAddress.md)
...
### test_Initialize_RevertAlreadyInitialized()

- **Signature**: `test_Initialize_RevertAlreadyInitialized()`
- **Visibility**: public
- **Source Range**: 1446:313:662
- **Details**: [function_test_Initialize_RevertAlreadyInitialized.md](./function_test_Initialize_RevertAlreadyInitialized.md)
...
- **Details**: [function_test_Initialize_Success.md](./function_test_Initialize_Success.md)
...
### test_EscrowShares_RevertUnauthorized()

- **Signature**: `test_EscrowShares_RevertUnauthorized()`
- **Visibility**: public
- **Source Range**: 2662:315:662
- **Details**: [function_test_EscrowShares_RevertUnauthorized.md](./function_test_EscrowShares_RevertUnauthorized.md)
...
### test_EscrowShares_RevertZeroAmount()

- **Signature**: `test_EscrowShares_RevertZeroAmount()`
- **Visibility**: public
- **Source Range**: 3051:289:662
- **Details**: [function_test_EscrowShares_RevertZeroAmount.md](./function_test_EscrowShares_RevertZeroAmount.md)
...
### test_ReturnShares_RevertUnauthorized()

- **Signature**: `test_ReturnShares_RevertUnauthorized()`
- **Visibility**: public
- **Source Range**: 3602:315:662
- **Details**: [function_test_ReturnShares_RevertUnauthorized.md](./function_test_ReturnShares_RevertUnauthorized.md)
...
### test_ReturnShares_RevertZeroAmount()

- **Signature**: `test_ReturnShares_RevertZeroAmount()`
- **Visibility**: public
- **Source Range**: 3991:289:662
- **Details**: [function_test_ReturnShares_RevertZeroAmount.md](./function_test_ReturnShares_RevertZeroAmount.md)
...
### test_ReturnAssets_RevertUnauthorized()

- **Signature**: `test_ReturnAssets_RevertUnauthorized()`
- **Visibility**: public
- **Source Range**: 4542:315:662
- **Details**: [function_test_ReturnAssets_RevertUnauthorized.md](./function_test_ReturnAssets_RevertUnauthorized.md)
...
### test_ReturnAssets_RevertZeroAmount()

- **Signature**: `test_ReturnAssets_RevertZeroAmount()`
- **Visibility**: public
- **Source Range**: 4931:289:662
- **Details**: [function_test_ReturnAssets_RevertZeroAmount.md](./function_test_ReturnAssets_RevertZeroAmount.md)
...
### test_ReturnAssets_RevertZeroAddress()

- **Signature**: `test_ReturnAssets_RevertZeroAddress()`
- **Visibility**: public
- **Source Range**: 5298:310:662
- **Details**: [function_test_ReturnAssets_RevertZeroAddress.md](./function_test_ReturnAssets_RevertZeroAddress.md)
