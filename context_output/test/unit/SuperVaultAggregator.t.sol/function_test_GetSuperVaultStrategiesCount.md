# Function: test_GetSuperVaultStrategiesCount()
...
- **SuperVaultAggregator::getSuperVaultStrategiesCount()**
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregatorTest.test_GetSuperVaultStrategiesCount() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 1)
  │   💬 Args: [count, 1, "Should have 1 strategy from setUp"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 2)
  │   💬 Args: [count, strategies.length, "Count should match getAllSuperVaultStrategies length"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 3)
      💬 Args: [newCount, 2, "Should have 2 strategies after creating another vault"]
      👁️  Def: internal
```
