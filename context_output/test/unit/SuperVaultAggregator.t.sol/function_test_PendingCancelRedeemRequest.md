# Function: test_PendingCancelRedeemRequest()
...
- **Vm::stopPrank()**
- **ISuperVaultStrategy::fulfillCancelRedeemRequests(address[])**
- **Vm::prank(address)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregatorTest.test_PendingCancelRedeemRequest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 102)
  │   💬 Args: [isPending, "Should return true when cancel request is pending"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(bool,bool,string) (NodeID: 103)
  │   💬 Args: [isPending, strategyPending, "Vault should return same value as strategy"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 104)
  │   💬 Args: [isPending, "Should still return true after fulfillment until claim"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 105)
      💬 Args: [isPending, "Should return false after claim"]
      👁️  Def: internal
```
