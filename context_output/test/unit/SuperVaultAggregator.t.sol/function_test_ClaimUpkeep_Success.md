# Function: test_ClaimUpkeep_Success()
...
function test_ClaimUpkeep_Success() public {
    ...
    assertEq(superVaultAggregator.claimableUpkeep(), claimableAmount - claimAmount, "Claimable upkeep should be reduced");
    assertEq(IERC20(upToken).balanceOf(superBank), superBankBalanceBefore + claimAmount, "SuperBank should receive upkeep tokens");
}
```
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregatorTest.test_ClaimUpkeep_Success() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdCheats.deal(address,address,uint256) (NodeID: 1)
  │   💬 Args: [upToken, address(this), upkeepAmount]
  │   👁️  Def: internal
  ...
  │   💬 Args: [claimableAmount > 0, "Claimable upkeep should be non-zero"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 100)
  │   💬 Args: [superVaultAggregator.claimableUpkeep(), claimableAmount - claimAmount, "Claimable upkeep should be reduced"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 101)
      💬 Args: [IERC20(upToken).balanceOf(superBank), superBankBalanceBefore + claimAmount, "SuperBank should receive upkeep tokens"]
      👁️  Def: internal
```
