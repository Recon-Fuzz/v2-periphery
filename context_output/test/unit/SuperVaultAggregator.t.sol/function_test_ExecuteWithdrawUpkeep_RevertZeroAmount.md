# Function: test_ExecuteWithdrawUpkeep_RevertZeroAmount()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregatorTest.test_ExecuteWithdrawUpkeep_RevertZeroAmount() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdCheats.deal(address,address,uint256) (NodeID: 1)
  │   💬 Args: [upToken, manager, upkeepAmount]
  │   👁️  Def: internal
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 99)
      💬 Args: [superVaultAggregator.getUpkeepBalance(strategy), 0, "Strategy upkeep balance should be zero"]
      👁️  Def: internal
```
