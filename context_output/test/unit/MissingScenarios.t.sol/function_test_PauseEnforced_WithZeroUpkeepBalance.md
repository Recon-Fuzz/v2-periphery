# Function: test_PauseEnforced_WithZeroUpkeepBalance()
...
```
┌─ [0] ⚙️ FUNCTION: MissingScenariosTest.test_PauseEnforced_WithZeroUpkeepBalance() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [upkeepBalance, 0, "Strategy should have zero upkeep balance"]
  │   👁️  Def: internal
