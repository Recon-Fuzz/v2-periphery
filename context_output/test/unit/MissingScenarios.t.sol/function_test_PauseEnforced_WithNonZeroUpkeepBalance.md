# Function: test_PauseEnforced_WithNonZeroUpkeepBalance()
...
```
┌─ [0] ⚙️ FUNCTION: MissingScenariosTest.test_PauseEnforced_WithNonZeroUpkeepBalance() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 100)
      💬 Args: [upkeepBalance, upkeepAmount, "Strategy should have upkeep balance"]
      👁️  Def: internal
```
