# Function: test_BatchForwardPPS_ContinuesAfterPausedStrategy()
...
```
┌─ [0] ⚙️ FUNCTION: MissingScenariosTest.test_BatchForwardPPS_ContinuesAfterPausedStrategy() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
