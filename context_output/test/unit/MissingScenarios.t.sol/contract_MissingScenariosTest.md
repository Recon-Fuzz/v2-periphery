...
- **Name**: MissingScenariosTest
- **Type**: Contract
- **Path**: test/unit/MissingScenarios.t.sol
- **Documentation**: @title MissingScenariosTest
...
### test_BatchForwardPPS_ContinuesAfterUnknownStrategy()

- **Signature**: `test_BatchForwardPPS_ContinuesAfterUnknownStrategy()`
- **Visibility**: public
- **Source Range**: 7170:2103:657
- **Details**: [function_test_BatchForwardPPS_ContinuesAfterUnknownStrategy.md](./function_test_BatchForwardPPS_ContinuesAfterUnknownStrategy.md)
...
### test_BatchForwardPPS_ContinuesAfterPausedStrategy()

- **Signature**: `test_BatchForwardPPS_ContinuesAfterPausedStrategy()`
- **Visibility**: public
- **Source Range**: 9467:1937:657
- **Details**: [function_test_BatchForwardPPS_ContinuesAfterPausedStrategy.md](./function_test_BatchForwardPPS_ContinuesAfterPausedStrategy.md)
...
### test_BatchForwardPPS_ContinuesAfterStaleTimestamp()

- **Signature**: `test_BatchForwardPPS_ContinuesAfterStaleTimestamp()`
- **Visibility**: public
- **Source Range**: 11569:1951:657
- **Details**: [function_test_BatchForwardPPS_ContinuesAfterStaleTimestamp.md](./function_test_BatchForwardPPS_ContinuesAfterStaleTimestamp.md)
...
### test_PauseEnforced_WithZeroUpkeepBalance()

- **Signature**: `test_PauseEnforced_WithZeroUpkeepBalance()`
- **Visibility**: public
- **Source Range**: 13924:1071:657
- **Details**: [function_test_PauseEnforced_WithZeroUpkeepBalance.md](./function_test_PauseEnforced_WithZeroUpkeepBalance.md)
...
### test_PauseEnforced_WithNonZeroUpkeepBalance()

- **Signature**: `test_PauseEnforced_WithNonZeroUpkeepBalance()`
- **Visibility**: public
- **Source Range**: 15155:1257:657
- **Details**: [function_test_PauseEnforced_WithNonZeroUpkeepBalance.md](./function_test_PauseEnforced_WithNonZeroUpkeepBalance.md)
...
### test_HookRejected_WhenInspectReverts()

- **Signature**: `test_HookRejected_WhenInspectReverts()`
- **Visibility**: public
- **Source Range**: 16753:1536:657
- **Details**: [function_test_HookRejected_WhenInspectReverts.md](./function_test_HookRejected_WhenInspectReverts.md)
...
### test_HookRejected_WhenNoInspectMethod()

- **Signature**: `test_HookRejected_WhenNoInspectMethod()`
- **Visibility**: public
- **Source Range**: 18452:1503:657
- **Details**: [function_test_HookRejected_WhenNoInspectMethod.md](./function_test_HookRejected_WhenNoInspectMethod.md)
...
### test_HookRejected_WhenNotRegistered()

- **Signature**: `test_HookRejected_WhenNotRegistered()`
- **Visibility**: public
- **Source Range**: 20286:1353:657
- **Details**: [function_test_HookRejected_WhenNotRegistered.md](./function_test_HookRejected_WhenNotRegistered.md)
...
### test_HookReceivesCorrectPrevHook()

- **Signature**: `test_HookReceivesCorrectPrevHook()`
- **Visibility**: public
- **Source Range**: 22179:2665:657
- **Details**: [function_test_HookReceivesCorrectPrevHook.md](./function_test_HookReceivesCorrectPrevHook.md)
...
### test_HookSequence_RevertsAtomically()

- **Signature**: `test_HookSequence_RevertsAtomically()`
- **Visibility**: public
- **Source Range**: 25262:2417:657
- **Details**: [function_test_HookSequence_RevertsAtomically.md](./function_test_HookSequence_RevertsAtomically.md)
...
### test_RapidPPSChanges_DeviationThresholdEnforced()

- **Signature**: `test_RapidPPSChanges_DeviationThresholdEnforced()`
- **Visibility**: public
- **Source Range**: 28035:1601:657
- **Details**: [function_test_RapidPPSChanges_DeviationThresholdEnforced.md](./function_test_RapidPPSChanges_DeviationThresholdEnforced.md)
...
### test_RapidPPSUpdates_MinIntervalEnforced()

- **Signature**: `test_RapidPPSUpdates_MinIntervalEnforced()`
- **Visibility**: public
- **Source Range**: 29785:2173:657
- **Details**: [function_test_RapidPPSUpdates_MinIntervalEnforced.md](./function_test_RapidPPSUpdates_MinIntervalEnforced.md)
