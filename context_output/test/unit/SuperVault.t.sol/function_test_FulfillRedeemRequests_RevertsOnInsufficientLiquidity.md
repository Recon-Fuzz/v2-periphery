# Function: test_FulfillRedeemRequests_RevertsOnInsufficientLiquidity()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_FulfillRedeemRequests_RevertsOnInsufficientLiquidity() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 101)
      💬 Args: [asset.balanceOf(address(strategy)), 0, "Strategy should have 0 balance"]
      👁️  Def: internal
```
