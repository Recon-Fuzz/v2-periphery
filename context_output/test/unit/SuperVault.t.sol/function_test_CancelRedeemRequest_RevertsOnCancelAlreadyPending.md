# Function: test_CancelRedeemRequest_RevertsOnCancelAlreadyPending()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_CancelRedeemRequest_RevertsOnCancelAlreadyPending() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
