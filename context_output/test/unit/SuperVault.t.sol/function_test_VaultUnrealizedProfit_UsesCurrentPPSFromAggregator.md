# Function: test_VaultUnrealizedProfit_UsesCurrentPPSFromAggregator()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_VaultUnrealizedProfit_UsesCurrentPPSFromAggregator() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [currentPPS, newPPS, "PPS manipulation should work"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 101)
      💬 Args: [profit, 0, "Profit should be calculated based on manipulated PPS"]
      👁️  Def: internal
```
