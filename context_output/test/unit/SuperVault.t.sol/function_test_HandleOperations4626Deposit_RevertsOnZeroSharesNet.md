# Function: test_HandleOperations4626Deposit_RevertsOnZeroSharesNet()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Deposit_RevertsOnZeroSharesNet() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [currentPPS, 1e18, "PPS should be initialized to 1e18"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 101)
      💬 Args: [newPPS, inflatedPPS, "PPS should be inflated to 1e30"]
      👁️  Def: internal
```
