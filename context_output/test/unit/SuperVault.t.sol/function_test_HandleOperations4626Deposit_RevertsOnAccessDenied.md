# Function: test_HandleOperations4626Deposit_RevertsOnAccessDenied()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Deposit_RevertsOnAccessDenied() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
