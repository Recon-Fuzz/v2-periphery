# Function: test_CancelRedeemRequest_SucceedsWithMinimalRedeemRequest()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_CancelRedeemRequest_SucceedsWithMinimalRedeemRequest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 100)
      💬 Args: [isPending, "Cancel request should be pending for minimal redeem"]
      👁️  Def: internal
```
