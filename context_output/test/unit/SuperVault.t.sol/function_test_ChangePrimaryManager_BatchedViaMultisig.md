# Function: test_ChangePrimaryManager_BatchedViaMultisig()
...
function test_ChangePrimaryManager_BatchedViaMultisig() public {
    ...
    calldatas[0] = abi.encodeWithSelector(ISuperGovernor.changePrimaryManager.selector, address(strategy), newManager, newFeeRecipient);
    ...
    assertEq(superVaultAggregator.getMainManager(address(strategy)), newManager, "Manager should be updated via multisig batch");
    ...
    assertTrue(superVaultAggregator.isStrategyPaused(address(strategy)), "New manager should operate immediately after multisig batch");
    vm.prank(manager);
...
- **MockMultisig::executeBatch(address[],bytes[])**
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_ChangePrimaryManager_BatchedViaMultisig() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(address,address,string) (NodeID: 102)
  │   💬 Args: [initialManager, manager, "Initial manager should be set"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(address,address,string) (NodeID: 103)
  │   💬 Args: [superVaultAggregator.getMainManager(address(strategy)), newManager, "Manager should be updated via multisig batch"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(address,address,string) (NodeID: 104)
  │   💬 Args: [feeConfig.recipient, newFeeRecipient, "Fee recipient should be updated via multisig batch"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 105)
  │   💬 Args: [finalHwm, finalPPS, "HWM should be reset to current PPS via multisig batch"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 106)
      💬 Args: [superVaultAggregator.isStrategyPaused(address(strategy)), "New manager should operate immediately after multisig batch"]
      👁️  Def: internal
```
