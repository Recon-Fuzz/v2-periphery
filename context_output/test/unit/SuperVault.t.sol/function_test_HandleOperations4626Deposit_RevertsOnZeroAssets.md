# Function: test_HandleOperations4626Deposit_RevertsOnZeroAssets()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Deposit_RevertsOnZeroAssets() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
