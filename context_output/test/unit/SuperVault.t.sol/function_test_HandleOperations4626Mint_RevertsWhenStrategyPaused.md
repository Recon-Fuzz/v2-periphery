# Function: test_HandleOperations4626Mint_RevertsWhenStrategyPaused()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Mint_RevertsWhenStrategyPaused() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
