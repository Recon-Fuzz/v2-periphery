# Function: test_SkimPerformanceFee_RevertsOnZeroPPS()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_SkimPerformanceFee_RevertsOnZeroPPS() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [vault.totalSupply(), 0, "Vault should have supply"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 101)
