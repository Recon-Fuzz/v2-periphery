# Function: test_HandleOperations4626Mint_RevertsWhenGlobalHooksVetoed()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Mint_RevertsWhenGlobalHooksVetoed() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
