# Function: test_HandleOperations4626Deposit_RevertsWhenPPSExpired()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Deposit_RevertsWhenPPSExpired() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 100)
      💬 Args: [block.timestamp - lastUpdateTimestamp, 1 days, "PPS should be expired"]
      👁️  Def: internal
```
