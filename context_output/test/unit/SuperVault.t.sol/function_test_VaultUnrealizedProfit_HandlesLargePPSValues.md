# Function: test_VaultUnrealizedProfit_HandlesLargePPSValues()
...
function test_VaultUnrealizedProfit_HandlesLargePPSValues() public {
    ...
    uint256 ppsGrowth = largePPS - 1e18;
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_VaultUnrealizedProfit_HandlesLargePPSValues() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │           💬 Args: [condition]
  │           👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 108)
  │   💬 Args: [profit, expectedProfit, "Should handle large PPS values correctly"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 109)
      💬 Args: [profit, 0, "Profit should be substantial with large PPS growth"]
      👁️  Def: internal
```
