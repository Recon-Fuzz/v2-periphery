# Function: test_SuperVaultStrategy_Initialize_RevertsOnInvalidManagementFeeBps()
...
function test_SuperVaultStrategy_Initialize_RevertsOnInvalidManagementFeeBps() public {
    ...
    ISuperVaultStrategy.FeeConfig memory feeConfig = ISuperVaultStrategy.FeeConfig({performanceFeeBps: 1000, managementFeeBps: 10_001, recipient: manager});
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_SuperVaultStrategy_Initialize_RevertsOnInvalidManagementFeeBps() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
