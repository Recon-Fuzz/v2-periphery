# Function: test_ClaimCancelRedeem_SucceedsWithMinimalClaimable()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_ClaimCancelRedeem_SucceedsWithMinimalClaimable() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 100)
      💬 Args: [isPending, "Cancel request should not be pending after claim"]
      👁️  Def: internal
```
