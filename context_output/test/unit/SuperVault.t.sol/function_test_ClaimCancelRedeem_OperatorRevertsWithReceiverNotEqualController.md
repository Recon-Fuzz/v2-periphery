# Function: test_ClaimCancelRedeem_OperatorRevertsWithReceiverNotEqualController()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_ClaimCancelRedeem_OperatorRevertsWithReceiverNotEqualController() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 105)
