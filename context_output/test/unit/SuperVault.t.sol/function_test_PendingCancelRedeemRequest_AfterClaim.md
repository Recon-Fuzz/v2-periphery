# Function: test_PendingCancelRedeemRequest_AfterClaim()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_PendingCancelRedeemRequest_AfterClaim() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 100)
  │   💬 Args: [isPending, "Should return false after claim is completed"]
  │   👁️  Def: internal
