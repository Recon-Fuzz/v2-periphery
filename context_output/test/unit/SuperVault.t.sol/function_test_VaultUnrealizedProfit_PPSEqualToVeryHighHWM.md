# Function: test_VaultUnrealizedProfit_PPSEqualToVeryHighHWM()
...
function test_VaultUnrealizedProfit_PPSEqualToVeryHighHWM() public {
    ...
    vm.stopPrank();
    uint256 veryHighValue = 1_000_000e18;
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_VaultUnrealizedProfit_PPSEqualToVeryHighHWM() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 100)
      💬 Args: [profit, 0, "Profit should be 0 when currentPPS equals very high vaultHwmPps"]
      👁️  Def: internal
```
