# Function: test_CancelRedeemRequest_RevertsOnZeroAddressController()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_CancelRedeemRequest_RevertsOnZeroAddressController() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
