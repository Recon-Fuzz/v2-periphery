# Function: test_ResetHighWaterMark_UpdatesHWMToCurrentPPS()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_ResetHighWaterMark_UpdatesHWMToCurrentPPS() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 1)
  │   💬 Args: [initialHwm, currentPPS, "Initial HWM should equal current PPS"]
  │   👁️  Def: internal
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 101)
      💬 Args: [newHwm, newPPS, "HWM should be reset to current PPS"]
      👁️  Def: internal
```
