# Function: test_QuoteMintAssetsGross_ZeroFees()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_QuoteMintAssetsGross_ZeroFees() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 1)
  │   💬 Args: [assetsGross, assetsNet, "assetsGross should equal assetsNet when fees are 0"]
  │   👁️  Def: internal
