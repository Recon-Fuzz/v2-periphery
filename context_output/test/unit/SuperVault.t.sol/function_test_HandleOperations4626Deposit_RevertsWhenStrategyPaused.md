# Function: test_HandleOperations4626Deposit_RevertsWhenStrategyPaused()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Deposit_RevertsWhenStrategyPaused() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
