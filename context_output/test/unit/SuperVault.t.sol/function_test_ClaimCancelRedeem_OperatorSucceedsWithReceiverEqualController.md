# Function: test_ClaimCancelRedeem_OperatorSucceedsWithReceiverEqualController()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_ClaimCancelRedeem_OperatorSucceedsWithReceiverEqualController() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 104)
      💬 Args: [receiverBalanceAfter - receiverBalanceBefore, claimedShares, "Receiver should receive shares"]
      👁️  Def: internal
```
