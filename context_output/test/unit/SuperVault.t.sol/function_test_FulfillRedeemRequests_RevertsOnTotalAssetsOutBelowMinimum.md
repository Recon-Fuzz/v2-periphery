# Function: test_FulfillRedeemRequests_RevertsOnTotalAssetsOutBelowMinimum()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_FulfillRedeemRequests_RevertsOnTotalAssetsOutBelowMinimum() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
