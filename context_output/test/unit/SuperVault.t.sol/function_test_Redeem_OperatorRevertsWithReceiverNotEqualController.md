# Function: test_Redeem_OperatorRevertsWithReceiverNotEqualController()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Redeem_OperatorRevertsWithReceiverNotEqualController() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
