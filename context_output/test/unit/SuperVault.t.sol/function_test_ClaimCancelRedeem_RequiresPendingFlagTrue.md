# Function: test_ClaimCancelRedeem_RequiresPendingFlagTrue()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_ClaimCancelRedeem_RequiresPendingFlagTrue() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [pendingBefore, "Pending flag should be true before claim"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 101)
      💬 Args: [pendingAfter, "Pending flag should be false after claim"]
      👁️  Def: internal
```
