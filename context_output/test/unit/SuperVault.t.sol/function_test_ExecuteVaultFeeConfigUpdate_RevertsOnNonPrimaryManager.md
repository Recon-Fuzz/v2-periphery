# Function: test_ExecuteVaultFeeConfigUpdate_RevertsOnNonPrimaryManager()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_ExecuteVaultFeeConfigUpdate_RevertsOnNonPrimaryManager() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
