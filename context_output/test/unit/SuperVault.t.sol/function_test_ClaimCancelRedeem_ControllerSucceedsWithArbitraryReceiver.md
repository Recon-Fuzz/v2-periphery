# Function: test_ClaimCancelRedeem_ControllerSucceedsWithArbitraryReceiver()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_ClaimCancelRedeem_ControllerSucceedsWithArbitraryReceiver() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 103)
  │   💬 Args: [claimableShares, 0, "Should have claimable shares for test"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 104)
      💬 Args: [receiverBalanceAfter - receiverBalanceBefore, claimedShares, "Arbitrary receiver should receive shares"]
      👁️  Def: internal
```
