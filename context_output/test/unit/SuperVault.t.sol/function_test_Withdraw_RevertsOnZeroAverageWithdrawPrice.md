# Function: test_Withdraw_RevertsOnZeroAverageWithdrawPrice()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Withdraw_RevertsOnZeroAverageWithdrawPrice() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 100)
      💬 Args: [averageWithdrawPrice, 0, "Average withdraw price should be 0 when no redemption fulfilled"]
      👁️  Def: internal
```
