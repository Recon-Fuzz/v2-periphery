# Function: test_VaultUnrealizedProfit_MinimalValuesEqual()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_VaultUnrealizedProfit_MinimalValuesEqual() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 100)
      💬 Args: [profit, 0, "Profit should be 0 when both currentPPS and vaultHwmPps are 1 wei"]
      👁️  Def: internal
```
