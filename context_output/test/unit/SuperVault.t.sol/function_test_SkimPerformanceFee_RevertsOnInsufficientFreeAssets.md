# Function: test_SkimPerformanceFee_RevertsOnInsufficientFreeAssets()
...
function test_SkimPerformanceFee_RevertsOnInsufficientFreeAssets() public {
    ...
    asset.transfer(address(0xdead), strategyBalance - 1e15);
...
- **asset** (state variable) [test/mocks/MockERC20.sol/contract_MockERC20.md]
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_SkimPerformanceFee_RevertsOnInsufficientFreeAssets() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [currentPPS, 1e18, "Initial PPS should be 1e18"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 101)
  │   💬 Args: [strategy.getStoredPPS(), newPPS, "PPS should be increased"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 102)
  │   💬 Args: [strategyBalance, 0, "Strategy should have some balance"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256,string) (NodeID: 103)
      💬 Args: [remainingBalance, 1e18, "Strategy should have very little balance"]
      👁️  Def: internal
```
