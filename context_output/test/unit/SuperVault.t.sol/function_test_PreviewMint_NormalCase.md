# Function: test_PreviewMint_NormalCase()
...
function test_PreviewMint_NormalCase() public {
    vm.prank(manager);
    (address vaultAddress, address strategyAddress, ) = superVaultAggregator.createVault(ISuperVaultAggregator.VaultCreationParams({asset: address(asset), name: "Test Vault Fee", symbol: "TVF", mainManager: manager, secondaryManagers: new address[](0), minUpdateInterval: 5, maxStaleness: 300, feeConfig: ISuperVaultStrategy.FeeConfig({performanceFeeBps: 0, managementFeeBps: 500, recipient: manager})}));
    ...
    uint256 assetsNet = (((sharesToMint * pps) + testVault.PRECISION()) - 1) / testVault.PRECISION();
    uint256 expectedGross = (((assetsNet * 10_000) + 9500) - 1) / 9500;
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_PreviewMint_NormalCase() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: Helpers._deployAccount(uint256,string) (NodeID: 1)
  │   💬 Args: [0x123, "Depositor"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdCheats.deal(address,address,uint256) (NodeID: 2)
  │   💬 Args: [address(asset), depositor, 10_000e18]
  │   👁️  Def: internal
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 100)
  │   💬 Args: [grossAssets, 0, "Gross assets should be greater than 0"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 101)
      💬 Args: [grossAssets, expectedGross, "Gross assets should match expected calculation"]
      👁️  Def: internal
```
