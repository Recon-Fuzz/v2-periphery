# Function: test_PendingCancelRedeemRequest_RequestIdIgnored()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_PendingCancelRedeemRequest_RequestIdIgnored() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 100)
  │   💬 Args: [isPending0, "Request ID 0 should return true"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(bool,bool,string) (NodeID: 101)
  │   💬 Args: [isPending0, isPending1, "Request ID should be ignored - result should be same"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(bool,bool,string) (NodeID: 102)
      💬 Args: [isPending0, isPending999, "Request ID should be ignored - result should be same"]
      👁️  Def: internal
```
