# Function: test_ExecuteHooks_RevertsOnExpectedAssetsLengthMismatch()
...
function test_ExecuteHooks_RevertsOnExpectedAssetsLengthMismatch() public {
    ...
    hookCalldata[0] = "";
    hookCalldata[1] = "";
    uint256[] memory expectedOut = new uint256[](3);
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_ExecuteHooks_RevertsOnExpectedAssetsLengthMismatch() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
```
