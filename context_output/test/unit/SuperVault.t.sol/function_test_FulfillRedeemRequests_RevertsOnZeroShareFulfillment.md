# Function: test_FulfillRedeemRequests_RevertsOnZeroShareFulfillment()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_FulfillRedeemRequests_RevertsOnZeroShareFulfillment() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdCheats.deal(address,address,uint256) (NodeID: 100)
      💬 Args: [address(asset), address(strategy), 100e18]
      👁️  Def: internal
