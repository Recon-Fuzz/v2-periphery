# Function: test_VaultUnrealizedProfit_ReturnsZeroWhenPPSBelowHWM()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_VaultUnrealizedProfit_ReturnsZeroWhenPPSBelowHWM() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 100)
      💬 Args: [profit, 0, "Profit should be 0 when PPS is below HWM"]
      👁️  Def: internal
```
