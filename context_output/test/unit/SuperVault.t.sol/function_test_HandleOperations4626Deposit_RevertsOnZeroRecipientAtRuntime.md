# Function: test_HandleOperations4626Deposit_RevertsOnZeroRecipientAtRuntime()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Deposit_RevertsOnZeroRecipientAtRuntime() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 1)
  │   💬 Args: [initialConfig.managementFeeBps, 500, "Initial management fee should be 5%"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(address,address,string) (NodeID: 2)
  │   💬 Args: [initialConfig.recipient, manager, "Initial recipient should be manager"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 3)
  │   💬 Args: [manipulatedConfig.managementFeeBps, 500, "Management fee should still be 5%"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(address,address,string) (NodeID: 4)
  │   💬 Args: [manipulatedConfig.recipient, address(0), "Recipient should be corrupted to address(0)"]
  │   👁️  Def: internal
