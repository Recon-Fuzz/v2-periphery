# Function: test_HandleOperations4626Deposit_RevertsWhenPPSStale()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Deposit_RevertsWhenPPSStale() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
