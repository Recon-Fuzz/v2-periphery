# Function: test_HandleOperations4626Mint_RevertsOnZeroAddressController()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Mint_RevertsOnZeroAddressController() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
