# Function: test_Withdraw_RevertsOnZeroAddressReceiver()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_Withdraw_RevertsOnZeroAddressReceiver() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 198)
