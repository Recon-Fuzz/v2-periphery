# Function: test_HandleOperations4626Deposit_RevertsWhenGlobalHooksVetoed()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_HandleOperations4626Deposit_RevertsWhenGlobalHooksVetoed() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 100)
      💬 Args: [superVaultAggregator.isGlobalHooksRootVetoed(), "Global hooks root should be vetoed"]
      👁️  Def: internal
```
