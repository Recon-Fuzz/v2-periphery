# Function: test_VaultUnrealizedProfit_ComprehensiveLessThanOrEqualCases()
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTest.test_VaultUnrealizedProfit_ComprehensiveLessThanOrEqualCases() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [strategy.vaultUnrealizedProfit(), 0, "Case 1: Equal at 1e18 should return 0"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 101)
  │   💬 Args: [strategy.vaultUnrealizedProfit(), 0, "Case 2: PPS < HWM should return 0"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 102)
  │   💬 Args: [strategy.vaultUnrealizedProfit(), 0, "Case 3: PPS (2e18) < HWM (3e18) should return 0"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 103)
  │   💬 Args: [strategy.vaultUnrealizedProfit(), 0, "Case 4: Equal at 10e18 should return 0"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 104)
      💬 Args: [strategy.vaultUnrealizedProfit(), 0, "Case 5: PPS (0) < HWM (1) should return 0"]
      👁️  Def: internal
```
