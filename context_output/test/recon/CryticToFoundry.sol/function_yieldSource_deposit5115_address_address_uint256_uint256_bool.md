# Function: yieldSource_deposit5115(address,address,uint256,uint256,bool)
...
function yieldSource_deposit5115(address receiver, address tokenIn, uint256 amountTokenToDeposit, uint256 minSharesOut, bool depositFromInternalBalance) public asActor() {
    ...
    if (currentType == YieldSourceType.ERC5115) {
        MockERC5115Tester(yieldSource).deposit(receiver, tokenIn, amountTokenToDeposit, minSharesOut, depositFromInternalBalance);
    }
}
```
...
- **MockERC5115Tester::deposit(address,address,uint256,uint256,bool)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_deposit5115(address,address,uint256,uint256,bool) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
