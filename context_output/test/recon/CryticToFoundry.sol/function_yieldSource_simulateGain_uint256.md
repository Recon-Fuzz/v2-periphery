# Function: yieldSource_simulateGain(uint256)
...
- **MockERC4626Tester::simulateGain(uint256)**
- **MockERC5115Tester::simulateGain(uint256)**
- **MockERC7540Tester::simulateGain(uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_simulateGain(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
