# Function: superVault_mint(uint256)
...
function superVault_mint(uint256 shares) public updateGhostsWithOpType(OpType.ADD) {
    ...
    eq(assets, previewMint, "previewMint returns the correct amounts compared to executing a mint");
}
```
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTargets.superVault_mint(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [assets, previewMint, "previewMint returns the correct amounts compared to executing a mint"]
  │   👁️  Def: internal
