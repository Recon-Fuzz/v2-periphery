# Function: yieldSource_deposit7540(uint256,address,address)
...
- **MockERC7540Tester::deposit(uint256,address,address)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_deposit7540(uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
