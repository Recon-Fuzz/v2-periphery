# Function: optimize_maxDustAccumulation()
...
function optimize_maxDustAccumulation() public view returns (int256) {
    ...
    for (uint256 i; i < actors.length; i++) {
        ...
        summedClaimableRedemptionsAsAssets += superVault.convertToAssets(claimableRedemptions);
    }
...
```
┌─ [0] ⚙️ FUNCTION: Properties.optimize_maxDustAccumulation() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
