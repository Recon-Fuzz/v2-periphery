# Function: yieldSource_cancelDepositRequest(uint256,address)
...
- **MockERC7540Tester::cancelDepositRequest(uint256,address)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_cancelDepositRequest(uint256,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
