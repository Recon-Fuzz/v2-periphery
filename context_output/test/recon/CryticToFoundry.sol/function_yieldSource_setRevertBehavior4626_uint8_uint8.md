# Function: yieldSource_setRevertBehavior4626(uint8,uint8)
...
- **MockERC4626Tester::setRevertBehavior(enum FunctionType,enum RevertType)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_setRevertBehavior4626(uint8,uint8) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
