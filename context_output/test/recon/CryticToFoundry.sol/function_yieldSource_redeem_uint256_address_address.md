# Function: yieldSource_redeem(uint256,address,address)
...
- **MockERC4626Tester::redeem(uint256,address,address)**
- **MockERC7540Tester::redeem(uint256,address,address)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_redeem(uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
