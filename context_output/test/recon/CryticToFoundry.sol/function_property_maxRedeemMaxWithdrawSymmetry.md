# Function: property_maxRedeemMaxWithdrawSymmetry()
...
function property_maxRedeemMaxWithdrawSymmetry() public {
    ...
    uint256 withdrawPrice = superVaultStrategy.getAverageWithdrawPrice(_getActor());
    uint256 maxWithdrawAsShares = maxWithdraw.mulDiv(superVault.PRECISION(), withdrawPrice, Math.Rounding.Floor);
...
```
┌─ [0] ⚙️ FUNCTION: Properties.property_maxRedeemMaxWithdrawSymmetry() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [maxWithdraw, superVault.PRECISION(), withdrawPrice, Math.Rounding.Floor]
  │   👁️  Def: internal
  ...
  │           💬 Args: [condition]
  │           👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ActorManager._getActor() (NodeID: 11)
  │   💬 Args: [no args]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: FoundryAsserts.eq(uint256,uint256,string) (NodeID: 12)
      💬 Args: [maxWithdrawAsShares, maxRedeem, "maxWithdrawAsShares != maxRedeem"]
      👁️  Def: internal
