# Function: doomsday_maxWithdrawResetsAfterFullWithdrawal(uint256)
...
```
┌─ [0] ⚙️ FUNCTION: DoomsdayTargets.doomsday_maxWithdrawResetsAfterFullWithdrawal(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [no args]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: FoundryAsserts.eq(uint256,uint256,string) (NodeID: 43)
  │   💬 Args: [maxWithdrawAfter, 0, "maxWithdraw should be reset to 0 after full withdrawal"]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 44)
  │     💬 Args: [a, b, reason]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: FoundryAsserts.t(bool,string) (NodeID: 45)
      💬 Args: [false, "withdraw of maxWithdraw should not revert"]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 46)
        💬 Args: [b, reason]
        👁️  Def: internal
```
