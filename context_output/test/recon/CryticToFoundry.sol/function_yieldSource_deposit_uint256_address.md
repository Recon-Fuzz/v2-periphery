# Function: yieldSource_deposit(uint256,address)
...
- **MockERC4626Tester::deposit(uint256,address)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_deposit(uint256,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
