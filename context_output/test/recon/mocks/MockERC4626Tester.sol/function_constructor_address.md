...
- **Kind**: internal
- **Source**: 571:103:637
- **Link**: `test/recon/mocks/MockERC4626Tester.sol:ERC4626:constructor(contract MockERC20)`
...
```
┌─ [0] 🏗️ CONSTRUCTOR: MockERC4626Tester.constructor(address) (NodeID: 0)
    💬 Args: [no args]
    🏗️  Contract: MockERC4626Tester
  └─ [1] 🏗️ CONSTRUCTOR: ERC4626.constructor(contract MockERC20) (NodeID: 1)
      💬 Args: [MockERC20(_asset)]
      🏗️  Contract: ERC4626
    └─ [2] 🏗️ CONSTRUCTOR: MockERC20.constructor(string,string,uint8) (NodeID: 2)
        💬 Args: ["MockERC4626Tester", "MCT", 18]
