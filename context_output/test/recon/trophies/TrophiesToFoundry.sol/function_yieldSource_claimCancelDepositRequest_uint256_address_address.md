# Function: yieldSource_claimCancelDepositRequest(uint256,address,address)
...
- **MockERC7540Tester::claimCancelDepositRequest(uint256,address,address)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_claimCancelDepositRequest(uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
