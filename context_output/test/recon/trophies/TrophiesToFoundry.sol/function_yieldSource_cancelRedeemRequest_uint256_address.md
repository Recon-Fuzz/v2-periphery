# Function: yieldSource_cancelRedeemRequest(uint256,address)
...
- **MockERC7540Tester::cancelRedeemRequest(uint256,address)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_cancelRedeemRequest(uint256,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
