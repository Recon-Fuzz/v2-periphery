# Function: superVaultAggregator_cancelChangePrimaryManager(address)
...
- **UnsafeSuperVaultAggregator::cancelChangePrimaryManager(address)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregatorTargets.superVaultAggregator_cancelChangePrimaryManager(address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
