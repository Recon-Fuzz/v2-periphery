# Function: yieldSource_requestRedeem(uint256,address,address)
...
- **MockERC7540Tester::requestRedeem(uint256,address,address)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_requestRedeem(uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
