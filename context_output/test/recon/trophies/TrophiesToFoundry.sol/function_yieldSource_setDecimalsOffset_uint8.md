# Function: yieldSource_setDecimalsOffset(uint8)
...
- **MockERC4626Tester::setDecimalsOffset(uint8)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_setDecimalsOffset(uint8) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
