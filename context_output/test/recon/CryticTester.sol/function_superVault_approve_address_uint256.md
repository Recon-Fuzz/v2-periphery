# Function: superVault_approve(address,uint256)
...
- **SuperVault::approve(address,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultTargets.superVault_approve(address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
