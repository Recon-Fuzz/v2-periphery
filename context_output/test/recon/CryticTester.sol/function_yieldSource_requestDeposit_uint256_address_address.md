# Function: yieldSource_requestDeposit(uint256,address,address)
...
- **MockERC7540Tester::requestDeposit(uint256,address,address)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_requestDeposit(uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
