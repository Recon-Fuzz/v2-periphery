# Function: doomsday_mintRedeemSymmetrical(uint256)
...
```
┌─ [0] ⚙️ FUNCTION: DoomsdayTargets.doomsday_mintRedeemSymmetrical(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [no args]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: CryticAsserts.gte(uint256,uint256,string) (NodeID: 63)
