# Function: superVaultAggregator_proposeWithdrawUpkeep(address)
...
- **UnsafeSuperVaultAggregator::proposeWithdrawUpkeep(address)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultAggregatorTargets.superVaultAggregator_proposeWithdrawUpkeep(address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
