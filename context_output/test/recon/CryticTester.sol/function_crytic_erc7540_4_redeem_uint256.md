# Function: crytic_erc7540_4_redeem(uint256)
...
- **Kind**: internal
- **Source**: 6985:732:10
- **Link**: `lib/erc7540-reusable-properties/src/ERC7540Properties.sol:ERC7540Properties:erc7540_4_redeem(address,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: Properties.crytic_erc7540_4_redeem(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: CryticAsserts.t(bool,string) (NodeID: 2)
      💬 Args: [erc7540_4_redeem(address(superVault), amt), "ERC7540-4: redeem with more than max should revert"]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: ERC7540Properties.erc7540_4_redeem(address,uint256) (NodeID: 3)
