# Function: crytic_erc7540_4_withdraw(uint256)
...
- **Kind**: internal
- **Source**: 6241:738:10
- **Link**: `lib/erc7540-reusable-properties/src/ERC7540Properties.sol:ERC7540Properties:erc7540_4_withdraw(address,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: Properties.crytic_erc7540_4_withdraw(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: CryticAsserts.t(bool,string) (NodeID: 2)
      💬 Args: [erc7540_4_withdraw(address(superVault), amt), "ERC7540-4: withdraw with more than max should revert"]
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: ERC7540Properties.erc7540_4_withdraw(address,uint256) (NodeID: 3)
