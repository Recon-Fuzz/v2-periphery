# Function: superVaultStrategy_handleOperations7540(enum ISuperVaultStrategy.Operation,address,address,uint256)
...
- **SuperVaultStrategy::handleOperations7540(enum ISuperVaultStrategy.Operation,address,address,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultStrategyTargets.superVaultStrategy_handleOperations7540(enum ISuperVaultStrategy.Operation,address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
