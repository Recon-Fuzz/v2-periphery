# Function: yieldSource_mint(uint256,address)
...
- **MockERC4626Tester::mint(uint256,address)**
- **MockERC7540Tester::mint(uint256,address)**
...
```
┌─ [0] ⚙️ FUNCTION: YieldSourceTargets.yieldSource_mint(uint256,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
