# Function: superVaultStrategy_handleOperations4626Deposit(address,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SuperVaultStrategyTargets.superVaultStrategy_handleOperations4626Deposit(address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
