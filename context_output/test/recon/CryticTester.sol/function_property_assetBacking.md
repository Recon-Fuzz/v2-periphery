...
- **Kind**: internal
- **Source**: 161:180:67
- **Link**: `lib/setup-helpers/lib/chimera/src/CryticAsserts.sol:CryticAsserts:gt(uint256,uint256,string)`
...
┌─ [0] ⚙️ FUNCTION: Properties.property_assetBacking() (NodeID: 0)
  ...
  │         💬 Args: [set._inner]
  │         👁️  Def: private
  └─ [1] ⚙️ FUNCTION: CryticAsserts.gt(uint256,uint256,string) (NodeID: 5)
