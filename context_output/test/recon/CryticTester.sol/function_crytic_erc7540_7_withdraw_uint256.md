...
- **Kind**: internal
- **Source**: 1261:269:67
- **Link**: `lib/setup-helpers/lib/chimera/src/CryticAsserts.sol:CryticAsserts:between(uint256,uint256,uint256)`
...
┌─ [0] ⚙️ FUNCTION: Properties.crytic_erc7540_7_withdraw(uint256) (NodeID: 0)
  ...
  └─ [1] ⚙️ FUNCTION: CryticAsserts.t(bool,string) (NodeID: 2)
      ...
      👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: ERC7540Properties.erc7540_7_withdraw(address,uint256) (NodeID: 3)
        💬 Args: [address(superVault), amt]
        👁️  Def: public
      └─ [3] ⚙️ FUNCTION: CryticAsserts.between(uint256,uint256,uint256) (NodeID: 4)
