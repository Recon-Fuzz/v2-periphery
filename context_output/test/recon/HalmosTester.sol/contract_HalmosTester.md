...
- **Name**: HalmosTester
- **Type**: Contract
- **Path**: test/recon/HalmosTester.sol
...
**SVM**: [lib/openzeppelin-contracts-upgradeable/lib/halmos-cheatcodes/src/SVM.sol/interface_SVM.md]
...
```solidity
MockSuperGovernor internal superGovernor
```

**MockSuperGovernor**: [test/recon/mocks/MockSuperGovernor.sol/contract_MockSuperGovernor.md]
...
```solidity
MockSuperVault internal vaultImpl
```

**MockSuperVault**: [test/recon/mocks/MockSuperVault.sol/contract_MockSuperVault.md]

### strategyImpl

```solidity
MockSuperVaultStrategy internal strategyImpl
```

**MockSuperVaultStrategy**: [test/recon/mocks/MockSuperVaultStrategy.sol/contract_MockSuperVaultStrategy.md]

### escrowImpl

```solidity
MockSuperVaultEscrow internal escrowImpl
```

**MockSuperVaultEscrow**: [test/recon/mocks/MockSuperVaultEscrow.sol/contract_MockSuperVaultEscrow.md]
...
### check_strategySolvency(uint256)

- **Signature**: `check_strategySolvency(uint256)`
- **Visibility**: public
- **Source Range**: 7533:647:629
- **Details**: [function_check_strategySolvency_uint256.md](./function_check_strategySolvency_uint256.md)
