...
```
┌─ [0] ⚙️ FUNCTION: UnsafeSuperVaultAggregator.addSecondaryManager(address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │       💬 Args: [set, value]
  │       👁️  Def: private
  └─ [1] 🔒 MODIFIER: UnsafeSuperVaultAggregator.validStrategy(address) (NodeID: 6)
      💬 Args: [strategy]
    └─ [2] ⚙️ FUNCTION: UnsafeSuperVaultAggregator._validStrategy(address) (NodeID: 7)
        💬 Args: [strategy]
        👁️  Def: internal
