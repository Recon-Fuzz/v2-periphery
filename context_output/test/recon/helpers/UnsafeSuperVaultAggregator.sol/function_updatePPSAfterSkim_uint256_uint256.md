...
```
┌─ [0] ⚙️ FUNCTION: UnsafeSuperVaultAggregator.updatePPSAfterSkim(uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │           💬 Args: [condition]
  │           👁️  Def: internal
  └─ [1] 🔒 MODIFIER: UnsafeSuperVaultAggregator.validStrategy(address) (NodeID: 9)
      💬 Args: [msg.sender]
    └─ [2] ⚙️ FUNCTION: UnsafeSuperVaultAggregator._validStrategy(address) (NodeID: 10)
        💬 Args: [msg.sender]
        👁️  Def: internal
