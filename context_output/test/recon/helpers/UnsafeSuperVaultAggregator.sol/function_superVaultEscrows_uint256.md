# Function: superVaultEscrows(uint256)
...
```
┌─ [0] ⚙️ FUNCTION: UnsafeSuperVaultAggregator.superVaultEscrows(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: EnumerableSet.length(struct EnumerableSet.AddressSet) (NodeID: 1)
  │   💬 Args: [_superVaultEscrows]
  │   👁️  Def: internal
