# Function: proposeMinUpdateIntervalChange(address,uint256)
...
- **_PARAMETER_CHANGE_TIMELOCK** (`uint256`)
...
```
┌─ [0] ⚙️ FUNCTION: UnsafeSuperVaultAggregator.proposeMinUpdateIntervalChange(address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
