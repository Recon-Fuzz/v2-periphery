# Function: superVaultStrategies(uint256)
...
```
┌─ [0] ⚙️ FUNCTION: UnsafeSuperVaultAggregator.superVaultStrategies(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: EnumerableSet.length(struct EnumerableSet.AddressSet) (NodeID: 1)
  │   💬 Args: [_superVaultStrategies]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: EnumerableSet.at(struct EnumerableSet.AddressSet,uint256) (NodeID: 3)
      💬 Args: [_superVaultStrategies, index]
      👁️  Def: internal
