...
- **Name**: UnsafeSuperVaultAggregator
- **Type**: Contract
- **Path**: test/recon/helpers/UnsafeSuperVaultAggregator.sol
- **Documentation**: @title UnsafeSuperVaultAggregator
...
- **Details**: [function_createVault_struct_ISuperVaultAggregator.VaultCreationParams.md](./function_createVault_struct_ISuperVaultAggregator.VaultCreationParams.md)
...
- **Visibility**: external
- **Source Range**: 9551:2965:634
- **Details**: [function_forwardPPS_struct_ISuperVaultAggregator.ForwardPPSArgs.md](./function_forwardPPS_struct_ISuperVaultAggregator.ForwardPPSArgs.md)
...
- **Details**: [function_validateHook_address_struct_ISuperVaultAggregator.ValidateHookArgs.md](./function_validateHook_address_struct_ISuperVaultAggregator.ValidateHookArgs.md)
...
- **Details**: [function_validateHooks_address_struct_ISuperVaultAggregator.ValidateHookArgs[].md](./function_validateHooks_address_struct_ISuperVaultAggregator.ValidateHookArgs[].md)
